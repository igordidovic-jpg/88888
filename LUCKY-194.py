...
# ================= CONFIG (tuning — en bloke; postopoma nadomešča magic numbers) =================
CFG = {
    "MIN_BET_MINUTE": 70,
    "GAME_DECIDED_MINUTE": 75,
    "NG_CONF_MIN": 0.62,
    "LOW_GOAL_10M_NEXT": 0.40,
    "FINAL_TIMING_LOW_GOAL_5M": 0.15,
    "ENTRY_ANTI_LATE_MINUTE": 88,
    "ENTRY_TEMPO_DANGER_SPIKE": 1.30,
    # Zgodnji value bypass (namesto slepega NO BET < MIN_BET)
    "EARLY_VALUE_EDGE": 0.25,
    "EARLY_VALUE_MC": 0.75,
    "EARLY_ATTACK_MINUTE": 55,
    "EARLY_ATTACK_LAM_RATIO": 1.5,
    "EARLY_ATTACK_SOT_MIN": 2,
    # CFOS GOLD RULE: 75+ izgubljajoči pritisk; 80+ AWAY kontrola → zmanjšaj fake λ_home
    "GOLD_IGNORE_HOME_PRESSURE_MIN": 75,
    "GOLD_LATE_HOME_LAM_MINUTE": 80,
    "GOLD_RULE_LATE_HOME_LAM": 0.85,
    # MATCH vs NEXT GOAL: 1X2 value ne sme pasti na NG/timing filtre (goal_timing, entry wait, final timing)
    "MATCH_VALUE_FORCE_EDGE": 0.20,
    "MATCH_VALUE_FORCE_MC": 0.70,
    # PRE-TRIGGER CHAOS: <70 brez vala + visoka aktivnost / λ → ne zrel vstop (NG/COMEBACK)
    "PRE_TRIGGER_MAX_MINUTE": 70,
    "PRE_TRIGGER_P_GOAL": 0.65,
    "PRE_TRIGGER_TEMPO_SHOTS": 0.22,
    "PRE_TRIGGER_TEMPO_DANGER": 0.75,
    "PRE_TRIGGER_LAM_MAX_MINUTE": 68,
    "PRE_TRIGGER_LAM_TOTAL": 1.30,
    "PRE_TRIGGER_KILL_CONF_BELOW": 0.75,
    "PRE_TRIGGER_EARLY_ENTRY_ENABLE": True,
    "PRE_TRIGGER_EARLY_ENTRY_MOM_MIN": 0.25,
    "PRE_TRIGGER_EARLY_ENTRY_LAM_RATIO_MIN": 3.0,
    "PRE_TRIGGER_EARLY_ENTRY_TEMPO_DANGER_MIN": 1.00,
    # PRE-GOAL trigger (pred-wave build-up lane)
    "PRE_GOAL_MINUTE": 25,
    "PRE_GOAL_ATTACK_RATIO_MIN": 1.80,
    "PRE_GOAL_DANGER_RATIO_MIN": 2.00,
    "PRE_GOAL_LAM_RATIO_MIN": 2.50,
    "PRE_GOAL_MOM_MIN": 0.22,
    "PRE_GOAL_TEMPO_DANGER_MIN": 0.95,
    "PRE_GOAL_TEMPO_ATTACKS_MIN": 1.60,
    "PRE_GOAL_BLOCK_TEMPO_SHOTS_MAX": 0.12,
    "PRE_GOAL_BLOCK_TEMPO_DANGER_MAX": 0.90,
    "PRE_GOAL_BLOCK_LAM_TOTAL_MAX": 0.35,
    "FAKE_PRESSURE_CONF_SCALE": 0.75,
    "FAKE_PRESSURE_POSSESSION_MIN": 60.0,
    "FAKE_PRESSURE_XG_MAX": 0.30,
    # CONTROL GAME calibration (leading side + xG/shots edge)
    "CONTROL_GAME_MIN_NG_CONF": 55,
    "CONTROL_GAME_LAM_FAKE_SCALE": 0.85,
    # Timing engine: high long-term goal probability, low short-term trigger => WAIT
    "TIMING_DELAY_PGOAL_MIN": 0.75,
    "TIMING_DELAY_PGOAL5_MAX": 0.30,
    "TIMING_DELAY_RELEASE_PGOAL5_MIN": 0.35,
    "TIMING_ENTRY_TRIGGER_PGOAL5_MIN": 0.35,
    "LOW_EVENT_WAIT_PGOAL_MAX": 0.40,
    "LOW_EVENT_WAIT_PGOAL10_MAX": 0.10,
    "CONTROL_FREEZE_PGOAL_MAX": 0.45,
    "DIRECTION_EVENT_BLOCK_PGOAL_MAX": 0.40,
    "DIRECTION_EVENT_BLOCK_CONF_MIN": 0.65,
    "GOAL_EVENT_EXEC_PGOAL_MIN": 0.65,
    "GOAL_EVENT_EXEC_PNOGOAL_MIN": 0.55,
    "GOAL_EVENT_HARD_OVERRIDE_PGOAL_MIN": 0.65,
    "LATE_CHAOS_FORCE_MINUTE": 75,
    "LATE_CHAOS_FORCE_PGOAL_MIN": 0.70,
    "LATE_CHAOS_FORCE_TEMPO_SHOTS_MIN": 0.25,
    # LOW EVENT BREAKOUT (direction strong, event low-mid -> micro risk entry)
    "LOW_EVENT_BREAKOUT_PGOAL_MIN": 0.20,
    "LOW_EVENT_BREAKOUT_PGOAL_MAX": 0.45,
    "LOW_EVENT_BREAKOUT_SIDE_GAP_MIN": 0.10,
    "LOW_EVENT_BREAKOUT_MOM_MIN": 0.15,
    "LOW_EVENT_BREAKOUT_LAM_RATIO_MIN": 1.50,
    "LOW_EVENT_BREAKOUT_CONF_MAX": 58,
    "LOW_EVENT_BREAKOUT_STRONG_SIDE_GAP_MIN": 0.16,
    "LOW_EVENT_BREAKOUT_STRONG_MOM_MIN": 0.22,
    "LOW_EVENT_BREAKOUT_STRONG_LAM_RATIO_MIN": 2.00,
    "LOW_EVENT_BREAKOUT_STAKE_SOFT": 0.2,
    "LOW_EVENT_BREAKOUT_STAKE_STRONG": 0.3,
    # Minute engine (event > minute): brez hard <70 gate
    "EARLY_EVENT_PGOAL5_MIN": 0.35,
    "EARLY_EVENT_PGOAL10_MIN": 0.55,
    "EARLY_EVENT_TEMPO_DANGER_MIN": 1.20,
    "EARLY_EVENT_BOOST_MINUTE_MAX": 25,
    "EARLY_EVENT_BOOST_TEMPO_DANGER_MIN": 1.40,
    # CONTEXT + TIMING layer
    "TIMING_ENTRY_FROM": 70,
    "TIMING_KILL_FROM": 85,
    "INTENT_HIGH_POS": 58.0,
    "INTENT_PARK_BUS_POS": 42.0,
    "INTENT_COUNTER_DANGER_RATIO": 1.25,
    "KILL_GAME_MINUTE": 75,
    "CHAOS_TEMPO_SHOTS": 0.25,
    "CHAOS_TEMPO_DANGER": 1.10,
    # Trading layer hard filters
    "HARD_ENDGAME_NO_BET_MINUTE": 90,
    "EXEC_HIDE_SIGNAL_CONF_MIN": 0.40,
    "TRADE_SIDE_CLEAR_GAP": 0.06,
    "TRADE_SIDE_CLEAR_CONF": 0.65,
    # REAL ENTRY engine (anti-fake comeback)
    "REAL_ENTRY_MINUTE": 70,
    "REAL_ENTRY_MIN_MOMENTUM": 0.05,
    "REAL_ENTRY_MIN_SIGNALS_AGR": 4,
    # FREEZE MODE entry (late dead-game execution)
    "FREEZE_ENTRY_MINUTE": 82,
    "FREEZE_ENTRY_HARD_MINUTE": 85,
    "FREEZE_ENTRY_LAM_TOTAL_MAX": 0.40,
    "FREEZE_ENTRY_MOMENTUM_ABS_MAX": 0.10,
    "FREEZE_ENTRY_PGOAL_MAX": 0.35,
    "FREEZE_NO_GOAL_MIN": 0.70,
    "FREEZE_DRAW_MC_MIN": 0.65,
    # SAFE FREEZE guard (anti xG asymmetry / anti latent counter)
    "FREEZE_QUALITY_CHECK_FROM_MINUTE": 80,
    "FREEZE_XG_ASYM_RATIO": 1.15,
    "FREEZE_XG_ABS_GAP_MIN": 0.08,
    "FREEZE_XG_ALERT_SIDE_MIN": 0.45,
    "FREEZE_LAM_LATENT_RATIO": 0.90,
    "FREEZE_BLOCK_ON_COUNTER_RISK": True,
    "FREEZE_BLOCK_ON_HIDDEN_GOAL_RISK": True,
    # GOAL EVENT override (visok P(goal), smer nejasna)
    "GOAL_EVENT_OVERRIDE_MINUTE": 60,
    "GOAL_EVENT_OVERRIDE_PGOAL_MIN": 0.70,
    "GOAL_EVENT_OVERRIDE_DIR_CONF_MAX": 0.55,
    "GOAL_EVENT_OVERRIDE_LAM_GAP_MAX": 0.15,
    "GOAL_EVENT_CHAOS_PGOAL_MIN": 0.50,
    "GOAL_EVENT_CHAOS_TEMPO_DANGER_MIN": 1.20,
    "GOAL_EVENT_CHAOS_TEMPO_SHOTS_MIN": 0.25,
    "GOAL_EVENT_CHAOS_MOM_ABS_MIN": 0.18,
    "GOAL_EVENT_SIDE_GAP_MAX": 0.15,
    "LOW_EVENT_LAM_TOTAL_MAX": 0.90,
    # EDGE MODE (profit-first soft entry)
    "EDGE_MODE_MINUTE": 70,
    "EDGE_MODE_MAX_MINUTE": 88,
    "EDGE_MODE_PROB_MIN": 0.40,
    "EDGE_MODE_PROB_MAX": 0.60,
    "EDGE_MODE_SIDE_GAP_MIN": 0.02,
    "EDGE_MODE_PGOAL_MIN": 0.45,
    "EDGE_MODE_P_NO_GOAL_MAX": 0.60,
    "EDGE_MODE_TEMPO_DANGER_MIN": 1.20,
    "EDGE_MODE_TEMPO_SHOTS_MIN": 0.24,
    "EDGE_MODE_REQUIRE_WAVE": True,
    # GOAL EVENT engine (OVER/UNDER fallback when direction is unclear)
    "GOAL_EVENT_ENGINE_OVER_MINUTE": 65,
    "GOAL_EVENT_ENGINE_OVER_PGOAL_MIN": 0.60,
    "GOAL_EVENT_ENGINE_OVER_TEMPO_DANGER_MIN": 1.30,
    "GOAL_EVENT_ENGINE_UNDER_MINUTE": 75,
    "GOAL_EVENT_ENGINE_UNDER_PGOAL_MAX": 0.45,
    "GOAL_EVENT_ENGINE_UNDER_PNOGOAL_MIN": 0.55,
    "GOAL_EVENT_LAMBDA_GATE_PGOAL_MIN": 0.65,
    "GOAL_EVENT_LAMBDA_GATE_LAM_TOTAL_MIN": 1.00,
    # Goal-event only mode (high p_goal, weak/contradictory direction)
    "GOAL_EVENT_ONLY_ENABLE": True,
    "GOAL_EVENT_ONLY_MINUTE": 50,
    "GOAL_EVENT_ONLY_PGOAL_MIN": 0.70,
    "GOAL_EVENT_ONLY_DIR_CONF_MAX": 0.55,
    "GOAL_EVENT_ONLY_SIDE_GAP_MAX": 0.15,
    "GOAL_EVENT_ONLY_REQUIRE_TIMING_BLOCK": True,
    "GOAL_EVENT_ONLY_REQUIRE_SIDE_CONFLICT": True,
    # GOAL ONLY engine (event lane neodvisno od direction lane)
    "GOAL_ONLY_MINUTE": 70,
    "GOAL_ONLY_WATCH_PGOAL_MIN": 0.50,
    "GOAL_ONLY_WATCH_PGOAL10_MIN": 0.45,
    "GOAL_ONLY_WATCH_TEMPO_SHOTS_MIN": 0.24,
    "GOAL_ONLY_WATCH_TEMPO_DANGER_MIN": 1.10,
    "GOAL_ONLY_WATCH_SIDE_GAP_MAX": 0.28,
    "GOAL_ONLY_ACTIVE_PGOAL_MIN": 0.60,
    "GOAL_ONLY_ACTIVE_PGOAL5_MIN": 0.30,
    "GOAL_ONLY_ACTIVE_PGOAL10_MIN": 0.50,
    "GOAL_ONLY_ACTIVE_TEMPO_SHOTS_MIN": 0.26,
    "GOAL_ONLY_ACTIVE_TEMPO_DANGER_MIN": 1.15,
    "GOAL_ONLY_ACTIVE_SIDE_GAP_MAX": 0.24,
    "GOAL_ONLY_PROFILE": "BALANCED",
    # Goal detector linkage (event engine tuning)
    "GOAL_DETECTOR_MIN_PROB_FOR_OVER_BOOST": 0.50,
    "GOAL_DETECTOR_OVER_BOOST_IF_VERY_LIKELY": 0.05,
    "GOAL_DETECTOR_BLOCK_OVER_ON_TOO_LATE": True,
    "GOAL_DETECTOR_ALLOW_UNDER_ON_TOO_LATE": True,
    # Goal detector v2 (lambda + p_goal first)
    "GOAL_DETECTOR_LAM_TOTAL_STRONG": 1.00,
    "GOAL_DETECTOR_LAM_TOTAL_MID": 0.80,
    "GOAL_DETECTOR_PGOAL_STRONG": 0.60,
    "GOAL_DETECTOR_PGOAL_MID": 0.50,
    "GOAL_DETECTOR_TEMPO_SHOTS_MIN": 0.18,
    # Early goal-event bypass (bet discipline stays for side, not for pure goal event)
    "EARLY_GOAL_EVENT_PGOAL_MIN": 0.65,
    "EARLY_GOAL_EVENT_LAM_TOTAL_MIN": 1.00,
    # PRE-ENTRY mode (setup se gradi)
    "PRE_ENTRY_PGOAL_MIN": 0.60,
    "PRE_ENTRY_PGOAL10_MAX": 0.35,
    "PRE_ENTRY_LAM_SIDE_RATIO": 1.50,
    "PRE_ENTRY_TRIGGER_PGOAL10_MIN": 0.35,
    "PRE_ENTRY_TRIGGER_TEMPO_DANGER_MIN": 1.00,
    "PRE_ENTRY_DIRECT_PGOAL_MIN": 0.70,
    "PRE_ENTRY_DIRECT_PGOAL10_MIN": 0.35,
    "PRE_ENTRY_PREPARE_FROM_MINUTE": 55,
    "PRE_ENTRY_PREPARE_PGOAL10_MIN": 0.28,
    "PRE_ENTRY_PREPARE_MOM_MIN": 0.14,
    # Semi-wave (high pressure without formal wave flag)
    "SEMI_WAVE_TEMPO_DANGER_MIN": 1.20,
    "SEMI_WAVE_TEMPO_SHOTS_MIN": 0.22,
    "SEMI_WAVE_MOM_MIN": 0.20,
    "SEMI_WAVE_LAM_TOTAL_MIN": 1.00,
    # Micro entry (controlled gray-zone execution)
    "MICRO_ENTRY_ENABLE": True,
    "MICRO_ENTRY_MINUTE": 55,
    "MICRO_ENTRY_MAX_MINUTE": 88,
    "MICRO_ENTRY_PGOAL_MIN": 0.65,
    "MICRO_ENTRY_PGOAL10_MAX": 0.35,
    "MICRO_ENTRY_MOM_MIN": 0.14,
    "MICRO_ENTRY_STAKE_UNITS": 0.2,
    # NEXT GOAL context-aware filters (kill/quality/timing/wave)
    "NG_KILL_FILTER_MINUTE": 75,
    "NG_KILL_FILTER_LAM_TOTAL_MAX": 0.75,
    "NG_KILL_FILTER_SCALE": 0.65,
    "NG_LOSING_PRESSURE_MOM_MIN": 0.12,
    "NG_LOSING_PRESSURE_SCALE": 0.88,
    "NG_QUALITY_D2S_MIN": 0.18,
    "NG_QUALITY_SOT_RATIO_MIN": 0.25,
    "NG_QUALITY_SCALE": 0.85,
    "NG_TIMING_10M_LOW": 0.30,
    "NG_TIMING_10M_LOW_SCALE": 0.75,
    "NG_TIMING_10M_HIGH": 0.45,
    "NG_TIMING_10M_HIGH_SCALE": 1.10,
    "NG_WAVE_BOOST": 1.25,
    # SMART confidence context penalties
    "NG_CONF_LAM_TOTAL_LOW": 0.70,
    "NG_CONF_LAM_PENALTY": 0.70,
    "NG_CONF_NO_WAVE_PENALTY": 0.85,
    "NG_CONF_PGOAL10_LOW": 0.30,
    "NG_CONF_PGOAL10_PENALTY": 0.80,
    # Dominance failure / equalizer flip logic
    "NG_DOM_FAIL_FROM_MINUTE": 60,
    "NG_DOM_FAIL_LAM_RATIO_MIN": 2.0,
    "NG_DOM_FAIL_PGOAL10_MAX": 0.25,
    "NG_DOM_FAIL_DOMINANT_SCALE": 0.85,
    "NG_DOM_FAIL_UNDERDOG_BOOST": 1.15,
    "NG_COUNTER_EQ_DOM_RATIO": 1.20,
    "NG_COUNTER_EQ_PGOAL10_MAX": 0.28,
    "NG_COUNTER_EQ_BOOST": 1.20,
    # Early phase soft unlock for build-up monitoring (60/65)
    "EARLY_BUILDUP_FROM_MINUTE": 60,
    "EARLY_BUILDUP_PGOAL_MIN": 0.55,
    "EARLY_BUILDUP_PGOAL10_MIN": 0.28,
    "EARLY_PRETRIGGER_FROM_MINUTE": 65,
    "EARLY_PRETRIGGER_PGOAL_MIN": 0.60,
    "EARLY_PRETRIGGER_PGOAL10_MIN": 0.32,
    "EARLY_PRETRIGGER_SIDE_GAP_MIN": 0.06,
    # Comeback aggressive entry (signal > short timing filter in 65-80)
    "COMEBACK_AGGR_MINUTE": 65,
    "COMEBACK_AGGR_MAX_MINUTE": 80,
    "COMEBACK_AGGR_SCORE_DIFF": 1,
    "COMEBACK_AGGR_LAM_RATIO_MIN": 1.30,
    "COMEBACK_AGGR_TEMPO_DANGER_MIN": 1.20,
    "COMEBACK_AGGR_MOM_MIN": 0.12,
    "COMEBACK_AGGR_ALLOW_NO_WAVE": True,
    "COMEBACK_FORCE_ENTRY_ENABLE": True,
    "COMEBACK_FORCE_ENTRY_LAM_RATIO_MIN": 1.40,
    "COMEBACK_FORCE_ENTRY_TEMPO_DANGER_MIN": 1.25,
    # Early goal build-up entry (prevent "wait until late trigger")
    "EARLY_GOAL_BUILDUP_ENABLE": True,
    "EARLY_GOAL_BUILDUP_MINUTE": 60,
    "EARLY_GOAL_BUILDUP_PGOAL_MIN": 0.45,
    "EARLY_GOAL_BUILDUP_TEMPO_DANGER_MIN": 0.60,
    "EARLY_GOAL_BUILDUP_LAM_TOTAL_MIN": 0.60,
    "EARLY_GOAL_BUILDUP_DIR_GAP_MIN": 0.05,
    "EARLY_GOAL_BUILDUP_AGGR_PGOAL_MIN": 0.60,
    # Fallback wave trigger (prepreči ATTACK_WAVE vs wave=NO konflikt)
    "WAVE_FALLBACK_FROM_MINUTE": 5,
    "WAVE_FALLBACK_TEMPO_DANGER_MIN": 1.40,
    "WAVE_FALLBACK_MOMENTUM_MIN": 0.15,
    # Latent goal signal (INFO ONLY, brez entry)
    "LATENT_SIGNAL_MOM_MIN": 0.20,
    "LATENT_SIGNAL_DANGER_RATIO": 1.30,
    "LATENT_SIGNAL_PGOAL10_MAX": 0.30,
    "LATENT_SIGNAL_PGOAL_MIN": 0.45,
}

# GOAL ONLY profile presets (strict / balanced / aggressive)
GOAL_ONLY_PRESETS = {
    "STRICT": {
        "GOAL_ONLY_MINUTE": 72,
        "GOAL_ONLY_WATCH_PGOAL_MIN": 0.54,
        "GOAL_ONLY_WATCH_PGOAL10_MIN": 0.47,
        "GOAL_ONLY_WATCH_TEMPO_SHOTS_MIN": 0.25,
        "GOAL_ONLY_WATCH_TEMPO_DANGER_MIN": 1.12,
        "GOAL_ONLY_WATCH_SIDE_GAP_MAX": 0.26,
        "GOAL_ONLY_ACTIVE_PGOAL_MIN": 0.63,
        "GOAL_ONLY_ACTIVE_PGOAL5_MIN": 0.31,
        "GOAL_ONLY_ACTIVE_PGOAL10_MIN": 0.52,
        "GOAL_ONLY_ACTIVE_TEMPO_SHOTS_MIN": 0.27,
        "GOAL_ONLY_ACTIVE_TEMPO_DANGER_MIN": 1.18,
        "GOAL_ONLY_ACTIVE_SIDE_GAP_MAX": 0.22,
    },
    "BALANCED": {
        "GOAL_ONLY_MINUTE": 70,
        "GOAL_ONLY_WATCH_PGOAL_MIN": 0.50,
    ...
    "AGGRESSIVE": {
        "GOAL_ONLY_MINUTE": 68,
        "GOAL_ONLY_WATCH_PGOAL_MIN": 0.48,
        "GOAL_ONLY_WATCH_PGOAL10_MIN": 0.43,
        "GOAL_ONLY_WATCH_TEMPO_SHOTS_MIN": 0.23,
        "GOAL_ONLY_WATCH_TEMPO_DANGER_MIN": 1.05,
        "GOAL_ONLY_WATCH_SIDE_GAP_MAX": 0.30,
        "GOAL_ONLY_ACTIVE_PGOAL_MIN": 0.58,
        "GOAL_ONLY_ACTIVE_PGOAL5_MIN": 0.28,
        "GOAL_ONLY_ACTIVE_PGOAL10_MIN": 0.48,
        "GOAL_ONLY_ACTIVE_TEMPO_SHOTS_MIN": 0.25,
        "GOAL_ONLY_ACTIVE_TEMPO_DANGER_MIN": 1.10,
        "GOAL_ONLY_ACTIVE_SIDE_GAP_MAX": 0.26,
    },
}


def _apply_goal_only_profile():
    profile = str(CFG.get("GOAL_ONLY_PROFILE", "BALANCED") or "BALANCED").strip().upper()
    if profile not in GOAL_ONLY_PRESETS:
        profile = "BALANCED"
    CFG.update(GOAL_ONLY_PRESETS[profile])
    CFG["GOAL_ONLY_PROFILE_ACTIVE"] = profile


_apply_goal_only_profile()


def _compute_context_timing(
    *,
    minute,
    score_diff,
    wave_active,
    ...
    """
    CONTEXT (game_state_v2 + intent) + TIMING (pre_trigger / entry / kill).
    Hevristika — ne spreminja picks; samo opis konteksta + filtri v bet_decision.
    """
    minute = int(float(minute or 0))
    score_diff = int(float(score_diff or 0))
    wave_active = bool(wave_active)
    tempo_shots = float(tempo_shots or 0.0)
    tempo_danger = float(tempo_danger or 0.0)
    momentum = float(momentum or 0.0)
    lam_h = float(lam_h or 0.0)
    lam_a = float(lam_a or 0.0)
    pos_h = float(pos_h or 0.0)
    pos_a = float(pos_a or 0.0)
    ...
    shot_q_h = float(shot_q_h or 0.0)
    shot_q_a = float(shot_q_a or 0.0)
    mc_h = float(mc_h or 0.0)
    mc_a = float(mc_a or 0.0)

    if minute < int(CFG.get("TIMING_ENTRY_FROM", 70)):
        timing_state = "PRE_TRIGGER"
    elif minute < int(CFG.get("TIMING_KILL_FROM", 85)):
        timing_state = "ENTRY"
    else:
        timing_state = "KILL"

    chaos_like = (
        tempo_shots > float(CFG.get("CHAOS_TEMPO_SHOTS", 0.25))
        and tempo_danger > float(CFG.get("CHAOS_TEMPO_DANGER", 1.10))
    )
    strong_wave = wave_active and tempo_danger > 1.00
    kill_min = int(CFG.get("KILL_GAME_MINUTE", 75))
    ...
    if (
        ...
        and (not strong_wave)
        and (
            (score_diff > 0 and mc_h >= 0.60)
            or (score_diff < 0 and mc_a >= 0.60)
        )
    ):
        game_state_v2 = "KILL_GAME"
    elif score_diff < 0 and (lam_h > lam_a or momentum > 0.05) and minute >= 55:
        game_state_v2 = "COMEBACK"
    elif chaos_like and (not wave_active):
        game_state_v2 = "CHAOS"
    elif strong_wave:
        game_state_v2 = "CHAOS"
    else:
        game_state_v2 = "BALANCED"

    hi_pos = float(CFG.get("INTENT_HIGH_POS", 58.0))
    lo_pos = float(CFG.get("INTENT_PARK_BUS_POS", 42.0))
    ctr_ratio = float(CFG.get("INTENT_COUNTER_DANGER_RATIO", 1.25))

    def _intent(side_h):
        pos_s = pos_h if side_h else pos_a
        pos_o = pos_a if side_h else pos_h
        dg_s = danger_h if side_h else danger_a
        dg_o = danger_a if side_h else danger_h
        pr_s = pressure_h if side_h else pressure_a
        pr_o = pressure_a if side_h else pressure_h
        sq_s = shot_q_h if side_h else shot_q_a
        lam_s = lam_h if side_h else lam_a
        lam_o = lam_a if side_h else lam_h
        sd_sign = score_diff if side_h else -score_diff

        # PARK BUS: vodi + nizka posest + ni λ + pozno
        if (
            minute >= kill_min
            and sd_sign > 0
            and pos_s > 0
            ...
            return "PARK_BUS"
        # COUNTER: manj posesti, a več nevarnosti / kakovosti
        if (
            pos_s > 0
            and pos_s < 50.0
            and dg_s * 1.0 >= dg_o * ctr_ratio
            and (sq_s >= 0.12 or lam_s >= lam_o)
        ):
            return "COUNTER"
        # CONTROL: visoka posest in ne bolj pritiska soperec
        if pos_s >= hi_pos and dg_s >= dg_o * 0.85 and pr_s >= pr_o * 0.85:
            return "CONTROL"
        # ATTACK: večji pritisk / danger brez visoke posesti
        if dg_s > dg_o and pr_s > pr_o:
            return "ATTACK"
        return "NEUTRAL"

    intent_home = _intent(True)
    intent_away = _intent(False)

    # Korekcije: če je pritisk razglašen za fake, "ATTACK" degradiraj na "NEUTRAL" za to stran
    if fake_home_pressure and intent_home == "ATTACK":
        intent_home = "NEUTRAL"
    if fake_away_pressure and intent_away == "ATTACK":
        intent_away = "NEUTRAL"
    # Gold rule: 75+ trail → HOME ni ATTACK nosilec
    if ignore_home_pressure and intent_home == "ATTACK":
        intent_home = "NEUTRAL"

    notes = []
    if pre_trigger_chaos:
        notes.append("PRE-TRIGGER CHAOS")
    if dual_threat_mode:
        notes.append("DUAL THREAT")
    if hidden_goal_risk:
        notes.append("HIDDEN RISK")
    if fake_home_pressure:
        notes.append("FAKE HOME")
    if fake_away_pressure:
        notes.append("FAKE AWAY")

    return {
        "game_state_v2": game_state_v2,
        "intent_home": intent_home,
        "intent_away": intent_away,
        "timing_state": timing_state,
        "context_notes": notes,
    }


def cfos_log_ex(where: str, err: BaseException, *, critical: bool = False) -> None:
    """Ne tihi pass: vsaj en vrstični izpis v CMD (za debug CSV/memory)."""
    tag = "CRITICAL" if critical else "WARNING"
    try:
        print(f"[CFOS {tag}] {where}: {type(err).__name__}: {err}")
    except Exception:
        pass
...
def init_ansi():
    if os.name == "nt":
        try:
            ...
            cfos_log_ex("init_ansi(os.system)", e)
            return False
    return True
...
def _detect_fake_pressure_guard(danger_h, danger_a, pos_h, pos_a, xg_h, xg_a):
    """
    Enotna fake-pressure detekcija (shared med GDE snapshot in bet_decision).
    """
    _fp_pos_min = float(CFG.get("FAKE_PRESSURE_POSSESSION_MIN", 60.0))
    _fp_xg_max = float(CFG.get("FAKE_PRESSURE_XG_MAX", 0.30))
    fake_home = ((float(danger_h or 0.0) > float(danger_a or 0.0)) or (float(pos_h or 0.0) > _fp_pos_min)) and (float(xg_h or 0.0) < _fp_xg_max)
    fake_away = ((float(danger_a or 0.0) > float(danger_h or 0.0)) or (float(pos_a or 0.0) > _fp_pos_min)) and (float(xg_a or 0.0) < _fp_xg_max)
    side = "HOME" if fake_home else ("AWAY" if fake_away else "NONE")
    reason = ""
    if side == "HOME":
        reason = "FAKE HOME PRESSURE: danger/possession without xG quality"
    elif side == "AWAY":
        reason = "FAKE AWAY PRESSURE: danger/possession without xG quality"
    return bool(fake_home or fake_away), side, reason


def _freeze_mode_flags(r):
    minute = int(float(r.get("minute", 0) or 0))
    score_diff = int(float(r.get("score_diff", 0) or 0))
    lam_total = float(r.get("lam_total", (float(r.get("lam_h", 0) or 0) + float(r.get("lam_a", 0) or 0))) or 0.0)
    momentum = float(r.get("momentum", 0) or 0.0)
    wave_active = bool((r.get("wave") or {}).get("active", False))
    p_goal = float(r.get("p_goal", 0) or 0.0)

    freeze_soft = (
        minute >= int(CFG.get("FREEZE_ENTRY_MINUTE", 82))
        and lam_total < float(CFG.get("FREEZE_ENTRY_LAM_TOTAL_MAX", 0.40))
        and (not wave_active)
        and abs(momentum) < float(CFG.get("FREEZE_ENTRY_MOMENTUM_ABS_MAX", 0.10))
    )
    freeze_hard = (
        minute >= int(CFG.get("FREEZE_ENTRY_HARD_MINUTE", 85))
        and p_goal < float(CFG.get("FREEZE_ENTRY_PGOAL_MAX", 0.35))
        and score_diff == 0
    )
    freeze_base = bool(freeze_soft or freeze_hard)
    if not freeze_base:
        return False, False

    freeze_quality_from = int(CFG.get("FREEZE_QUALITY_CHECK_FROM_MINUTE", 80))
    xg_h = float(r.get("xg_h", 0.0) or 0.0)
    xg_a = float(r.get("xg_a", 0.0) or 0.0)
    lam_h = float(r.get("lam_h", 0.0) or 0.0)
    lam_a = float(r.get("lam_a", 0.0) or 0.0)
    xg_ratio = float(CFG.get("FREEZE_XG_ASYM_RATIO", 1.15))
    xg_gap_min = float(CFG.get("FREEZE_XG_ABS_GAP_MIN", 0.08))
    xg_alert_side_min = float(CFG.get("FREEZE_XG_ALERT_SIDE_MIN", 0.45))
    lam_latent_ratio = float(CFG.get("FREEZE_LAM_LATENT_RATIO", 0.90))
    counter_risk = bool(r.get("counter_risk", False))
    hidden_goal_risk = bool(r.get("hidden_goal_risk", False))
    fake_home = bool(r.get("fake_home_pressure", False))
    fake_away = bool(r.get("fake_away_pressure", False))

    quality_alert = False
    if minute >= freeze_quality_from:
        away_kill = (
            xg_a > max(0.01, xg_h) * xg_ratio
            and (xg_a - xg_h) > xg_gap_min
            and xg_a >= xg_alert_side_min
            and lam_a >= (lam_h * lam_latent_ratio)
        )
        home_kill = (
            xg_h > max(0.01, xg_a) * xg_ratio
            and (xg_h - xg_a) > xg_gap_min
            and xg_h >= xg_alert_side_min
            and lam_h >= (lam_a * lam_latent_ratio)
        )
        fake_trap_alert = (
            (fake_home and (xg_a > xg_h + 0.05) and lam_a >= (lam_h * lam_latent_ratio))
            or (fake_away and (xg_h > xg_a + 0.05) and lam_h >= (lam_a * lam_latent_ratio))
        )
        quality_alert = bool(away_kill or home_kill or fake_trap_alert)

    if bool(CFG.get("FREEZE_BLOCK_ON_COUNTER_RISK", True)) and counter_risk:
        quality_alert = True
    if bool(CFG.get("FREEZE_BLOCK_ON_HIDDEN_GOAL_RISK", True)) and hidden_goal_risk:
        quality_alert = True

    if quality_alert:
        return False, False
    return True, bool(freeze_hard)


def _freeze_mode_status_text(r):
    minute = int(float(r.get("minute", 0) or 0))
    score_diff = int(float(r.get("score_diff", 0) or 0))
    lam_total = float(r.get("lam_total", (float(r.get("lam_h", 0) or 0) + float(r.get("lam_a", 0) or 0))) or 0.0)
    momentum = float(r.get("momentum", 0) or 0.0)
    ...
    freeze_raw = bool(freeze_soft_raw or freeze_hard_raw)
    freeze_mode, freeze_hard = _freeze_mode_flags(r)

    if freeze_mode:
        if freeze_hard:
            return "ACTIVE", "85+ hard (nizka P(goal), izenačeno)"
        return "ACTIVE", "82+ soft (nizka lambda, brez vala, nizek momentum)"
    ...
    if freeze_raw:
        ...
        lam_h = float(r.get("lam_h", 0.0) or 0.0)
        lam_a = float(r.get("lam_a", 0.0) or 0.0)
        xg_gap = abs(xg_h - xg_a)
        if bool(CFG.get("FREEZE_BLOCK_ON_COUNTER_RISK", True)) and bool(r.get("counter_risk", False)):
            return "BLOCKED", "anti-freeze: counter risk"
        if bool(CFG.get("FREEZE_BLOCK_ON_HIDDEN_GOAL_RISK", True)) and bool(r.get("hidden_goal_risk", False)):
            return "BLOCKED", "anti-freeze: hidden goal risk"
        if xg_gap >= float(CFG.get("FREEZE_XG_ABS_GAP_MIN", 0.08)):
            side = "AWAY" if xg_a > xg_h else "HOME"
            return "BLOCKED", f"anti-freeze: xG asymmetry ({side})"
        if (lam_a >= lam_h * float(CFG.get("FREEZE_LAM_LATENT_RATIO", 0.90)) and xg_a > xg_h + 0.05) or (
            lam_h >= lam_a * float(CFG.get("FREEZE_LAM_LATENT_RATIO", 0.90)) and xg_h > xg_a + 0.05
        ):
            return "BLOCKED", "anti-freeze: latent quality threat"
        return "BLOCKED", "anti-freeze: quality guard"

    return "INACTIVE", "pogoji niso izpolnjeni"


def _execute_check_model(r, main_bet, confidence=""):
    """
    GO pravilo po trgu:
      - GOAL market (NEXT GOAL / NO GOAL / OVER-UNDER): min 6/8 + obvezna 2/2
      - MATCH market (HOME / DRAW / AWAY): min 5/7 + obvezna 2/2 (MAIN BET + VALUE CORE)
    """
    bet = str(main_bet or "").strip().upper()
    conf = str(confidence or "").strip().upper()
    final_reason = str(r.get("final_auto_reason", "") or "").strip().upper()
    override_active = bool(
        r.get("goal_decision_engine_override_active", False)
        or r.get("low_event_breakout_active", False)
        or ("GOAL DECISION ENGINE OVERRIDE" in final_reason)
        or ("LOW EVENT BREAKOUT:" in final_reason)
    )
    gt = r.get("goal_timing") or {}
    entry = str(gt.get("entry", "WAIT") or "WAIT").strip().upper()
    ng_level = str(r.get("ng_window_level", "HOLD") or "HOLD").strip().upper()
    pre_trigger = bool(r.get("pre_trigger_chaos", False))
    dual_threat = bool(r.get("dual_threat_mode", False))
    hidden_goal_risk = bool(r.get("hidden_goal_risk", False))
    fake_home = bool(r.get("fake_home_pressure", False))
    fake_away = bool(r.get("fake_away_pressure", False))
    ignore_home = bool(r.get("ignore_home_pressure", False))
    fake_side_lock = ("HOME" in bet and fake_home) or ("AWAY" in bet and fake_away)
    gold_home_lock = ("HOME" in bet and ignore_home)

    freeze_mode, _freeze_hard = _freeze_mode_flags(r)
    edge_mode_active = bool(r.get("edge_mode_active", False))
    is_match_market = bet in ("HOME", "DRAW", "AWAY")
    is_goal_event_pick = bet in ("GOAL YES", "OVER", "OVER / GOAL YES", "NO GOAL", "UNDER", "NO GOAL / UNDER")
    is_freeze_no_goal = bet == "NO GOAL" and freeze_mode
    market_type = "FREEZE" if is_freeze_no_goal else ("MATCH" if is_match_market else ("EVENT" if is_goal_event_pick else "GOAL"))

    minute = int(float(r.get("minute", 0) or 0))
    p_goal = float(r.get("p_goal", 0.0) or 0.0)
    p_no_goal = float(r.get("p_no_goal", max(0.0, 1.0 - p_goal)) or max(0.0, 1.0 - p_goal))
    ng_conf = float((r.get("next_goal_prediction_smart") or {}).get("confidence", 0.0) or 0.0)
    lam_h = float(r.get("lam_h", 0.0) or 0.0)
    lam_a = float(r.get("lam_a", 0.0) or 0.0)
    lam_total_evt = float(r.get("lam_total", (lam_h + lam_a)) or (lam_h + lam_a))
    lam_gap = abs(lam_h - lam_a)
    side_gap = abs(float(r.get("p_home_next", 0.0) or 0.0) - float(r.get("p_away_next", 0.0) or 0.0))
    tempo_danger = float(r.get("tempo_danger", 0.0) or 0.0)
    tempo_shots = float(r.get("tempo_shots", 0.0) or 0.0)
    momentum = float(r.get("momentum", 0.0) or 0.0)
    wave_active = bool((r.get("wave") or {}).get("active", False))
    game_type = str(r.get("game_type", "") or "").strip().upper()
    chaos_open = game_type in ("CHAOS", "ATTACK_WAVE", "OPEN CHAOS")
    base_event_core_ok = (
        minute >= int(CFG.get("GOAL_EVENT_OVERRIDE_MINUTE", 60))
        and p_goal >= float(CFG.get("GOAL_EVENT_OVERRIDE_PGOAL_MIN", 0.70))
        and ng_conf <= float(CFG.get("GOAL_EVENT_OVERRIDE_DIR_CONF_MAX", 0.55))
        and lam_gap <= float(CFG.get("GOAL_EVENT_OVERRIDE_LAM_GAP_MAX", 0.15))
    )
    chaos_event_core_ok = (
        minute >= int(CFG.get("GOAL_EVENT_OVERRIDE_MINUTE", 60))
        and p_goal >= float(CFG.get("GOAL_EVENT_CHAOS_PGOAL_MIN", 0.50))
        and ng_conf <= float(CFG.get("GOAL_EVENT_OVERRIDE_DIR_CONF_MAX", 0.55))
        and side_gap <= float(CFG.get("GOAL_EVENT_SIDE_GAP_MAX", 0.15))
        and (
            wave_active
            or tempo_danger >= float(CFG.get("GOAL_EVENT_CHAOS_TEMPO_DANGER_MIN", 1.20))
            or tempo_shots >= float(CFG.get("GOAL_EVENT_CHAOS_TEMPO_SHOTS_MIN", 0.25))
            or abs(momentum) >= float(CFG.get("GOAL_EVENT_CHAOS_MOM_ABS_MIN", 0.18))
            or chaos_open
        )
    )
    under_event_core_ok = (
        minute >= int(CFG.get("GOAL_EVENT_ENGINE_UNDER_MINUTE", 75))
        and p_goal <= float(CFG.get("GOAL_EVENT_ENGINE_UNDER_PGOAL_MAX", 0.45))
        and p_no_goal >= float(CFG.get("GOAL_EVENT_ENGINE_UNDER_PNOGOAL_MIN", 0.55))
    )
    lambda_event_gate_ok = (
        p_goal >= float(CFG.get("GOAL_EVENT_LAMBDA_GATE_PGOAL_MIN", 0.65))
        and lam_total_evt >= float(CFG.get("GOAL_EVENT_LAMBDA_GATE_LAM_TOTAL_MIN", 1.00))
    )
    event_core_ok = bool(
        under_event_core_ok
        if bet in ("NO GOAL", "UNDER", "NO GOAL / UNDER")
        else (base_event_core_ok or chaos_event_core_ok or lambda_event_gate_ok)
    )
    event_exec_force = bool(
        (
            bet in ("GOAL YES", "OVER", "OVER / GOAL YES")
            and p_goal >= float(CFG.get("GOAL_EVENT_EXEC_PGOAL_MIN", 0.65))
        )
        or (
            bet in ("NO GOAL", "UNDER", "NO GOAL / UNDER")
            and p_no_goal >= float(CFG.get("GOAL_EVENT_EXEC_PNOGOAL_MIN", 0.55))
        )
    )

    mc_h = float(r.get("mc_h_adj", r.get("mc_h_raw", 0.0)) or 0.0)
    mc_x = float(r.get("mc_x_adj", r.get("mc_x_raw", 0.0)) or 0.0)
    mc_a = float(r.get("mc_a_adj", r.get("mc_a_raw", 0.0)) or 0.0)
    edge_h = float(r.get("edge_h", 0.0) or 0.0)
    edge_x = float(r.get("edge_x", 0.0) or 0.0)
    edge_a = float(r.get("edge_a", 0.0) or 0.0)
    match_edge_min = float(CFG.get("MATCH_VALUE_FORCE_EDGE", 0.20))
    match_mc_min = float(CFG.get("MATCH_VALUE_FORCE_MC", 0.70))
    if bet == "HOME":
        pick_edge, pick_mc = edge_h, mc_h
    elif bet == "DRAW":
        pick_edge, pick_mc = edge_x, mc_x
    elif bet == "AWAY":
        pick_edge, pick_mc = edge_a, mc_a
    else:
        pick_edge, pick_mc = 0.0, 0.0
    value_core_ok = (pick_edge >= match_edge_min) and (pick_mc >= match_mc_min)
    value_or_freeze_ok = value_core_ok or (freeze_mode and bet in ("DRAW", "NO GOAL"))

    timing_ok = (entry == "ENTRY") or edge_mode_active or override_active
    window_ok = (ng_level not in ("HOLD", "PRE-TRIGGER")) or override_active
    pre_trigger_ok = (not pre_trigger) or override_active

    if is_goal_event_pick:
        event_conf_ok = (conf != "LOW") or event_exec_force or override_active
        a_checks = [
            ("MAIN BET != NO BET", bet not in ("", "NO BET", "NONE")),
            ("EVENT CORE (OVER/UNDER)", event_core_ok),
            ("BREZ PRE-TRIGGER", pre_trigger_ok),
            ("BREZ DUAL THREAT", not dual_threat),
            ("BREZ HIDDEN GOAL RISK", not hidden_goal_risk),
            ("CONF ni LOW", event_conf_ok),
        ]
        min_true = 4
    elif is_match_market or is_freeze_no_goal:
        a_checks = [
            ("MAIN BET != NO BET", bet not in ("", "NO BET", "NONE")),
            (f"VALUE CORE ali FREEZE MODE", value_or_freeze_ok),
            ("BREZ DUAL THREAT", not dual_threat),
            ("BREZ HIDDEN GOAL RISK", not hidden_goal_risk),
            ("BREZ FAKE locka za smer", not fake_side_lock),
            ("BREZ GOLD HOME locka", not gold_home_lock),
            ("CONF ni LOW", conf != "LOW"),
        ]
        min_true = 5
    else:
        a_checks = [
            ("MAIN BET != NO BET", bet not in ("", "NO BET", "NONE")),
            ("TIMING ENTRY ali EDGE MODE", timing_ok),
            ("OKNO ni HOLD/PRE-TRIGGER", window_ok),
            ("BREZ PRE-TRIGGER", pre_trigger_ok),
            ("BREZ DUAL THREAT", not dual_threat),
            ("BREZ FAKE locka za smer", not fake_side_lock),
            ("BREZ GOLD HOME locka", not gold_home_lock),
    ...
    a_true = sum(1 for _, ok in a_checks if ok)
    mandatory_ok = bool(a_checks[0][1]) and bool(a_checks[1][1])
    a_active = mandatory_ok and a_true >= min_true

    if is_goal_event_pick:
        b_checks = [
            ("MAIN BET = NO BET", bet in ("", "NO BET", "NONE")),
            ("EVENT CORE ni izpolnjen", not event_core_ok),
            ("PRE-TRIGGER aktiven", pre_trigger),
            ("DUAL THREAT aktiven", dual_threat),
            ("HIDDEN GOAL RISK aktiven", hidden_goal_risk),
            ("CONF LOW", (conf == "LOW") and (not event_conf_ok)),
        ]
    elif is_match_market or is_freeze_no_goal:
        b_checks = [
            ("MAIN BET = NO BET", bet in ("", "NO BET", "NONE")),
            ("VALUE/FREEZE pogoj ni izpolnjen", not value_or_freeze_ok),
            ("DUAL THREAT aktiven", dual_threat),
            ("HIDDEN GOAL RISK aktiven", hidden_goal_risk),
            ("FAKE lock za smer", fake_side_lock),
            ("GOLD HOME lock", gold_home_lock),
            ("CONF LOW", conf == "LOW"),
        ]
    else:
        b_checks = [
            ("MAIN BET = NO BET", bet in ("", "NO BET", "NONE")),
            ("TIMING ni ENTRY in EDGE MODE ni aktiven", (not timing_ok)),
            ("OKNO HOLD/PRE-TRIGGER", (not window_ok)),
            ("PRE-TRIGGER aktiven", (not pre_trigger_ok)),
            ("DUAL THREAT aktiven", dual_threat),
            ("FAKE lock za smer", fake_side_lock),
            ("GOLD HOME lock", gold_home_lock),
            ("CONF LOW", conf == "LOW"),
        ]
    b_active = not a_active
    return a_checks, b_checks, a_true, mandatory_ok, a_active, b_active, market_type, min_true, len(a_checks)


def _trade_execution_plan(r, final_bet, final_conf, a_active, market_type):
    """
    Trgovalni engine:
    - pripravljenost za vstop (DA/NE)
    - trg izvedbe
    - razlog izvedbe
    - value execution zastavica
    """
    bet = str(final_bet or "").strip().upper()
    conf_word = str(final_conf or "").strip().upper()
    final_reason = str(r.get("final_auto_reason", "") or "").strip().upper()
    override_active = bool(
        r.get("goal_decision_engine_override_active", False)
        or r.get("low_event_breakout_active", False)
    ...
    minute = int(float(r.get("minute", 0) or 0))
    endgame_lock = minute >= int(CFG.get("HARD_ENDGAME_NO_BET_MINUTE", 90))
    freeze_mode, _freeze_hard = _freeze_mode_flags(r)
    edge_mode_active = bool(r.get("edge_mode_active", False))

    ng = r.get("next_goal_prediction_smart") or {}
    ng_pred = str(ng.get("prediction", "") or "").strip().upper()
    ng_conf = float(ng.get("confidence", 0.0) or 0.0)
    conf_hide_min = float(CFG.get("EXEC_HIDE_SIGNAL_CONF_MIN", 0.40))
    hide_signal = ng_conf < conf_hide_min
    side_gap = abs(float(r.get("p_home_next", 0.0) or 0.0) - float(r.get("p_away_next", 0.0) or 0.0))
    side_clear_gap = float(CFG.get("TRADE_SIDE_CLEAR_GAP", 0.06))
    side_clear_conf = float(CFG.get("TRADE_SIDE_CLEAR_CONF", 0.65))
    side_clear = (ng_pred in ("HOME", "AWAY")) and (ng_conf >= side_clear_conf) and (side_gap >= side_clear_gap)
    p_goal_evt = float(r.get("p_goal", 0.0) or 0.0)
    p_no_goal_evt = float(r.get("p_no_goal", max(0.0, 1.0 - p_goal_evt)) or max(0.0, 1.0 - p_goal_evt))
    is_event_bet = bet in ("GOAL YES", "OVER", "OVER / GOAL YES", "NO GOAL", "UNDER", "NO GOAL / UNDER")
    event_exec_force = bool(
        is_event_bet
        and (
            (
                bet in ("GOAL YES", "OVER", "OVER / GOAL YES")
                and p_goal_evt >= float(CFG.get("GOAL_EVENT_EXEC_PGOAL_MIN", 0.65))
            )
            or (
                bet in ("NO GOAL", "UNDER", "NO GOAL / UNDER")
                and p_no_goal_evt >= float(CFG.get("GOAL_EVENT_EXEC_PNOGOAL_MIN", 0.55))
            )
        )
    )
    ...
    if endgame_lock:
        return {
            "ready": False,
            "market": "NO BET",
            "reason": "ENDGAME ZAKLEP 90+",
            "hide_signal": hide_signal,
            "value_exec": False,
            "value_reason": "ZAKLENJENO",
        }
    if override_active and bet not in ("", "NO BET", "NONE"):
        if bet.startswith("NEXT GOAL"):
            market_pick = bet
        elif bet in ("GOAL YES", "OVER", "OVER / GOAL YES"):
            market_pick = "OVER / GOAL YES (Next goal YES)"
        elif bet in ("NO GOAL", "UNDER", "NO GOAL / UNDER"):
            market_pick = "NO GOAL / UNDER"
        elif bet in ("HOME", "DRAW", "AWAY"):
            market_pick = f"1X2 {bet}"
        else:
            market_pick = bet
        return {
            "ready": True,
            "market": market_pick,
            "reason": "OVERRIDE: DIRECT EXECUTION (TIMING BYPASS)",
            "hide_signal": hide_signal,
            "value_exec": True,
            "value_reason": "OVERRIDE ACTIVE",
        }
    if event_exec_force:
        if bet in ("NO GOAL", "UNDER", "NO GOAL / UNDER"):
            market_pick = "NO GOAL / UNDER"
            force_reason = "EVENT EXECUTION: HIGH P(no-goal) (DIRECTION CONF IGNORED)"
        else:
            market_pick = "OVER / GOAL YES (Next goal YES)"
            force_reason = "EVENT EXECUTION: HIGH P(goal) (DIRECTION CONF IGNORED)"
        return {
            "ready": True,
            "market": market_pick,
            "reason": force_reason,
            "hide_signal": hide_signal,
            "value_exec": True,
            "value_reason": "GOAL EVENT FORCE",
        }
    if freeze_mode and bet in ("DRAW", "NO GOAL") and a_active:
        if bet == "DRAW":
            market_pick = "1X2 DRAW"
        else:
            market_pick = "UNDER / NO GOAL"
        return {
            "ready": True,
            "market": market_pick,
            "reason": "FREEZE MODE (pozna tekma, nizka lambda, brez vala)",
            "hide_signal": hide_signal,
            "value_exec": True,
            "value_reason": "FREEZE IZVEDBA",
        }
    if not a_active:
        return {
            "ready": False,
            "market": "NO BET",
            "reason": "VSTOPNI POGOJI NISO IZPOLNJENI",
            "hide_signal": hide_signal,
            "value_exec": bool(value_core_ok),
            "value_reason": "VALUE CORE AKTIVEN" if value_core_ok else "VALUE CORE IZKLOPLJEN",
        }

    # A je aktivna: izberi konkreten trg
    if market_type == "MATCH":
        market_pick = f"1X2 {bet}" if bet in ("HOME", "DRAW", "AWAY") else "1X2"
        return {
            "ready": True,
            "market": market_pick,
            "reason": "MATCH VALUE + PRIPRAVLJEN VSTOP",
            "hide_signal": hide_signal,
            "value_exec": bool(value_core_ok),
            "value_reason": "VALUE CORE AKTIVEN" if value_core_ok else "VALUE CORE IZKLOPLJEN",
        }
    if market_type == "EVENT" or bet in ("GOAL YES", "OVER", "OVER / GOAL YES", "NO GOAL", "UNDER", "NO GOAL / UNDER"):
        if bet in ("NO GOAL", "UNDER", "NO GOAL / UNDER"):
            return {
                "ready": True,
                "market": "NO GOAL / UNDER",
                "reason": "LOW GOAL PROB (EVENT ENGINE)",
                "hide_signal": hide_signal,
                "value_exec": True,
                "value_reason": "GOAL EVENT ENGINE",
            }
        return {
            "ready": True,
            "market": "OVER / GOAL YES (Next goal YES)",
            "reason": "HIGH GOAL PROB WITHOUT CLEAR SIDE",
            "hide_signal": hide_signal,
            "value_exec": True,
            "value_reason": "GOAL EVENT ENGINE",
        }
    if market_type == "FREEZE":
        market_pick = "UNDER / NO GOAL" if bet == "NO GOAL" else "1X2 DRAW"
        return {
            "ready": True,
            "market": market_pick,
            "reason": "FREEZE MODE (dead game)",
            "hide_signal": hide_signal,
            "value_exec": True,
            "value_reason": "FREEZE IZVEDBA",
        }
    ...
    # GOAL lane
    if hide_signal and (not side_clear):
        return {
            "ready": True,
            "market": "OVER/UNDER (BREZ SMERI)",
            "reason": f"SMART SIGNAL SKRIT (<{int(conf_hide_min*100)}%)",
            "hide_signal": True,
            "value_exec": True,
            "value_reason": "GOAL EVENT IZVEDBA",
        }
    if bet.startswith("NEXT GOAL"):
        if edge_mode_active:
            return {
                "ready": True,
                "market": bet,
                "reason": "EDGE MODE (SOFT ENTRY, 0.3)",
                "hide_signal": hide_signal,
                "value_exec": True,
                "value_reason": "EDGE MODE IZVEDBA",
            }
        return {
            "ready": True,
            "market": bet,
            "reason": "SMER JASNA (NEXT GOAL)",
            "hide_signal": hide_signal,
            "value_exec": True,
            "value_reason": "GOAL EVENT IZVEDBA",
        }
    if bet == "NO GOAL":
        return {
            "ready": True,
            "market": "UNDER / NO GOAL",
            "reason": "NIZKA GOAL-EVENT CONA",
            "hide_signal": hide_signal,
            "value_exec": True,
            "value_reason": "GOAL EVENT IZVEDBA",
        }
    ...
    return {
        "ready": True,
        "market": adv if adv else "OVER / GOAL YES",
        "reason": "GOAL EVENT (SMER NEJASNA)",
        "hide_signal": hide_signal,
        "value_exec": True,
        "value_reason": "GOAL EVENT IZVEDBA",
    }
...
def live_execution_status(r, main_bet, confidence=""):
    """
    Enotna GO / NO GO logika za live execute vrstico v CMD.
    """
    a_checks, _b_checks, a_true, mandatory_ok, a_active, _b_active, market_type, min_true, total_checks = _execute_check_model(r, main_bet, confidence)
    plan = _trade_execution_plan(r, main_bet, confidence, a_active, market_type)
    if bool(plan.get("ready", False)):
        return "GO", f"{market_type} {a_true}/{total_checks} | {str(plan.get('market', '')).strip()}"

    failed_mand = [lbl for lbl, ok in a_checks[:2] if not ok]
    failed_other = [lbl for lbl, ok in a_checks[2:] if not ok]
    reasons = failed_mand + failed_other[:3]

    def _short_reason(lbl: str) -> str:
        t = str(lbl or "").upper()
        if "MAIN BET != NO BET" in t:
            return "GLAVNA STAVA"
        if "TIMING ENTRY" in t:
            return "ČAS VSTOPA"
        if "VALUE CORE" in t:
            return "VALUE CORE"
        if "OKNO" in t:
        ...
        if "DUAL THREAT" in t:
            return "DUAL THREAT"
        if "HIDDEN GOAL RISK" in t:
            return "SKRITO TVEGANJE"
        if "FAKE" in t:
            return "LAŽEN SIGNAL"
        if "GOLD HOME" in t:
            return "GOLD HOME"
    ...
    short = [_short_reason(x) for x in reasons if str(x).strip()]
    if not short:
        short = ["premalo checkov"]
    ...
    why = ", ".join(uniq[:4])
    p_reason = str(plan.get("reason", "") or "").strip()
    if p_reason:
        return "NO GO", f"{market_type} {a_true}/{total_checks} | {p_reason} | manjka: {why}"
    return "NO GO", f"{market_type} {a_true}/{total_checks} | manjka: {why}"


def _a_bet_market_hint(r, final_bet, market_type, a_active):
    """
    Kratek predlog trga za A STAVA.
    Ko smer gola ni dovolj jasna, predlagaj OVER/UNDER (GOAL YES/NO GOAL).
    """
    fb = str(final_bet or "").strip().upper()
    if not a_active:
        return "❌ ČAKAJ (NO GO)"

    if market_type == "MATCH":
        if fb in ("HOME", "DRAW", "AWAY"):
            return f"✅ 1X2: {fb}"
        return "✅ 1X2 (MATCH)"

    # GOAL market
    if fb.startswith("NEXT GOAL"):
        return f"✅ {fb}"
    if fb == "NO GOAL":
        return "✅ OVER/UNDER: UNDER / NO GOAL"

    ng = r.get("next_goal_prediction_smart") or {}
    ng_pred = str(ng.get("prediction", "") or "").strip().upper()
    ng_conf = float(ng.get("confidence", 0.0) or 0.0)
    ph = float(r.get("p_home_next", 0.0) or 0.0)
    pa = float(r.get("p_away_next", 0.0) or 0.0)
    p_goal = float(r.get("p_goal", 0.0) or 0.0)
    side_gap = abs(ph - pa)
    adv = str(r.get("goal_event_market_advisory", "") or "").strip()

    side_clear = (ng_pred in ("HOME", "AWAY")) and (ng_conf >= 0.65) and (side_gap >= 0.06)
    if side_clear:
        return f"✅ NEXT GOAL {ng_pred}"

    if p_goal >= 0.55:
        if adv:
            return f"✅ OVER/UNDER: {adv} (smer gola nejasna)"
        return "✅ OVER/UNDER: OVER / GOAL YES (smer gola nejasna)"
    return "✅ OVER/UNDER: UNDER / NO GOAL (smer gola nejasna)"


def _signal_quality_summary(r):
    ng = r.get("next_goal_prediction_smart") or {}
    conf = float(ng.get("confidence", 0.0) or 0.0)
    agr = int(ng.get("signals_agreement", 0) or 0)
    if conf < float(CFG.get("EXEC_HIDE_SIGNAL_CONF_MIN", 0.40)):
        return "NIZKA", f"SMART {conf*100:.1f}% | skladnost {agr}/7"
    if conf >= 0.70 and agr >= 5:
        return "VISOKA", f"SMART {conf*100:.1f}% | skladnost {agr}/7"
    return "SREDNJA", f"SMART {conf*100:.1f}% | skladnost {agr}/7"


def _collect_conflict_warnings(r):
    warns = []
    game_type = str(r.get("game_type", "") or "").strip().upper()
    wave_active = bool((r.get("wave") or {}).get("active", False))
    if game_type == "ATTACK_WAVE" and (not wave_active):
        warns.append("KONFLIKT: game_type=ATTACK_WAVE, wave=NO")

    ng = str((r.get("next_goal_prediction_smart") or {}).get("prediction", "") or "").strip().upper()
    ph = float(r.get("p_home_next", 0.0) or 0.0)
    pa = float(r.get("p_away_next", 0.0) or 0.0)
    if ng == "HOME" and pa > ph + 0.05:
        warns.append("KONFLIKT: SMART=HOME, verjetnosti favorizirajo AWAY")
    elif ng == "AWAY" and ph > pa + 0.05:
        warns.append("KONFLIKT: SMART=AWAY, verjetnosti favorizirajo HOME")
    return warns


def print_execute_lanes_top(r):
    """
    Kratek semafor na vrhu CMD:
    A STAVA = GO lane
    B STAVA = NO GO lane
    """
    ...
    if fb in ("", "NONE"):
        fb = "NO BET"
    fc = str(r.get("final_auto_conf", "") or "").strip().upper()
    a_checks, b_checks, a_true, _mandatory_ok, a_active, b_active, market_type, min_true, total_checks = _execute_check_model(r, fb, fc)
    trade = _trade_execution_plan(r, fb, fc, a_active, market_type)
    _sig_q, _sig_meta = _signal_quality_summary(r)
    _exec, _exec_why = live_execution_status(r, fb, fc)
    _no_bet_reason = str(r.get("final_auto_reason", "") or "").strip()
    if fb == "NO BET" and (not _no_bet_reason):
        _no_bet_reason = _exec_why
    _action = "VSTOP DOVOLJEN ZDAJ" if a_active else "POČAKAJ (vstop še ni odprt)"
    _warns = _collect_conflict_warnings(r)
    _dq_status = str(r.get("data_quality_status", "OK") or "OK").strip().upper()
    _dq_notes = str(r.get("data_quality_notes", "") or "").strip()
    _frz_state, _frz_reason = _freeze_mode_status_text(r)
    _edge_mode = bool(r.get("edge_mode_active", False))
    _edge_side = str(r.get("edge_mode_side", "") or "").strip().upper()
    _event_mode = bool(r.get("goal_event_engine_active", False))
    _event_side = str(r.get("goal_event_engine_side", "") or "").strip().upper()
    _event_only = bool(r.get("goal_event_only_active", False))
    _gd_txt = str(r.get("goal_detector_text", "") or "").strip()
    _gd_prob = float(r.get("goal_detector_prob", 0.0) or 0.0)
    _pre_mode = bool(r.get("entry_pre_mode", False))
    _pre_trigger = bool(r.get("entry_trigger", False))
    _pre_final = bool(r.get("entry_final", False))
    _pre_side = str(r.get("entry_side", "NONE") or "NONE").strip().upper()
    _pre_active = bool(r.get("pre_entry_mode_active", False))
    _pre_status = str(r.get("pre_entry_status", "NORMAL") or "NORMAL").strip().upper()
    _pre_action = str(r.get("pre_entry_action", "-") or "-").strip()
    _pre_side = str(r.get("pre_entry_side", "NONE") or "NONE").strip().upper()
    _pre_eta = str(r.get("pre_entry_eta", "-") or "-").strip()
    _entry_signal_found = bool(r.get("entry_signal_found", False))
    _entry_candidate = str(r.get("entry_candidate_bet", "NONE") or "NONE").strip().upper()
    _entry_exec_allowed = bool(r.get("entry_execution_allowed", False))
    _entry_exec_status = str(r.get("entry_execution_status", "WAIT") or "WAIT").strip()
    _entry_block_reason = str(r.get("entry_block_reason", "") or "").strip()
    _entry_prepare = bool(r.get("entry_prepare", False))
    _semi_wave = bool(r.get("semi_wave_active", False))
    _micro_entry = bool(r.get("micro_entry_active", False))
    _cb_aggr = bool(r.get("comeback_aggressive_entry_active", False))
    _cb_aggr_reason = str(r.get("comeback_aggressive_entry_reason", "") or "").strip()
    _gde_override = bool(r.get("goal_decision_engine_override_active", False))
    _low_evt_breakout = bool(r.get("low_event_breakout_active", False))
    _ng_pred = str((r.get("next_goal_prediction_smart") or {}).get("prediction", "") or "").strip().upper()
    _ph = float(r.get("p_home_next", 0.0) or 0.0)
    _pa = float(r.get("p_away_next", 0.0) or 0.0)
    _p10 = float(r.get("p_goal_10", 0.0) or 0.0)
    _p10_thr = float(CFG.get("LOW_GOAL_10M_NEXT", 0.40))

    def _mk(ok):
        return btxt("✅", GREEN, True) if ok else btxt("❌", RED, True)

    print(f"{CYAN}{BOLD}--- HITRI EXECUTE ---{RESET}")
    print(f"{'VIR ODLOČITVE:'.ljust(22)} BET_DECISION (kanonični vir)")
    print(f"{'PRIORITETA:'.ljust(22)} {_action}")
    print(f"{'KAKOVOST PODATKOV:'.ljust(22)} {_dq_status}{(' | ' + _dq_notes) if _dq_notes else ''}")
    print(f"{'KAKOVOST SIGNALA:'.ljust(22)} {_sig_q} ({_sig_meta})")
    if _gd_txt:
        print(f"{'GOAL DETECTOR:'.ljust(22)} {_gd_txt} ({_gd_prob*100:.0f}%)")
    if _pre_final:
        _pte = f"SIGNAL FOUND ({_pre_side})"
    elif _pre_mode and _pre_trigger:
        _pte = f"TRIGGER ({_pre_side})"
    elif _pre_mode:
        _pte = f"BUILD-UP ({_pre_side})"
    else:
        _pte = "NORMAL"
    print(f"{'PRE->TRIGGER->ENTRY:'.ljust(22)} {_pte}")
    if _semi_wave:
        print(f"{'WAVE STATE:'.ljust(22)} SEMI-WAVE (pressure build-up)")
    if _cb_aggr:
        print(f"{'COMEBACK AGGR:'.ljust(22)} {btxt('ACTIVE', GREEN, True)}")
        if _cb_aggr_reason:
            print(f"{'COMEBACK RAZLOG:'.ljust(22)} {_cb_aggr_reason}")
    if _entry_signal_found and _entry_candidate not in ("", "NONE"):
        _exec_txt = btxt("YES", GREEN, True) if _entry_exec_allowed else btxt("NO", RED, True)
        print(f"{'SIGNAL/EXECUTION:'.ljust(22)} {_entry_candidate} | EXEC {_exec_txt} ({_entry_exec_status})")
        if (not _entry_exec_allowed) and _entry_block_reason:
            print(f"{'EXEC BLOCK:'.ljust(22)} {_entry_block_reason}")
    _sig_side = _ng_pred if _ng_pred in ("HOME", "AWAY") else ("HOME" if _ph >= _pa else "AWAY")
    _sig_exec = "NO BET" if fb == "NO BET" else fb
    print(f"{'SIGNAL SMER:'.ljust(22)} {_sig_side}")
    print(f"{'SIGNAL IZVEDBA:'.ljust(22)} {_sig_exec}")
    _forced_exec = bool(
        _gde_override
        or _low_evt_breakout
        or _entry_exec_status.upper().startswith("FORCED")
        or ("OVERRIDE" in str(trade.get("reason", "") or "").upper())
    )
    _exec_mode = "FORCED OVERRIDE" if _forced_exec else "NORMAL FLOW"
    print(f"{'EXECUTION MODE:'.ljust(22)} {_exec_mode}")
    _blk_reason = _entry_block_reason
    if (not _blk_reason) and fb == "NO BET":
        if str(_no_bet_reason or "").upper().startswith("LOW GOAL 10M"):
            _blk_reason = f"P(GOAL 10M)={_p10*100:.2f}% < ENTRY THRESHOLD {_p10_thr*100:.0f}%"
        else:
            _blk_reason = str(_no_bet_reason or "").strip()
    if _blk_reason:
        print(f"{'RAZLOG BLOKADE:'.ljust(22)} {_blk_reason}")
    if _entry_prepare:
        print(f"{'PREPARE ENTRY:'.ljust(22)} ACTIVE (ETA<=10m)")
    if _micro_entry:
        print(f"{'MICRO ENTRY:'.ljust(22)} {btxt('ACTIVE', GREEN, True)} | stake 0.2")
    if _pre_active:
        print(f"{'PRE-ENTRY MODE:'.ljust(22)} {btxt(_pre_status, YELLOW, True)} | {_pre_action}")
        print(f"{'PRE-ENTRY SMER:'.ljust(22)} {_pre_side} | ETA {_pre_eta}")
    print(
        f"{'A STAVA (GO):'.ljust(22)} "
        f"{btxt('AKTIVNO', GREEN, True) if a_active else btxt('NE', RED, True)} "
        f"| {fb} ({fc or '-'}) | {market_type} {a_true}/{total_checks} (min {min_true}/{total_checks} + obvezna 2/2)"
    )
    print(f"{'A TRG (kaj staviš):'.ljust(22)} {_a_bet_market_hint(r, fb, market_type, a_active)}")
    print(
        f"{'TRG READY:'.ljust(22)} "
        f"{btxt('YES', GREEN, True) if bool(trade.get('ready', False)) else btxt('NO', RED, True)}"
    )
    print(f"{'TRG IZVEDBA:'.ljust(22)} {str(trade.get('market', 'NO BET') or 'NO BET')}")
    print(f"{'TRG RAZLOG:'.ljust(22)} {str(trade.get('reason', '-') or '-')}")
    if _edge_mode:
        print(f"{'EDGE MODE:'.ljust(22)} {btxt('ACTIVE', GREEN, True)} | SOFT ENTRY {_edge_side or '-'} (0.3)")
    else:
        print(f"{'EDGE MODE:'.ljust(22)} {btxt('INACTIVE', YELLOW, True)}")
    if _event_mode:
        _evt_lbl = "GOAL EVENT ONLY" if _event_only else "GOAL EVENT ENGINE"
        print(f"{'GOAL EVENT ENG:'.ljust(22)} {btxt('ACTIVE', GREEN, True)} | {_event_side or '-'} (0.5) | {_evt_lbl}")
    else:
        print(f"{'GOAL EVENT ENG:'.ljust(22)} {btxt('INACTIVE', YELLOW, True)}")
    _frz_color = GREEN if _frz_state == "ACTIVE" else (RED if _frz_state == "BLOCKED" else YELLOW)
    print(f"{'FREEZE STATUS:'.ljust(22)} {btxt(_frz_state, _frz_color, True)} | {_frz_reason}")
    print(
        f"{'VALUE IZVEDBA:'.ljust(22)} "
        f"{btxt('DA', GREEN, True) if bool(trade.get('value_exec', False)) else btxt('NE', RED, True)}"
        f" ({str(trade.get('value_reason', '-') or '-')})"
    )
    if fb == "NO BET":
        print(f"{'NO BET RAZLOG:'.ljust(22)} {_no_bet_reason or '-'}")
    if _warns:
        print(f"{'KONFLIKT CHECK:'.ljust(22)} {btxt('OPOZORILO', YELLOW, True)}")
        for w in _warns[:2]:
            print(f"  {btxt('!', YELLOW, True)} {w}")
    if bool(trade.get("hide_signal", False)):
        print(f"{'FILTER SIGNALA:'.ljust(22)} {btxt('SKRIJ SMER SIGNALA (<40%)', YELLOW, True)}")
    for label, ok in a_checks:
        print(f"  {_mk(ok)} {label}")

    print(f"{'B STAVA (NO GO):'.ljust(22)} {btxt('AKTIVNO', RED, True) if b_active else btxt('NE', GREEN, True)}")
    for label, ok in b_checks:
        print(f"  {_mk(ok)} {label}")


def _smart_minute_engine_state(r):
    """
    Enoten minute/event layer:
    - minuta je utež (minute_mult)
    - vstop odloča event_ok (ne hard minute lock)
    """
    minute = int(float(r.get("minute", 0) or 0))
    tempo_danger = float(r.get("tempo_danger", 0.0) or 0.0)
    tempo_shots = float(r.get("tempo_shots", 0.0) or 0.0)
    ...
    lam_h = float(r.get("lam_h", 0.0) or 0.0)
    lam_a = float(r.get("lam_a", 0.0) or 0.0)
    lam_c = float(r.get("lam_c", 0.0) or 0.0)
    lam_total = float(lam_h + lam_a + lam_c)
    p_goal_5 = float(r.get("p_goal_5", 0.0) or 0.0)
    p_goal_10 = float(r.get("p_goal_10", 0.0) or 0.0)
    pre_trigger_chaos = bool(r.get("pre_trigger_chaos", False))
    pre_goal_trigger = bool(r.get("pre_goal_trigger", False))
    pre_goal_side = str(r.get("pre_goal_side", "NONE") or "NONE").strip().upper()

    wave_active = bool((r.get("wave") or {}).get("active", False))
    semi_wave_active = (
        (not wave_active)
        and tempo_danger >= float(CFG.get("SEMI_WAVE_TEMPO_DANGER_MIN", 1.20))
        and tempo_shots >= float(CFG.get("SEMI_WAVE_TEMPO_SHOTS_MIN", 0.22))
        and abs(float(momentum or 0.0)) >= float(CFG.get("SEMI_WAVE_MOM_MIN", 0.20))
        and float(lam_total or 0.0) >= float(CFG.get("SEMI_WAVE_LAM_TOTAL_MIN", 1.00))
    )
    wave_for_entry = bool(wave_active or semi_wave_active)

    minute_mult = 0.90 if minute < 30 else (1.00 if minute < 70 else 1.10)
    event_ok = bool(
        p_goal_5 > float(CFG.get("EARLY_EVENT_PGOAL5_MIN", 0.35))
        or p_goal_10 > float(CFG.get("EARLY_EVENT_PGOAL10_MIN", 0.55))
        or wave_for_entry
        or tempo_danger > float(CFG.get("EARLY_EVENT_TEMPO_DANGER_MIN", 1.20))
    )
    pre_trigger_early_entry = False
    pre_trigger_early_side = "NONE"
    if bool(CFG.get("PRE_TRIGGER_EARLY_ENTRY_ENABLE", True)):
        _pt_mom = float(CFG.get("PRE_TRIGGER_EARLY_ENTRY_MOM_MIN", 0.25))
        _pt_lr = float(CFG.get("PRE_TRIGGER_EARLY_ENTRY_LAM_RATIO_MIN", 3.0))
        _pt_td = float(CFG.get("PRE_TRIGGER_EARLY_ENTRY_TEMPO_DANGER_MIN", 1.00))
        _home_early = (
            pre_trigger_chaos
            and (not wave_active)
            and momentum > _pt_mom
            and lam_h > (lam_a * _pt_lr)
            and tempo_danger > _pt_td
        )
        _away_early = (
            pre_trigger_chaos
            and (not wave_active)
            and momentum < -_pt_mom
            and lam_a > (lam_h * _pt_lr)
            and tempo_danger > _pt_td
        )
        if _home_early or _away_early:
            pre_trigger_early_entry = True
            pre_trigger_early_side = "HOME" if _home_early else "AWAY"
            event_ok = True
    early_boost = (
        minute < int(CFG.get("EARLY_EVENT_BOOST_MINUTE_MAX", 25))
        and tempo_danger > float(CFG.get("EARLY_EVENT_BOOST_TEMPO_DANGER_MIN", 1.40))
    )
    if early_boost:
        event_ok = True
    if pre_goal_trigger:
    ...
    reasons = []
    if p_goal_5 > float(CFG.get("EARLY_EVENT_PGOAL5_MIN", 0.35)):
        reasons.append("P5")
    if p_goal_10 > float(CFG.get("EARLY_EVENT_PGOAL10_MIN", 0.55)):
        reasons.append("P10")
    if wave_for_entry:
        reasons.append("WAVE")
    if tempo_danger > float(CFG.get("EARLY_EVENT_TEMPO_DANGER_MIN", 1.20)):
        reasons.append("TEMPO")
    if early_boost:
        reasons.append("EARLY_BOOST")
    if pre_goal_trigger and pre_goal_side in ("HOME", "AWAY"):
        reasons.append(f"PRE_GOAL_{pre_goal_side}")
    if pre_trigger_early_entry:
        reasons.append(f"PRE_TRIGGER_EARLY_{pre_trigger_early_side}")
    event_reason = f"EVENT TRIGGER ACTIVE ({'+'.join(reasons)})" if reasons else "EVENT TRIGGER MISSING"

    return {
        "minute": minute,
        "minute_mult": float(minute_mult),
        "event_ok": bool(event_ok),
        "event_reason": str(event_reason),
        "wave_for_entry": bool(wave_for_entry),
        "early_boost": bool(early_boost),
        "pre_trigger_early_entry": bool(pre_trigger_early_entry),
        "pre_trigger_early_side": pre_trigger_early_side,
        "pre_goal_trigger": bool(pre_goal_trigger),
        "pre_goal_side": pre_goal_side,
    }


def _goal_decision_engine_snapshot(r):
    """
    Snapshot za GOAL DECISION ENGINE (uporaben za CMD in bet_decision override).
    """
    minute = int(float(r.get("minute", 0) or 0))
    score_home = int(float(r.get("score_home", 0) or 0))
    score_away = int(float(r.get("score_away", 0) or 0))
    lam_h = float(r.get("lam_h", 0.0) or 0.0)
    lam_a = float(r.get("lam_a", 0.0) or 0.0)
    lam_c = float(r.get("lam_c", 0.0) or 0.0)
    lam_total = float(lam_h + lam_a + lam_c)
    lam_diff = abs(float(lam_h - lam_a))
    momentum = float(r.get("momentum", 0.0) or 0.0)
    tempo_shots = float(r.get("tempo_shots", 0.0) or 0.0)
    tempo_danger = float(r.get("tempo_danger", 0.0) or 0.0)
    xg_h = float(r.get("xg_h", 0.0) or 0.0)
    xg_a = float(r.get("xg_a", 0.0) or 0.0)
    shots_h = float(r.get("shots_h", 0.0) or 0.0)
    shots_a = float(r.get("shots_a", 0.0) or 0.0)
    sot_h = float(r.get("sot_h", 0.0) or 0.0)
    sot_a = float(r.get("sot_a", 0.0) or 0.0)
    sot_total = float(sot_h + sot_a)
    xg_total = float(r.get("xg_total", 0.0) or 0.0)
    danger_h = float(r.get("danger_h", 0.0) or 0.0)
    danger_a = float(r.get("danger_a", 0.0) or 0.0)
    pos_h = float(r.get("pos_h", r.get("pos_home", 0.0)) or 0.0)
    sm_state = _smart_minute_engine_state(r)
    wave_on = bool(sm_state.get("wave_for_entry", False))
    minute_mult = float(sm_state.get("minute_mult", 1.0) or 1.0)
    event_ok = bool(sm_state.get("event_ok", False))
    event_reason = str(sm_state.get("event_reason", "EVENT TRIGGER MISSING") or "EVENT TRIGGER MISSING")
    p_home_next = float(r.get("p_home_next", 0.0) or 0.0)
    p_away_next = float(r.get("p_away_next", 0.0) or 0.0)
    p_goal = float(r.get("p_goal", 0.0) or 0.0)
    p_goal_5 = float(r.get("p_goal_5", 0.0) or 0.0)
    p_goal_10 = float(r.get("p_goal_10", 0.0) or 0.0)

    # MODE
    if lam_total > 1.30 and tempo_danger > 1.15:
        mode = "CHAOS"
    elif lam_total > 1.10:
        mode = "BUILD-UP"
    else:
    ...
    # FAKE PRESSURE FILTER: napad/possession brez xG kvalitete ni realen edge.
    pos_a = float(r.get("pos_a", r.get("pos_away", 0.0)) or 0.0)
    fake_pressure_gde, fake_pressure_side, _ = _detect_fake_pressure_guard(
        danger_h=danger_h,
        danger_a=danger_a,
        pos_h=pos_h,
        pos_a=pos_a,
    ...
    # CONTROL GAME: vodilna ekipa + xG edge + shots edge => smer ne sme pasti na coin-flip.
    control_away = (
    ...
    control_game = bool(control_away or control_home)
    control_side = "AWAY" if control_away else ("HOME" if control_home else "NONE")

    # NEXT GOAL SIGNAL (smer + pritisk)
    next_goal_signal = "NONE"
    next_goal_conf = 0
    next_goal_reason = "NO EDGE"
    danger_ratio_h = (danger_h / max(1e-9, danger_a)) if danger_h > 0 else 0.0
    danger_ratio_a = (danger_a / max(1e-9, danger_h)) if danger_a > 0 else 0.0
    momentum_gate_ok = control_game or (abs(momentum) > 0.12)
    dir_ready = (
        lam_diff > 0.25
        and momentum_gate_ok
        and wave_on
        and (danger_ratio_h > 1.5 or danger_ratio_a > 1.5)
    )
    if dir_ready and lam_total > 1e-9:
        if lam_h > lam_a:
            next_goal_signal = "HOME"
            next_goal_conf = int(max(0.0, min(0.99, lam_h / lam_total)) * 100)
        else:
            next_goal_signal = "AWAY"
            next_goal_conf = int(max(0.0, min(0.99, lam_a / lam_total)) * 100)
        next_goal_reason = "MOMENTUM + DANGER + LAMBDA EDGE + WAVE"
    elif lam_diff <= 0.25 and abs(momentum) <= 0.12 and (not wave_on):
        next_goal_reason = "COIN FLIP (NO DIR EDGE)"

    # OVER/UNDER SIGNAL (event mode)
    both_attack = min(danger_h, danger_a) > 0 and (max(danger_h, danger_a) / max(1e-9, min(danger_h, danger_a))) < 1.8
    ou_signal = "NO BET"
    ou_conf = 0
    ou_reason = "LOW TEMPO"
    if lam_total > 1.30 and tempo_shots > 0.22 and tempo_danger > 1.15 and both_attack:
        ou_signal = "OVER"
        ou_conf = int(max(0.0, min(0.99, p_goal)) * 100)
        ou_reason = "CHAOS GAME (HIGH TEMPO + HIGH LAMBDA)"
    elif lam_total < 0.90 and tempo_shots < 0.18 and tempo_danger < 1.00 and (not wave_on):
        ou_signal = "UNDER"
        ou_conf = int(max(0.0, min(0.95, 1.0 - p_goal)) * 100)
        ou_reason = "LOW EVENT (NO WAVE)"

    if fake_pressure_gde:
        next_goal_signal = "NONE"
        next_goal_conf = 0
        next_goal_reason = f"FAKE {fake_pressure_side} PRESSURE (danger/possession brez xG)"
        ou_signal = "NO BET"
        ou_conf = 0
        ou_reason = f"FAKE {fake_pressure_side} PRESSURE FILTER"

    # CONTROL GAME OVERRIDE (ključna kalibracija): smer vodilne ekipe z edge-om.
    if control_game and (not fake_pressure_gde):
        next_goal_signal = control_side
        next_goal_conf = max(int(CFG.get("CONTROL_GAME_MIN_NG_CONF", 55)), int(next_goal_conf))
        next_goal_reason = f"LEADING + xG EDGE + SHOTS EDGE ({control_side})"
        ou_signal = "NO BET"
        ou_conf = 0
        ou_reason = "CONTROL GAME (direction > event)"

    # EVENT GATE (kritično): smer brez dogodka = WAIT (no direction bet).
    low_event_wait = (
        p_goal < float(CFG.get("LOW_EVENT_WAIT_PGOAL_MAX", 0.40))
        or p_goal_10 < float(CFG.get("LOW_EVENT_WAIT_PGOAL10_MAX", 0.10))
    )
    control_freeze = bool(control_game and p_goal < float(CFG.get("CONTROL_FREEZE_PGOAL_MAX", 0.45)))
    direction_without_event_block = (
        next_goal_conf >= int(float(CFG.get("DIRECTION_EVENT_BLOCK_CONF_MIN", 0.65)) * 100)
        and p_goal < float(CFG.get("DIRECTION_EVENT_BLOCK_PGOAL_MAX", 0.40))
    )
    event_lock = bool(low_event_wait or control_freeze or direction_without_event_block)
    side_gap = abs(float(p_away_next or 0.0) - float(p_home_next or 0.0))
    _bo_pmin = float(CFG.get("LOW_EVENT_BREAKOUT_PGOAL_MIN", 0.20))
    _bo_pmax = float(CFG.get("LOW_EVENT_BREAKOUT_PGOAL_MAX", 0.45))
    _bo_gap = float(CFG.get("LOW_EVENT_BREAKOUT_SIDE_GAP_MIN", 0.10))
    _bo_mom = float(CFG.get("LOW_EVENT_BREAKOUT_MOM_MIN", 0.15))
    _bo_lr = float(CFG.get("LOW_EVENT_BREAKOUT_LAM_RATIO_MIN", 1.50))
    _bo_gap_strong = float(CFG.get("LOW_EVENT_BREAKOUT_STRONG_SIDE_GAP_MIN", 0.16))
    _bo_mom_strong = float(CFG.get("LOW_EVENT_BREAKOUT_STRONG_MOM_MIN", 0.22))
    _bo_lr_strong = float(CFG.get("LOW_EVENT_BREAKOUT_STRONG_LAM_RATIO_MIN", 2.00))
    _bo_stake_soft = float(CFG.get("LOW_EVENT_BREAKOUT_STAKE_SOFT", 0.2))
    _bo_stake_strong = float(CFG.get("LOW_EVENT_BREAKOUT_STAKE_STRONG", 0.3))
    low_event_breakout = False
    low_event_breakout_side = "NONE"
    low_event_breakout_level = "NONE"
    low_event_breakout_stake = 0.0
    low_event_breakout_reason = ""
    if (
        event_lock
        and (not fake_pressure_gde)
        and p_goal >= _bo_pmin
        and p_goal <= _bo_pmax
        and side_gap >= _bo_gap
    ):
        if (
            (next_goal_signal == "AWAY")
            and (momentum <= -_bo_mom)
            and (lam_a >= (lam_h * _bo_lr))
        ):
            low_event_breakout = True
            low_event_breakout_side = "AWAY"
        elif (
            (next_goal_signal == "HOME")
            and (momentum >= _bo_mom)
            and (lam_h >= (lam_a * _bo_lr))
        ):
            low_event_breakout = True
            low_event_breakout_side = "HOME"
        if low_event_breakout:
            _lam_ratio = (lam_a / max(1e-9, lam_h)) if low_event_breakout_side == "AWAY" else (lam_h / max(1e-9, lam_a))
            _mom_abs = abs(float(momentum or 0.0))
            if side_gap >= _bo_gap_strong and _lam_ratio >= _bo_lr_strong and _mom_abs >= _bo_mom_strong:
                low_event_breakout_level = "STRONG"
                low_event_breakout_stake = _bo_stake_strong
            else:
                low_event_breakout_level = "SOFT"
                low_event_breakout_stake = _bo_stake_soft
            low_event_breakout_reason = (
                f"LOW EVENT BREAKOUT {low_event_breakout_level} ({low_event_breakout_side}) | "
                f"p_goal={p_goal*100:.1f}% gap={side_gap*100:.1f}% λ_ratio={_lam_ratio:.2f} "
                f"stake={low_event_breakout_stake:.1f}"
            )

    # TIMING ENGINE: high long-term p_goal brez kratkoročnega triggerja -> WAIT (DELAYED_GOAL).
    timing_entry_trigger = (
        p_goal_5 >= float(CFG.get("TIMING_ENTRY_TRIGGER_PGOAL5_MIN", CFG.get("TIMING_DELAY_RELEASE_PGOAL5_MIN", 0.35)))
        or wave_on
    )
    timing_delayed = (
        p_goal >= float(CFG.get("TIMING_DELAY_PGOAL_MIN", 0.75))
        and p_goal_5 < float(CFG.get("TIMING_DELAY_PGOAL5_MAX", 0.30))
        and (not wave_on)
    )
    timing_action = "WAIT" if timing_delayed else ("ENTRY" if timing_entry_trigger else "GO")
    if (not timing_entry_trigger) and (not event_ok):
        timing_action = "WAIT"
    if event_lock:
        if low_event_breakout:
            mode = "LOW_EVENT_BREAKOUT"
            timing_action = "FORCED"
            next_goal_signal = low_event_breakout_side
            next_goal_conf = min(
                int(CFG.get("LOW_EVENT_BREAKOUT_CONF_MAX", 58)),
                max(45, int(next_goal_conf or 0)),
            )
            next_goal_reason = low_event_breakout_reason or "LOW EVENT BREAKOUT"
            ou_signal = "NO BET"
            ou_conf = 0
            ou_reason = f"LOW EVENT BREAKOUT {low_event_breakout_level} (direction-only risk lane)"
        else:
            timing_action = "WAIT"
            if control_freeze:
                mode = "CONTROL_FREEZE"
            elif str(mode or "").upper() == "LOW EVENT":
                mode = "LOW_EVENT_WAIT"
            next_goal_signal = "NONE"
            next_goal_conf = 0
            next_goal_reason = "DIRECTION WITHOUT EVENT (WAIT)"
            ou_signal = "NO BET"
            ou_conf = 0
            ou_reason = "EVENT TOO LOW (NO ENTRY)"
    if timing_delayed:
        mode = "DELAYED_GOAL"
        ou_signal = "NO BET"
        ou_conf = 0
        ou_reason = "DELAYED GOAL SETUP (LOW 5m TIMING)"
        if next_goal_signal in ("HOME", "AWAY"):
            next_goal_reason = f"{next_goal_reason} | TIMING WAIT (5m<{int(CFG.get('TIMING_DELAY_PGOAL5_MAX', 0.30)*100)}%, no wave)"

    minute_gate = int(CFG.get("WAVE_FALLBACK_FROM_MINUTE", 5))
    minute_gate_ok = (minute >= minute_gate) or event_ok

    # PHASE ENTRY: aktivno že od 5. minute
    early_phase = (
        minute >= minute_gate and minute < 30
        and lam_total > 0.90
        and tempo_danger > 1.05
        and sot_total >= 2
    )
    mid_phase = (
        minute >= 30 and minute < 60
        and lam_total > 1.10
        and tempo_danger > 1.10
        and sot_total >= 5
    )
    late_phase = (
        minute >= 60
        and lam_total > 1.20
        and tempo_danger > 1.15
        and sot_total >= 6
    )
    phase_name = "NONE"
    if early_phase:
        ...
        phase_name = "LATE"
    phase_entry_active = early_phase or mid_phase or late_phase or event_ok
    if control_game:
        phase_entry_active = True

    # anti-random early safety
    if minute < 15 and lam_total < 1.0 and (not event_ok):
        phase_entry_active = False
        phase_name = "NONE"

    # EARLY BUILD-UP flag (zahtevan trigger)
    early_goal_flag = (
        minute >= 50
        and lam_total > 1.20
        and tempo_danger > 1.10
    ...
    final_bet = "NO BET"
    alt_bet = "-"
    _ng_min_conf = int(CFG.get("CONTROL_GAME_MIN_NG_CONF", 55)) if control_game else 60
    if next_goal_conf >= _ng_min_conf and next_goal_signal in ("HOME", "AWAY"):
        final_bet = f"NEXT GOAL {next_goal_signal}"
    elif ou_conf >= 65 and ou_signal in ("OVER", "UNDER"):
        final_bet = ou_signal

    if early_goal_flag and ou_signal != "UNDER":
        final_bet = "GOAL YES (EARLY BUILD-UP)"

    if timing_delayed:
        final_bet = "NO BET"
        alt_bet = "WAIT FOR TRIGGER (WAVE or P(goal 5m) > 35%)"
    elif event_lock and (not low_event_breakout):
        final_bet = "NO BET"
        alt_bet = "HOLD / NO BET (EVENT TOO LOW)"
    elif (
        p_goal >= float(CFG.get("TIMING_DELAY_PGOAL_MIN", 0.75))
        and timing_entry_trigger
        and (not fake_pressure_gde)
        and final_bet == "NO BET"
    ):
        final_bet = "GOAL YES"
        alt_bet = "ENTRY TRIGGERED (WAVE / P(goal 5m) > 35%)"
        ou_signal = "OVER"
        ou_conf = max(int(ou_conf), int(max(0.0, min(0.99, p_goal)) * 100))
        ou_reason = "TIMING ENTRY TRIGGER (5m / wave)"

    if next_goal_conf >= 60 and ou_conf >= 65:
        alt_bet = ou_signal

    final_conf = max(next_goal_conf, ou_conf)
    return {
        "mode": mode,
        "minute": minute,
        "minute_gate": minute_gate,
        "minute_gate_ok": bool(minute_gate_ok),
        "minute_mult": round(float(minute_mult), 3),
        "event_ok": bool(event_ok),
        "event_reason": event_reason,
        "fake_pressure_gde": bool(fake_pressure_gde),
        "fake_pressure_side": fake_pressure_side,
        "control_game": bool(control_game),
        "control_side": control_side,
        "low_event_wait": bool(low_event_wait),
        "control_freeze": bool(control_freeze),
        "direction_without_event_block": bool(direction_without_event_block),
        "event_lock": bool(event_lock),
        "low_event_breakout": bool(low_event_breakout),
        "low_event_breakout_side": low_event_breakout_side,
        "low_event_breakout_level": low_event_breakout_level,
        "low_event_breakout_stake": round(float(low_event_breakout_stake), 3),
        "low_event_breakout_reason": low_event_breakout_reason,
        "timing_delayed": bool(timing_delayed),
        "timing_entry_trigger": bool(timing_entry_trigger),
        "timing_action": timing_action,
        "phase_entry_active": bool(phase_entry_active),
        "phase_name": phase_name,
        "early_goal_flag": bool(early_goal_flag),
        "next_goal_signal": next_goal_signal,
        "next_goal_conf": int(next_goal_conf),
        "next_goal_reason": next_goal_reason,
        "ou_signal": ou_signal,
        "ou_conf": int(ou_conf),
        "ou_reason": ou_reason,
        "final_bet": final_bet,
        "alt_bet": alt_bet,
        "final_conf": int(final_conf),
    }


def print_goal_decision_engine(r):
    """
    Enotno CMD okno za hitro odločitev:
    NEXT GOAL / OVER-UNDER / WAIT z faznim entry triggerjem od 5. minute.
    """
    gd = _goal_decision_engine_snapshot(r)
    final_auto_bet = str(r.get("final_auto_bet", "NO BET") or "NO BET").strip().upper()
    print(f"\n{CYAN}{BOLD}=============== GOAL DECISION ENGINE ==============={RESET}\n")
    print(f"{'MODE:'.ljust(28)} {gd['mode']}")
    print(f"{'MINUTE GATE:'.ljust(28)} ACTIVE FROM {gd['minute_gate']} min")
    print(f"{'MINUTE WEIGHT:'.ljust(28)} x{float(gd.get('minute_mult', 1.0) or 1.0):.2f}")
    print(f"{'EVENT TRIGGER:'.ljust(28)} {'YES' if gd.get('event_ok', False) else 'NO'} ({gd.get('event_reason', 'N/A')})")
    if gd.get("fake_pressure_gde", False):
        print(f"{'FAKE PRESSURE:'.ljust(28)} YES ({gd.get('fake_pressure_side', 'NONE')})")
    else:
        print(f"{'FAKE PRESSURE:'.ljust(28)} NO")
    if gd.get("control_game", False):
        print(f"{'CONTROL GAME:'.ljust(28)} YES ({gd.get('control_side', 'NONE')})")
    else:
        print(f"{'CONTROL GAME:'.ljust(28)} NO")
    print(f"{'EVENT LOCK:'.ljust(28)} {'YES' if gd.get('event_lock', False) else 'NO'}")
    if gd.get("low_event_breakout", False):
        print(
            f"{'LOW EVENT BREAKOUT:'.ljust(28)} YES "
            f"({gd.get('low_event_breakout_side', 'NONE')} | {gd.get('low_event_breakout_level', 'SOFT')} | "
            f"stake {float(gd.get('low_event_breakout_stake', 0.2) or 0.2):.1f})"
        )
    else:
        print(f"{'LOW EVENT BREAKOUT:'.ljust(28)} NO")
    print(f"{'TIMING ACTION:'.ljust(28)} {gd.get('timing_action', 'GO')}")
    print(f"{'PHASE ENTRY ACTIVE:'.ljust(28)} {'YES' if gd['phase_entry_active'] else 'NO'}")
    print(f"{'ENTRY PHASE:'.ljust(28)} {gd['phase_name']}")
    print()
    print("NEXT GOAL:")
    print(f"{'  SIGNAL:'.ljust(28)} {gd['next_goal_signal']}")
    print(f"{'  CONF:'.ljust(28)} {gd['next_goal_conf']}%")
    print(f"{'  REASON:'.ljust(28)} {gd['next_goal_reason']}")
    print()
    print("OVER / UNDER:")
    print(f"{'  SIGNAL:'.ljust(28)} {gd['ou_signal']}")
    print(f"{'  CONF:'.ljust(28)} {gd['ou_conf']}%")
    print(f"{'  REASON:'.ljust(28)} {gd['ou_reason']}")
    print()
    print("EARLY ENTRY:")
    print(f"{'  STATUS:'.ljust(28)} {'ACTIVE' if gd['early_goal_flag'] else 'OFF'}")
    print(f"{'  TRIGGER:'.ljust(28)} {'YES' if gd['early_goal_flag'] else 'NO'}")
    print()
    print("FINAL DECISION:")
    print(f"{'  BET:'.ljust(28)} {gd['final_bet']}")
    print(f"{'  ALTERNATIVE:'.ljust(28)} {gd['alt_bet']}")
    print(f"{'  CONFIDENCE:'.ljust(28)} {gd['final_conf']}%")
    print(f"{'  MODEL FINAL:'.ljust(28)} {final_auto_bet}")
    print(f"\n{CYAN}{BOLD}====================================================={RESET}\n")
...
def print_decision_levels_snapshot(r):
    ...
    _dq = r.get("decision_quality", None)
    if _dq is not None:
        try:
            dq_v = float(_dq)
        except Exception:
            dq_v = None
        if dq_v is not None:
            _pal = bool(r.get("pick_aligned_scores_rank1", False))
            _tag = "ujemanje rank1 ✔" if _pal else "rank1 ≠ pick"
            print(
                f"{'Ocena odločitve:'.ljust(22)} "
                f"{btxt(f'{dq_v:.0f}/100 ({_tag})', CYAN, False)}"
            )
...
def print_value_detector_block(r):
    ...
    if minute < CFG["MIN_BET_MINUTE"]:
        mode = "EARLY (event-driven lane, minute is weight)"
    elif away_lane or home_lane:
        mode = "LATE GAME VALUE"
    else:
        mode = "MONITOR"

    if vd_path == "early_event_lock":
        trigger = "NONE (engine: SMART MINUTE EVENT LOCK)"
    ...
    if vd_path == "pro_sync":
        ...
        print()
    if minute >= CFG["MIN_BET_MINUTE"] and final_bet == "NO BET":
        if (
            edge_a > 0.06
            and lam_gap_away
            and not trap_away
...
def parse_csv_line(line):
    ...
    if not raw:
        return []
    try:
        # Auto-detect delimiter: robust against ',', ';', tab and mixed pasted rows.
        # Slovenian exports often use ';' as separator when decimals contain commas.
        if ";" in raw and (raw.count(";") >= raw.count(",")):
            row = next(csv.reader(StringIO(raw), delimiter=";"))
        elif "\t" in raw and (raw.count("\t") >= raw.count(",")):
            row = next(csv.reader(StringIO(raw), delimiter="\t"))
        else:
            row = next(csv.reader(StringIO(raw), delimiter=","))
    except Exception:
        # Safe fallback: pick delimiter by most frequent token.
        delims = [",", ";", "\t", "|"]
        d = max(delims, key=lambda x: raw.count(x))
        row = raw.split(d) if raw.count(d) > 0 else [raw]

    out = [str(x).strip() for x in row]

    # If parser returned a single blob but line clearly has separators, split again.
    if len(out) <= 1:
        for d in (";", "\t", ",", "|"):
            if raw.count(d) > 0:
                out = [x.strip() for x in raw.split(d)]
                break
    return out
...
def append_bet_decision_log_row(
    ...
    *,
    ...
    try:
        ...
        sh = _to_int_safe(r.get("score_home", 0), 0)
        sa = _to_int_safe(r.get("score_away", 0), 0)
        ts_scores = r.get("top_scores") or []
        t1s, t1p = ("", 0.0)
        if ts_scores:
            t1s = str(ts_scores[0][0])
            t1p = _to_float_safe(ts_scores[0][1] if len(ts_scores[0]) > 1 else 0.0, 0.0)
        parts_top5 = []
        if top5:
            for nm, sc in top5[:5]:
                parts_top5.append(f"{nm}:{_to_float_safe(sc, 0.0):.3f}")
        top5_blob = "|".join(parts_top5)
        ng = r.get("next_goal_prediction_smart") or {}
        ngp = str(ng.get("prediction", "") or "")
        ngc = _to_float_safe(ng.get("confidence", 0), 0.0)
        dq_cell = ""
        dq_raw = r.get("decision_quality", None)
        if dq_raw is not None:
            try:
                dq_cell = f"{_to_float_safe(dq_raw, 0.0):.2f}"
            except Exception:
                dq_cell = ""
        dq_r1 = r.get("pick_aligned_scores_rank1", None)
        dq_rank1_cell = ""
        if dq_r1 is not None:
            dq_rank1_cell = "1" if bool(dq_r1) else "0"
        row = {
            "ts": time.strftime("%Y-%m-%dT%H:%M:%S", time.localtime()),
            "home": home,
            "away": away,
            "minute": str(_to_int_safe(minute_val, 0)),
            "score": f"{sh}-{sa}",
            ...
            "edge_h": f"{_to_float_safe(r.get('edge_h', 0), 0.0):.5f}",
            "edge_x": f"{_to_float_safe(r.get('edge_x', 0), 0.0):.5f}",
            "edge_a": f"{_to_float_safe(r.get('edge_a', 0), 0.0):.5f}",
            "p_goal": f"{_to_float_safe(r.get('p_goal', 0), 0.0):.5f}",
            "p_goal_10": f"{_to_float_safe(r.get('p_goal_10', 0), 0.0):.5f}",
            "ph_next": f"{_to_float_safe(r.get('p_home_next', 0), 0.0):.5f}",
            "pa_next": f"{_to_float_safe(r.get('p_away_next', 0), 0.0):.5f}",
            "ng_pred": _sanitize_log_cell(ngp, 16),
            "ng_conf": f"{ngc:.5f}",
            "game_state": _sanitize_log_cell(game_state, 40),
            "tempo_sh": f"{_to_float_safe(r.get('tempo_shots', 0), 0.0):.5f}",
            "tempo_dg": f"{_to_float_safe(r.get('tempo_danger', 0), 0.0):.5f}",
            "lam_h": f"{_to_float_safe(r.get('lam_h', 0), 0.0):.5f}",
            "lam_a": f"{_to_float_safe(r.get('lam_a', 0), 0.0):.5f}",
            "top1": _sanitize_log_cell(t1s, 16),
            "p_top1": f"{t1p:.5f}",
            "match_bet": _sanitize_log_cell(match_bet, 24),
            "match_reason": _sanitize_log_cell(match_reason, 120),
            "reliability": f"{_to_float_safe(model_reliability, 0.0):.5f}",
            "top5": _sanitize_log_cell(top5_blob, 500),
            "dq": dq_cell,
            "dq_rank1": dq_rank1_cell,
            "game_state_v2": _sanitize_log_cell(str(r.get("game_state_v2", "") or ""), 24),
            "intent_home": _sanitize_log_cell(str(r.get("intent_home", "") or ""), 16),
            "intent_away": _sanitize_log_cell(str(r.get("intent_away", "") or ""), 16),
            "timing_state": _sanitize_log_cell(str(r.get("timing_state", "") or ""), 16),
            "context_notes": _sanitize_log_cell(str(r.get("context_notes", "") or ""), 200),
        }
        ...
        cfos_log_ex("append_bet_decision_log_row", e, critical=True)
...
def next_goal_window_state(p_goal_10, ng_smart_conf, p_home_next, p_away_next, momentum, minute):
    ...
    if minute < 60 and p_goal_10 >= 0.26 and ng_smart_conf >= 0.48:
        return "WATCH", side, "EARLY BUILD-UP (45-60)"
    if minute < 65 and p_goal_10 >= 0.30 and ng_smart_conf >= 0.52 and edge >= 0.06:
        return "PRE-TRIGGER", side, "SOFT PRE-TRIGGER (60-65)"
...
def goal_timing_detector(p_goal_5, p_goal_10, tempo_danger, tempo_shots, wave_active, overpressure_home, overpressure_away, timeline_goal_factor, minute, ignore_home_pressure=False):
    ...
    minute = int(float(minute or 0))
    wave_active = bool(wave_active)
    over_h = bool(overpressure_home) and not bool(ignore_home_pressure)
...
def goal_detector(minute, score_diff, tempo_shots, tempo_danger, wave_active, momentum, sot_h, sot_a, lam_total=0.0, p_goal=0.0):
    """
    Mini engine samo za vprašanje: bo gol ali ne.
    Ne izbira strani, samo event verjetnost.
    """
    minute = int(float(minute or 0))
    score_diff = int(float(score_diff or 0))
    tempo_shots = float(tempo_shots or 0.0)
    ...
    lam_total = float(lam_total or 0.0)
    p_goal = float(p_goal or 0.0)

    score = 0
    notes = []

    # v2: najprej event jedro (lambda + p_goal), potem ostalo
    if lam_total > float(CFG.get("GOAL_DETECTOR_LAM_TOTAL_STRONG", 1.00)):
        score += 3
        notes.append("lam_total_strong")
    elif lam_total > float(CFG.get("GOAL_DETECTOR_LAM_TOTAL_MID", 0.80)):
        score += 1
        notes.append("lam_total_mid")

    if p_goal > float(CFG.get("GOAL_DETECTOR_PGOAL_STRONG", 0.60)):
        score += 2
        notes.append("p_goal_strong")
    elif p_goal > float(CFG.get("GOAL_DETECTOR_PGOAL_MID", 0.50)):
        score += 1
        notes.append("p_goal_mid")

    if tempo_danger > 1.2:
        score += 1
        notes.append("tempo_danger")
    if tempo_shots > float(CFG.get("GOAL_DETECTOR_TEMPO_SHOTS_MIN", 0.18)):
        score += 1
        notes.append("tempo_shots")
    if wave_active:
        score += 1
        notes.append("attack_wave")
    ...
    if score_diff != 0:
        score += 1
        notes.append("chasing_score")

    if minute >= 90:
        score -= 2
        notes.append("time_kill_90+")
    elif minute >= 85:
        score -= 1
        notes.append("time_kill_85+")

    if minute >= 90 and score < 6:
        level = "TOO_LATE"
        text = "PREPOZNO (TIME KILL)"
        est_prob = 0.36
    elif score >= 5:
        level = "VERY_LIKELY"
        text = "GOL ZELO VERJETEN"
        est_prob = 0.67
    elif score >= 3:
        level = "POSSIBLE"
        text = "GOL MOGOČ"
    ...
    return {
        ...
        "level": level,
        "text": text,
        "prob": float(clamp(est_prob, 0.0, 1.0)),
        "notes": notes,
    }


def pre_entry_mode_detector(minute, p_goal, p_goal_10, p_home_next, p_away_next):
    """
    PRE-ENTRY MODE: gol je verjeten, a 10-min okno še ni odprto.
    Namen: ne vstopi takoj, pokaži build-up status + smer + ETA.
    """
    minute = int(float(minute or 0))
    p_goal = float(p_goal or 0.0)
    p_goal_10 = float(p_goal_10 or 0.0)
    ...
    active = (
        p_goal > float(CFG.get("PRE_ENTRY_PGOAL_MIN", 0.60))
        and p_goal_10 < float(CFG.get("PRE_ENTRY_PGOAL10_MAX", 0.35))
    )

    if p_away_next > p_home_next + 0.01:
        side = "AWAY"
    elif p_home_next > p_away_next + 0.01:
        side = "HOME"
    else:
        side = "NONE"
    ...
    if active:
        return {
            "active": True,
            "status": "BUILD-UP",
            "action": "POČAKAJ (setup se gradi)",
            "side": side,
            "eta": "5-15 min",
            "reason": f"Any goal {p_goal*100:.1f}% / 10m {p_goal_10*100:.1f}% (min {minute}')",
        }
...
def predict_next_goal_smart(
    ...
    p_goal_10 = float(p_goal_10 or 0.0)
    wave_active = bool(wave_active)
    lam_total = float(lam_total or (lam_h + lam_a))
    ...
    # Context penalties: low lambda / no wave / weak short window.
    if lam_total < float(CFG.get("NG_CONF_LAM_TOTAL_LOW", 0.70)):
        confidence *= float(CFG.get("NG_CONF_LAM_PENALTY", 0.70))
    if not wave_active:
        confidence *= float(CFG.get("NG_CONF_NO_WAVE_PENALTY", 0.85))
    if p_goal_10 < float(CFG.get("NG_CONF_PGOAL10_LOW", 0.30)):
        confidence *= float(CFG.get("NG_CONF_PGOAL10_PENALTY", 0.80))
...
def game_type_pressure_side(r):
    ...
    pos_h = float(r.get("pos_h", r.get("pos_home", 0)) or 0)
    pos_a = float(r.get("pos_a", r.get("pos_away", 0)) or 0)
...
def _is_endgame_closed_context(r):
    minute = int(float(r.get("minute", 0) or 0))
    lock_min = int(CFG.get("HARD_ENDGAME_NO_BET_MINUTE", 90))
    game_state_v2 = str(r.get("game_state_v2", "") or "").strip().upper()
    final_reason = str(r.get("final_auto_reason", "") or "").strip().upper()
    return (
        minute >= lock_min
        or "ENDGAME HARD LOCK" in final_reason
        or (game_state_v2 == "KILL_GAME" and minute >= 85)
    )


def _is_no_bet_locked_context(r):
    fb = str(r.get("final_auto_bet", "") or "").strip().upper()
    if fb not in ("NO BET", ""):
        return False
    reason = str(r.get("final_auto_reason", "") or "").strip().upper()
    # Global lock za razlagalne bloke: če je končna odločitev NO BET, ne izpisuj "trading story".
    return bool(reason)


def _no_bet_lock_reason(r):
    reason = str(r.get("final_auto_reason", "") or "").strip()
    if reason:
        return reason
    _exec, _why = live_execution_status(r, str(r.get("final_auto_bet", "NO BET") or "NO BET"), str(r.get("final_auto_conf", "") or ""))
    return _why if _exec == "NO GO" else "NO BET"


def print_interpretacija(r):
    print(f"\n{MAGENTA}--------------- INTERPRETACIJA MODELA ----------------{RESET}\n")
    if _is_no_bet_locked_context(r) and (not _is_endgame_closed_context(r)):
        print("Razlaga je zaklenjena, ker je končna odločitev NO BET.")
        print(f"Glavni razlog: {_no_bet_lock_reason(r)}")
        print("Open-game signali so informativni, ne izvajalni.")
        return
    if _is_endgame_closed_context(r):
        print("Tekma je v zaključni fazi (90+ / KILL GAME).")
        print("Rezultat je praktično zaklenjen.")
        print("Realna verjetnost gola za trading je nizka.")
        print("Market je zaprt ali neprimeren za nov vstop.")
        print("\nZato:")
        print("→ NI več prave value")
        print("→ NI več realnega signala")
        print("→ NO BET")
        return
    ...
    print(f"Zgodovina: REMI {round(hist_draw * 100)}%")
    print(f"Učenje: REMI {(rx - 1.0) * 100:+.1f}%")
    ...
    print(f"Verjetnost gola: {round(p_goal * 100)}%")
...
def izracunaj_model(data, final_third_fm_h=None, final_third_fm_a=None):
    ...
    # Nekateri feedi občasno pošljejo višje vrednosti (ali delni shift).
    # Namesto trde zavrnitve raje mehko omejimo, da vrstica ne pade.
    if shots_h > 80 or shots_a > 80:
        print("ERROR: shots extremely unrealistic (CSV SHIFT)")
        return None
    if shots_h > 50 or shots_a > 50:
        print("WARNING: shots high -> capped to 50 (possible CSV SHIFT)")
        shots_h = min(float(shots_h or 0.0), 50.0)
        shots_a = min(float(shots_a or 0.0), 50.0)
        data_quality_notes.append("SHOTS_CAPPED_50")
    ...
    # Usklajeno z zgornjim validatorjem: normalno območje do 50, ekstrem nad 80 je že blokiran prej.
    if shots_h > 50 or shots_a > 50:
        raise ValueError("NAPAKA: prevec shots")
...
# ZAČETEK DELA 7.2/ 8
    ...
    # CFOS GOLD RULE: po 75' pritisk ekipe, ki izgublja, ni več zanesljiv (interpretacija / filtri).
    ignore_home_pressure = bool(
        minute >= CFG["GOLD_IGNORE_HOME_PRESSURE_MIN"] and score_home < score_away
    )
    ...
    if minute >= 55:
        ...
        # ============================================================
        # LATE FAKE HOME PRESSURE + CFOS GOLD RULE (80+ AWAY kontrola)
        # ============================================================
        # Če AWAY vodi v zaključku: HOME "pritisk" pogosto lažen comeback signal → znižaj λ_home.
        if minute >= CFG["GOLD_LATE_HOME_LAM_MINUTE"] and leading_side == "AWAY":
            trap_specific = (
                float(tempo_shots_h or 0.0) > float(tempo_shots_a or 0.0)
                and float(momentum or 0.0) < 0.0
                and no_wave
            )
            if trap_specific:
                fake_home_pressure = True
            lam_h *= float(CFG["GOLD_RULE_LATE_HOME_LAM"])
        ...
        # ============================================================
        # FAKE VOLUME vs QUALITY (SHOTS / xG / λ / DANGER)
        # ============================================================
        if float(shots_h or 0.0) > float(shots_a or 0.0) and float(shot_q_h or 0.0) < float(shot_q_a or 0.0):
            fake_home_pressure = True
        if float(shots_a or 0.0) > float(shots_h or 0.0) and float(shot_q_a or 0.0) < float(shot_q_h or 0.0):
            fake_away_pressure = True
        if float(xg_h or 0.0) < float(xg_a or 0.0) and float(shots_h or 0.0) > float(shots_a or 0.0):
            fake_home_pressure = True
        if float(xg_a or 0.0) < float(xg_h or 0.0) and float(shots_a or 0.0) > float(shots_h or 0.0):
            fake_away_pressure = True
        if float(danger_h or 0.0) > float(danger_a or 0.0) * 1.3 and float(lam_h or 0.0) < float(lam_a or 0.0):
            fake_home_pressure = True
        if float(danger_a or 0.0) > float(danger_h or 0.0) * 1.3 and float(lam_a or 0.0) < float(lam_h or 0.0):
            fake_away_pressure = True
...
# ZAČETEK DELA 7.4/ 8
    ...
    ng_lam_h = float(lam_h or 0.0)
    ng_lam_a = float(lam_a or 0.0)
    wave_active = bool((wave or {}).get("active", False))
    wave_fallback_from_minute = int(CFG.get("WAVE_FALLBACK_FROM_MINUTE", 5))
    wave_fallback_active = (
        int(minute or 0) >= wave_fallback_from_minute
        and
        float(tempo_danger or 0.0) > float(CFG.get("WAVE_FALLBACK_TEMPO_DANGER_MIN", 1.40))
        and float(momentum or 0.0) > float(CFG.get("WAVE_FALLBACK_MOMENTUM_MIN", 0.15))
    )
    if wave_fallback_active:
        wave_active = True
    wave_side = str((wave or {}).get("side", "") or "").strip().upper()
    if wave_side not in ("HOME", "AWAY"):
        wave_side = "HOME" if (float(danger_h or 0.0) >= float(danger_a or 0.0)) else "AWAY"

    # KILL GAME HARD FILTER: pozna nizka-intenzivna tekma brez vala.
    if (
        minute >= int(CFG.get("NG_KILL_FILTER_MINUTE", 75))
        and float(lam_total or 0.0) < float(CFG.get("NG_KILL_FILTER_LAM_TOTAL_MAX", 0.75))
        and (not wave_active)
    ):
        _kg = float(CFG.get("NG_KILL_FILTER_SCALE", 0.65))
        ng_lam_h *= _kg
        ng_lam_a *= _kg

    # LOSING TEAM PRESSURE FILTER: zmanjša "moramo napadat" bias.
    _lp_mom = float(CFG.get("NG_LOSING_PRESSURE_MOM_MIN", 0.12))
    _lp_sc = float(CFG.get("NG_LOSING_PRESSURE_SCALE", 0.88))
    if score_home < score_away and float(momentum or 0.0) > _lp_mom:
        ng_lam_h *= _lp_sc
    if score_away < score_home and float(momentum or 0.0) < -_lp_mom:
        ng_lam_a *= _lp_sc

    # QUALITY FILTER: volume brez kvalitete ni enako realna gol grožnja.
    _q_d2s = float(CFG.get("NG_QUALITY_D2S_MIN", 0.18))
    _q_sot = float(CFG.get("NG_QUALITY_SOT_RATIO_MIN", 0.25))
    _q_sc = float(CFG.get("NG_QUALITY_SCALE", 0.85))
    if float(d2s_h or 0.0) < _q_d2s:
        ng_lam_h *= _q_sc
    if float(d2s_a or 0.0) < _q_d2s:
        ng_lam_a *= _q_sc
    if float(sot_r_h or 0.0) < _q_sot:
        ng_lam_h *= _q_sc
    if float(sot_r_a or 0.0) < _q_sot:
        ng_lam_a *= _q_sc

    # CONTROL GAME FAKE-BIAS CORRECTION:
    # če trailing/home brez xG edge vodi v višji λ, zmanjšaj lažen "HOME next" bias.
    _ctrl_lam_sc = float(CFG.get("CONTROL_GAME_LAM_FAKE_SCALE", 0.85))
    if score_away > score_home and float(xg_a or 0.0) > float(xg_h or 0.0) and float(shots_a or 0.0) >= float(shots_h or 0.0):
        if ng_lam_h > ng_lam_a and float(xg_h or 0.0) < float(xg_a or 0.0):
            ng_lam_h *= _ctrl_lam_sc
    if score_home > score_away and float(xg_h or 0.0) > float(xg_a or 0.0) and float(shots_h or 0.0) >= float(shots_a or 0.0):
        if ng_lam_a > ng_lam_h and float(xg_a or 0.0) < float(xg_h or 0.0):
            ng_lam_a *= _ctrl_lam_sc

    # ATTACK WAVE HARD BOOST: najmočnejši live signal.
    _wb = float(CFG.get("NG_WAVE_BOOST", 1.25))
    if wave_active:
        if wave_side == "HOME":
            ng_lam_h *= _wb
        else:
    ...
    # DOMINANCE FAILURE / REGRESSION:
    # če ena stran "dominira" po λ, a ni kratkoročnega gola in ni vala, naraste flip tveganje.
    _df_min = int(CFG.get("NG_DOM_FAIL_FROM_MINUTE", 60))
    _df_ratio = float(CFG.get("NG_DOM_FAIL_LAM_RATIO_MIN", 2.0))
    _df_p10 = float(CFG.get("NG_DOM_FAIL_PGOAL10_MAX", 0.25))
    _df_dom_sc = float(CFG.get("NG_DOM_FAIL_DOMINANT_SCALE", 0.85))
    _df_ud_boost = float(CFG.get("NG_DOM_FAIL_UNDERDOG_BOOST", 1.15))
    _no_conv = (float(p_goal_10 or 0.0) <= _df_p10) and (not wave_active)
    if minute >= _df_min and _no_conv:
        if ng_lam_a > max(1e-9, ng_lam_h) * _df_ratio:
            ng_lam_a *= _df_dom_sc
            ng_lam_h *= _df_ud_boost
        elif ng_lam_h > max(1e-9, ng_lam_a) * _df_ratio:
            ng_lam_h *= _df_dom_sc
            ng_lam_a *= _df_ud_boost

    # COUNTER EQUALIZER MODE:
    # vodilna ekipa dominira brez konverzije -> naslednji gol bias proti ekipi, ki lovi izid.
    _eq_dom = float(CFG.get("NG_COUNTER_EQ_DOM_RATIO", 1.20))
    _eq_p10 = float(CFG.get("NG_COUNTER_EQ_PGOAL10_MAX", 0.28))
    _eq_boost = float(CFG.get("NG_COUNTER_EQ_BOOST", 1.20))
    if minute >= _df_min and float(p_goal_10 or 0.0) <= _eq_p10 and (not wave_active):
        if score_home < score_away:
            away_pressure_high = float(danger_a or 0.0) > float(danger_h or 0.0) * _eq_dom
            away_pressure_high = away_pressure_high or (float(pressure_a or 0.0) > float(pressure_h or 0.0) * _eq_dom)
            if away_pressure_high:
                ng_lam_a *= _df_dom_sc
                ng_lam_h *= _eq_boost
        elif score_away < score_home:
            home_pressure_high = float(danger_h or 0.0) > float(danger_a or 0.0) * _eq_dom
            home_pressure_high = home_pressure_high or (float(pressure_h or 0.0) > float(pressure_a or 0.0) * _eq_dom)
            if home_pressure_high:
                ng_lam_h *= _df_dom_sc
                ng_lam_a *= _eq_boost

    lam_attack = ng_lam_h + ng_lam_a

    if lam_attack > 0:
        p_home_next = (ng_lam_h / lam_attack) * p_goal
        p_away_next = (ng_lam_a / lam_attack) * p_goal
    else:
        p_home_next = 0.0
        p_away_next = 0.0

    # 10-min window modulation: timing mora vplivati na NG execution verjetnost.
    _p10 = float(p_goal_10 or 0.0)
    if _p10 < float(CFG.get("NG_TIMING_10M_LOW", 0.30)):
        _sc = float(CFG.get("NG_TIMING_10M_LOW_SCALE", 0.75))
        p_home_next *= _sc
        p_away_next *= _sc
    elif _p10 > float(CFG.get("NG_TIMING_10M_HIGH", 0.45)):
        _sc = float(CFG.get("NG_TIMING_10M_HIGH_SCALE", 1.10))
        p_home_next *= _sc
        p_away_next *= _sc
    ...
    pre_trigger_chaos = False
    pre_trigger_reasons = []
    lam_total_now = float(lam_h or 0.0) + float(lam_a or 0.0) + float(lam_c or 0.0)
    wave_active = bool((wave or {}).get("active", False)) or bool(wave_fallback_active)
    if minute < int(CFG["PRE_TRIGGER_MAX_MINUTE"]) and (not wave_active):
        if (
            float(p_goal or 0.0) >= float(CFG["PRE_TRIGGER_P_GOAL"])
            or float(tempo_shots or 0.0) > float(CFG["PRE_TRIGGER_TEMPO_SHOTS"])
            or float(tempo_danger or 0.0) > float(CFG["PRE_TRIGGER_TEMPO_DANGER"])
        ):
            pre_trigger_chaos = True
            pre_trigger_reasons.append("EARLY_NO_WAVE_HIGH_ACTIVITY")
        if (
            minute < int(CFG["PRE_TRIGGER_LAM_MAX_MINUTE"])
            and lam_total_now > float(CFG["PRE_TRIGGER_LAM_TOTAL"])
        ):
            pre_trigger_chaos = True
            pre_trigger_reasons.append("HIGH_LAMBDA_NO_WAVE")
    ...
    _fscale = float(CFG.get("FAKE_PRESSURE_CONF_SCALE", 0.75))
    _ngp0 = str((next_goal_prediction_smart or {}).get("prediction", "") or "").strip().upper()
    if fake_home_pressure and _ngp0 == "HOME":
        ng_smart_conf_core *= _fscale
        ng_smart_conf *= _fscale
    if fake_away_pressure and _ngp0 == "AWAY":
        ng_smart_conf_core *= _fscale
        ng_smart_conf *= _fscale
    if isinstance(next_goal_prediction_smart, dict):
        next_goal_prediction_smart["confidence"] = float(ng_smart_conf_core)
    ...
    if (
        pre_trigger_chaos
        and (not wave_active)
        and minute < int(CFG["PRE_TRIGGER_MAX_MINUTE"])
        and float(ng_smart_conf) < float(CFG["PRE_TRIGGER_KILL_CONF_BELOW"])
    ):
        if "SMART_LT_KILL" not in pre_trigger_reasons:
            pre_trigger_reasons.append("SMART_LT_KILL")
    ...
    low_side_gap = abs(float(p_home_next or 0) - float(p_away_next or 0)) <= float(CFG.get("GOAL_EVENT_SIDE_GAP_MAX", 0.15))
    chaos_goal_game = (
        wave_active
        or tempo_danger >= float(CFG.get("GOAL_EVENT_CHAOS_TEMPO_DANGER_MIN", 1.20))
        or tempo_shots >= float(CFG.get("GOAL_EVENT_CHAOS_TEMPO_SHOTS_MIN", 0.25))
        or abs(float(momentum or 0.0)) >= float(CFG.get("GOAL_EVENT_CHAOS_MOM_ABS_MIN", 0.18))
        or str(game_type or "").strip().upper() in ("CHAOS", "ATTACK_WAVE", "OPEN CHAOS")
    )
    if (
        (
            float(p_goal or 0) > 0.65
            or (
                float(p_goal or 0) >= float(CFG.get("GOAL_EVENT_CHAOS_PGOAL_MIN", 0.50))
                and chaos_goal_game
                and low_side_gap
            )
        )
        and next_goal_conf < float(CFG.get("GOAL_EVENT_OVERRIDE_DIR_CONF_MAX", 0.55))
    ):
        bet_mode = "GOAL_EVENT"
    ...
    # === GOAL ONLY ENGINE (BLOCKED / WATCH / ACTIVE) ===
    goal_only_mode = "BLOCKED"
    goal_only_action = "NO ALT"
    goal_only_reason = []
    goal_only_gap = abs(float(p_home_next or 0.0) - float(p_away_next or 0.0))
    goal_only_open_state = (
        str(game_type or "").strip().upper() in ("CHAOS", "OPEN CHAOS", "ATTACK_WAVE")
        or int(score_diff or 0) == 0
    )

    if minute >= int(CFG.get("GOAL_ONLY_MINUTE", 70)):
        if p_goal >= float(CFG.get("GOAL_ONLY_WATCH_PGOAL_MIN", 0.50)):
            goal_only_reason.append("P(goal) watch")
        if p_goal_10 >= float(CFG.get("GOAL_ONLY_WATCH_PGOAL10_MIN", 0.45)):
            goal_only_reason.append("10m timing watch")
        if p_goal_5 >= float(CFG.get("GOAL_ONLY_ACTIVE_PGOAL5_MIN", 0.30)):
            goal_only_reason.append("5m timing active")
        if tempo_shots > float(CFG.get("GOAL_ONLY_WATCH_TEMPO_SHOTS_MIN", 0.24)):
            goal_only_reason.append("tempo shots high")
        if tempo_danger > float(CFG.get("GOAL_ONLY_WATCH_TEMPO_DANGER_MIN", 1.10)):
            goal_only_reason.append("tempo danger high")
        if goal_only_gap < float(CFG.get("GOAL_ONLY_WATCH_SIDE_GAP_MAX", 0.28)):
            goal_only_reason.append("direction unclear")
        if goal_only_open_state:
            goal_only_reason.append("open game state")

        watch_ok = (
            p_goal >= float(CFG.get("GOAL_ONLY_WATCH_PGOAL_MIN", 0.50))
            and p_goal_10 >= float(CFG.get("GOAL_ONLY_WATCH_PGOAL10_MIN", 0.45))
            and (
                tempo_shots > float(CFG.get("GOAL_ONLY_WATCH_TEMPO_SHOTS_MIN", 0.24))
                or tempo_danger > float(CFG.get("GOAL_ONLY_WATCH_TEMPO_DANGER_MIN", 1.10))
            )
            and goal_only_gap < float(CFG.get("GOAL_ONLY_WATCH_SIDE_GAP_MAX", 0.28))
        )
        active_ok = (
            p_goal >= float(CFG.get("GOAL_ONLY_ACTIVE_PGOAL_MIN", 0.60))
            and (
                p_goal_5 >= float(CFG.get("GOAL_ONLY_ACTIVE_PGOAL5_MIN", 0.30))
                or p_goal_10 >= float(CFG.get("GOAL_ONLY_ACTIVE_PGOAL10_MIN", 0.50))
            )
            and tempo_shots > float(CFG.get("GOAL_ONLY_ACTIVE_TEMPO_SHOTS_MIN", 0.26))
            and tempo_danger > float(CFG.get("GOAL_ONLY_ACTIVE_TEMPO_DANGER_MIN", 1.15))
            and goal_only_gap < float(CFG.get("GOAL_ONLY_ACTIVE_SIDE_GAP_MAX", 0.24))
        )
        if active_ok:
            goal_only_mode = "ACTIVE"
            goal_only_action = "GOAL YES"
        elif watch_ok:
            goal_only_mode = "WATCH"
            goal_only_action = "GOAL WATCHLIST"
    ...
    if minute >= 78 and 0.0 < odds_draw_f < 1.45:
        ...
        minute >= 75
        and lam_total_f < float(CFG.get("LOW_EVENT_LAM_TOTAL_MAX", 0.90))
        and bet_mode == "DIRECTION"
        and (not wave_active)
        and tempo_danger < float(CFG.get("GOAL_EVENT_CHAOS_TEMPO_DANGER_MIN", 1.20))
        and tempo_shots < float(CFG.get("GOAL_EVENT_CHAOS_TEMPO_SHOTS_MIN", 0.25))
        and abs(float(momentum or 0.0)) < float(CFG.get("GOAL_EVENT_CHAOS_MOM_ABS_MIN", 0.18))
        and str(game_type or "").strip().upper() not in ("CHAOS", "ATTACK_WAVE", "OPEN CHAOS")
    ):
        bet_mode = "LOW_EVENT"
    ...
    # CFOS GOLD: ob zaostanku 75+ ne sproži HOME NG okna na lažnem pritisku.
    if ignore_home_pressure and str(ng_window_side or "").upper() == "HOME":
        if ng_window_level == "TRIGGER":
            ng_window_level = "WATCH"
            ng_window_reason = "CFOS GOLD: HOME NG zadržan (trail 75+, pritisk ni signal)"
        elif ng_window_level == "PRE-TRIGGER":
            ng_window_level = "WATCH"
            ng_window_reason = "CFOS GOLD: HOME NG buildup zadržan (trail 75+)"
    ...
    if (
        ...
        and (not wave_active)
        and minute < int(CFG["PRE_TRIGGER_MAX_MINUTE"])
        and str(next_goal_bet or "")
        in ("NEXT GOAL HOME", "NEXT GOAL AWAY", "COMEBACK HOME", "COMEBACK AWAY")
    ):
        next_goal_bet = "NO BET"
        next_goal_reason = "PRE-TRIGGER: " + (
            " | ".join(pre_trigger_reasons) if pre_trigger_reasons else "CHAOS_ZONE"
        )
    ...
    goal_timing = goal_timing_detector(
        ...
        minute=minute,
        ignore_home_pressure=ignore_home_pressure,
    )
    ...
    # ============================================================
    # LATENT GOAL SIGNAL (INFO ONLY)
    # ============================================================
    latent_goal_signal_active = False
    latent_goal_signal_side = "NONE"
    latent_goal_signal_reason = ""
    latent_over_signal = False

    _lat_mom_min = float(CFG.get("LATENT_SIGNAL_MOM_MIN", 0.20))
    _lat_dng_ratio = float(CFG.get("LATENT_SIGNAL_DANGER_RATIO", 1.30))
    _lat_p10_max = float(CFG.get("LATENT_SIGNAL_PGOAL10_MAX", 0.30))
    _lat_pg_min = float(CFG.get("LATENT_SIGNAL_PGOAL_MIN", 0.45))

    latent_home = (
        float(momentum or 0.0) > _lat_mom_min
        and float(danger_h or 0.0) > float(danger_a or 0.0) * _lat_dng_ratio
        and float(p_goal_10 or 0.0) < _lat_p10_max
        and float(p_goal or 0.0) >= _lat_pg_min
    )
    latent_away = (
        float(momentum or 0.0) < -_lat_mom_min
        and float(danger_a or 0.0) > float(danger_h or 0.0) * _lat_dng_ratio
        and float(p_goal_10 or 0.0) < _lat_p10_max
        and float(p_goal or 0.0) >= _lat_pg_min
    )

    if latent_home or latent_away:
        latent_goal_signal_active = True
        latent_goal_signal_side = "HOME" if latent_home else "AWAY"
        latent_goal_signal_reason = "LOW SHORT-TERM TIMING, HIGH PRESSURE BUILD-UP"
        latent_over_signal = bool(float(p_goal or 0.0) >= 0.55)

    # ============================================================
    # CONTEXT + TIMING ENGINE (game_state_v2 / intent / timing_state)
    # ============================================================
    try:
        _ctx_ti = _compute_context_timing(
            minute=minute,
            score_diff=score_diff,
            wave_active=wave_active,
            tempo_shots=tempo_shots,
            ...
            shot_q_h=shot_q_h,
            shot_q_a=shot_q_a,
            pre_trigger_chaos=pre_trigger_chaos,
            fake_home_pressure=fake_home_pressure,
            fake_away_pressure=fake_away_pressure,
            ignore_home_pressure=ignore_home_pressure,
        ...
        cfos_log_ex("context_timing", _e_ctx)
        _ctx_ti = {
            "game_state_v2": "BALANCED",
            "intent_home": "NEUTRAL",
            "intent_away": "NEUTRAL",
            "timing_state": "ENTRY" if minute >= 70 else "PRE_TRIGGER",
            "context_notes": [],
        }
    game_state_v2 = _ctx_ti["game_state_v2"]
    intent_home = _ctx_ti["intent_home"]
    intent_away = _ctx_ti["intent_away"]
    timing_state = _ctx_ti["timing_state"]
    context_notes = list(_ctx_ti.get("context_notes", []) or [])
    try:
        _gd = goal_detector(
            minute=minute,
            score_diff=score_diff,
        ...
        cfos_log_ex("goal_detector", _e_gd)
        _gd = {"score": 0, "level": "LOW", "text": "NIZKA VERJETNOST GOLA", "prob": 0.32, "notes": []}
    try:
        _pre = pre_entry_mode_detector(
            minute=minute,
            p_goal=p_goal,
            p_goal_10=p_goal_10,
            p_home_next=p_home_next,
        ...
        cfos_log_ex("pre_entry_mode_detector", _e_pre)
        _pre = {"active": False, "status": "NORMAL", "action": "-", "side": "NONE", "eta": "-", "reason": ""}

    _wave_out = dict(wave or {})
    _wave_out["active"] = bool(wave_active)
    if bool(wave_fallback_active) and str(_wave_out.get("side", "")).strip().upper() not in ("HOME", "AWAY"):
        _wave_out["side"] = "HOME"
    ...
    return {
        ...
        "goal_only_mode": str(goal_only_mode),
        "goal_only_action": str(goal_only_action),
        "goal_only_reason": " | ".join(goal_only_reason) if goal_only_reason else "NONE",
        "goal_only_direction_gap": float(goal_only_gap),
        "latent_goal_signal_active": bool(latent_goal_signal_active),
        "latent_goal_signal_side": latent_goal_signal_side,
        "latent_goal_signal_reason": latent_goal_signal_reason,
        "latent_over_signal": bool(latent_over_signal),
        "goal_detector_score": int(_gd.get("score", 0) or 0),
        "goal_detector_level": str(_gd.get("level", "LOW") or "LOW"),
        "goal_detector_text": str(_gd.get("text", "NIZKA VERJETNOST GOLA") or "NIZKA VERJETNOST GOLA"),
        "goal_detector_prob": float(_gd.get("prob", 0.0) or 0.0),
        "goal_detector_notes": list(_gd.get("notes", []) or []),
        "pre_entry_mode_active": bool(_pre.get("active", False)),
        "pre_entry_status": str(_pre.get("status", "NORMAL") or "NORMAL"),
        "pre_entry_action": str(_pre.get("action", "-") or "-"),
        "pre_entry_side": str(_pre.get("side", "NONE") or "NONE"),
        "pre_entry_eta": str(_pre.get("eta", "-") or "-"),
        "pre_entry_reason": str(_pre.get("reason", "") or ""),
        ...
        "timeline": timeline, "wave": _wave_out, "game_type": game_type,
        "wave_fallback_active": bool(wave_fallback_active),
        "wave_fallback_from_minute": int(wave_fallback_from_minute),
        "wave_fallback_tempo_danger_min": float(CFG.get("WAVE_FALLBACK_TEMPO_DANGER_MIN", 1.40)),
        "wave_fallback_momentum_min": float(CFG.get("WAVE_FALLBACK_MOMENTUM_MIN", 0.15)),
        ...
        "fake_away_pressure": fake_away_pressure,
        "pre_trigger_chaos": bool(pre_trigger_chaos),
        "pre_trigger_reason": " | ".join(pre_trigger_reasons) if pre_trigger_reasons else "",
        "ignore_home_pressure": ignore_home_pressure,
        ...
        "data_quality_status": "DEGRADED" if data_quality_notes else "OK",
...
def print_live_goal_probability(r):
    ...
    gd_txt = str(r.get("goal_detector_text", "") or "").strip()
    gd_prob = float(r.get("goal_detector_prob", 0.0) or 0.0)
    if gd_txt:
        live_print("Goal detector", f"{gd_txt} ({round(gd_prob * 100)}%)")
    live_print("Goal only mode", str(r.get("goal_only_mode", "BLOCKED") or "BLOCKED"))
...
def print_next_goal_bet(r):
    ...
    _gd_prob = float(r.get("goal_detector_prob", 0.0) or 0.0)
    if _gd_txt:
        print(f"Goal detector    {_gd_txt} ({round(_gd_prob * 100)}%)")
    if bool(r.get("pre_entry_mode_active", False)):
        print(f"Pre-entry mode   {r.get('pre_entry_status', 'BUILD-UP')} | {r.get('pre_entry_action', 'POČAKAJ')}")
        print(f"Pre-entry smer   {r.get('pre_entry_side', 'NONE')} | ETA {r.get('pre_entry_eta', '5-15 min')}")
        _pre_r = str(r.get("pre_entry_reason", "") or "").strip()
        if _pre_r:
            print(f"Pre-entry razlog {_pre_r}")
    if bool(r.get("latent_goal_signal_active", False)):
        _ls = str(r.get("latent_goal_signal_side", "NONE") or "NONE").strip().upper()
        _lr = str(r.get("latent_goal_signal_reason", "") or "").strip()
        print(f"Latent signal    {_ls} (INFO ONLY)")
        if _lr:
            print(f"Latent razlog    {_lr}")
        if bool(r.get("latent_over_signal", False)):
            print("Over signal      YES (INFO ONLY)")
    ...
    if bool(r.get("fake_home_pressure", False)):
        print("Fake pressure    AKTIVNO (POZEN DOMA TRAP / VOLUME)")
    if bool(r.get("fake_away_pressure", False)):
        print("Fake AWAY        AKTIVNO (VOLUME brez kakovosti)")
    if bool(r.get("pre_trigger_chaos", False)):
        _ptr = str(r.get("pre_trigger_reason", "") or "").strip()
        print("Pre-trigger      DA (CHAOS / prezgodaj)", f"| {_ptr}" if _ptr else "")
    if bool(r.get("ignore_home_pressure", False)):
        print("Gold rule        AKTIVNO (75+ trail: HOME pritisk ni signal)")
    if bool(r.get("dual_threat_mode", False)):
        print("Dual threat      AKTIVNO (OPEN ENDGAME LOCK)")
    _gsv2 = str(r.get("game_state_v2", "") or "")
    _ih = str(r.get("intent_home", "") or "")
    _ia = str(r.get("intent_away", "") or "")
    _ts = str(r.get("timing_state", "") or "")
    if _gsv2 or _ih or _ia or _ts:
        print(f"Game state v2    {_gsv2 or '-'}  | Timing {_ts or '-'}")
        print(f"Intent H/A       {_ih or '-'} / {_ia or '-'}")
    if ng_level == "TRIGGER":
        print(btxt("!!! 10M NEXT GOAL TRIGGER ACTIVE !!!", GREEN, True))
    print("------------------------------------------------")


def print_goal_only_engine(r):
    print()
    print("--------------- GOAL ONLY ENGINE ----------------")
    mode = str(r.get("goal_only_mode", "BLOCKED") or "BLOCKED").strip().upper()
    action = str(r.get("goal_only_action", "NO ALT") or "NO ALT").strip()
    reason = str(r.get("goal_only_reason", "NONE") or "NONE").strip()
    profile = str(CFG.get("GOAL_ONLY_PROFILE_ACTIVE", CFG.get("GOAL_ONLY_PROFILE", "BALANCED")) or "BALANCED").strip().upper()
    gap = float(r.get("goal_only_direction_gap", abs(float(r.get("p_home_next", 0.0) or 0.0) - float(r.get("p_away_next", 0.0) or 0.0))) or 0.0)
    mode_col = GREEN if mode == "ACTIVE" else (YELLOW if mode == "WATCH" else RED)
    print(f"Profile          {profile}")
    print(f"Mode             {btxt(mode, mode_col, True)}")
    print(f"P(goal)          {pct(r.get('p_goal', 0))} %")
    print(f"P(goal 5m)       {pct(r.get('p_goal_5', 0))} %")
    print(f"P(goal 10m)      {pct(r.get('p_goal_10', 0))} %")
    print(f"Direction gap    {gap:.3f}")
    print(f"Tempo shots      {float(r.get('tempo_shots', 0.0) or 0.0):.3f}")
    print(f"Tempo danger     {float(r.get('tempo_danger', 0.0) or 0.0):.3f}")
...
def print_top_signals(r):
    if _is_endgame_closed_context(r):
        ...
        print(f"1. {btxt('ENDGAME LOCK 90+ (NO TRADE)', RED, True)}")
        print(f"2. {btxt('Rezultat je zaklenjen', YELLOW, True)}")
        return
    if _is_no_bet_locked_context(r):
        _r = _no_bet_lock_reason(r)
        print(f"\n{CYAN}{BOLD}================ TOP SIGNALI ================ {RESET}\n")
        print(f"1. {btxt('INFO: NO BET zaklep aktiven', YELLOW, True)}")
        print(f"2. {btxt(f'INFO: {_r}', YELLOW, True)}")
        if bool(r.get("latent_goal_signal_active", False)):
            _ls = str(r.get("latent_goal_signal_side", "NONE") or "NONE").strip().upper()
            _lr = str(r.get("latent_goal_signal_reason", "") or "").strip()
            print(f"3. {btxt(f'INFO: LATENT NEXT GOAL {_ls} (INFO ONLY)', CYAN, True)}")
            if _lr:
                print(f"4. {btxt(f'INFO: {_lr}', CYAN, True)}")
        else:
            print(f"3. {btxt('INFO: signali so informativni (brez entryja)', YELLOW, True)}")
        return
...
def print_5_korakov(r):
    ...
    if _is_no_bet_locked_context(r) and (not _is_endgame_closed_context(r)):
        _r = _no_bet_lock_reason(r)
        print(f"{RED}{BOLD}1. Končna odločitev -> NO BET (zaklenjeno){RESET}")
        print(f"{YELLOW}{BOLD}2. Glavni razlog -> {_r}{RESET}")
        print(f"{MAGENTA}{BOLD}3. Timing/entry -> še ni za vstop{RESET}")
        print(f"{GREEN}{BOLD}4. Signali -> samo spremljanje, brez entryja{RESET}")
        print(f"{BLUE}{BOLD}5. Akcija -> POČAKAJ NA ENTRY OKNO{RESET}")
        return
    if _is_endgame_closed_context(r):
        print(f"{RED}{BOLD}1. Time state -> ENDGAME LOCK (90+){RESET}")
        print(f"{YELLOW}{BOLD}2. Tempo danger / tempo shots -> IRRELEVANT ZA NOV ENTRY{RESET}")
        print(f"{MAGENTA}{BOLD}3. Attack wave / timeline trend -> BLOKIRANO ZA TRADING{RESET}")
        print(f"{GREEN}{BOLD}4. Any goal / next goal signal -> SIGNAL HIDDEN / NO ENTRY{RESET}")
        print(f"{BLUE}{BOLD}5. EDGE proti marketu -> VALUE NEAKTIVEN (MARKET CLOSED){RESET}")
        return
...
def cfos_analiza_sistema(r):
    ...
    if _is_no_bet_locked_context(r) and (not _is_endgame_closed_context(r)):
        _r = _no_bet_lock_reason(r)
        print(btxt("• Končni signal je NO BET (zaklenjena razlaga).", RED, True))
        print(f"• Glavni razlog: {_r}")
        print("• Open-game metrični signali so prikazani samo informativno.")
        print("• Ukrep: brez novega vstopa do potrjenega ENTRY okna.")
        print(f"\n{MAGENTA}Moje predvidevanje:{RESET}")
        print("Napoved izida".ljust(28), btxt(str(r.get("napoved_izida", "N/A")), CYAN, True))
        print("Napoved rezultata".ljust(28), btxt(str(r.get("napoved_rezultata", "N/A")), CYAN, True))
        print("Kaj bi stavil".ljust(28), btxt("NO BET", YELLOW, True))
        print("Zakaj".ljust(28), _r)
        return
    if _is_endgame_closed_context(r):
        print(btxt("• Tekma je v endgame lock režimu (90+ / KILL GAME).", RED, True))
        print("• Open-game signali se ne uporabljajo več za vstop.")
        print("• Trading signal je zaklenjen na NO BET.")
        print("• Fokus: upravljanje že obstoječe pozicije (brez novega entry).")
        print(f"\n{MAGENTA}Moje predvidevanje:{RESET}")
        print("Napoved izida".ljust(28), btxt(str(r.get("napoved_izida", "N/A")), CYAN, True))
        print("Napoved rezultata".ljust(28), btxt(str(r.get("napoved_rezultata", "N/A")), CYAN, True))
        print("Kaj bi stavil".ljust(28), btxt("NO BET", YELLOW, True))
        print("Zakaj".ljust(28), "ENDGAME LOCK (90+)")
        print(f"\n{MAGENTA}Na kaj moraš biti najbolj pozoren:{RESET}")
        print(f"{btxt('- Protect bankroll / brez novega entryja', YELLOW, True)}")
        print(f"{btxt('- Zaklep rezultata in časovni decay', ORANGE, True)}")
        return
    ...
    # Po `bet_decision` (kliče `izpis_rezultata` najprej) je kanonična stava v `final_auto_*`,
    # ne v `moja_stava` (predlog iz `predlog_stave` ob izračunu modela).
    _fab = str(r.get("final_auto_bet", "") or "").strip().upper()
    if _fab and _fab not in ("NONE",):
        stava = _fab
        razlog = str(r.get("final_auto_reason") or r.get("razlog_stave") or "")
    else:
        stava = r["moja_stava"]
...
def cfos_slo_interpretacija(
    ...
    print("\n=============== CFOS RAZLAGA =================\n")
    if str(bet or "").strip().upper() == "NO BET" and str(no_bet_reason or "").strip() and (not endgame_lock):
        print("NO BET ZAKLEP:")
        print(f"Glavni razlog: {no_bet_reason}")
        print("Razlaga odprte tekme je informativna in ne pomeni vstopnega signala.")
        print("Trgovalni ukrep: počakaj na potrjen vstopni signal.")
        print("\n============================================\n")
        return
    if endgame_lock or int(float(minute or 0)) >= int(CFG.get("HARD_ENDGAME_NO_BET_MINUTE", 90)):
        print("KONČNICA:")
        print("Tekma je v zaključni fazi (90+).")
        print("Rezultat je praktično zaklenjen.")
        print("Interpretacija odprte tekme je izklopljena.")
        print("Trgovalni signal: NO BET.")
        print("\n============================================\n")
        return
...
def izpis_rezultata(r):
    ...
    if ng_smart:
        ...
        hide_conf_min = float(CFG.get("EXEC_HIDE_SIGNAL_CONF_MIN", 0.40))
        if conf_val < hide_conf_min:
            print(f"Prediction".ljust(28), btxt("HIDDEN (LOW CONF)", YELLOW, True))
            ...
            print(f"Signal filter".ljust(28), btxt(f"< {int(hide_conf_min*100)}% => SIDE HIDDEN", YELLOW, False))
        else:
    ...
    if _is_endgame_closed_context(r):
        print(btxt("NEXT GOAL SIGNAL -> SKRIT (ENDGAME LOCK)", YELLOW, True))
    elif _is_no_bet_locked_context(r):
        _r = _no_bet_lock_reason(r)
        if bool(r.get("latent_goal_signal_active", False)):
            _ls = str(r.get("latent_goal_signal_side", "NONE") or "NONE").strip().upper()
            _lr = str(r.get("latent_goal_signal_reason", "") or "").strip()
            _msg = f"NEXT GOAL SIGNAL -> {_ls} (INFO ONLY) | {_r}"
            if _lr:
                _msg += f" | {_lr}"
            print(btxt(_msg, CYAN, True))
            if bool(r.get("latent_over_signal", False)):
                print(btxt("OVER SIGNAL -> YES (INFO ONLY, LATE COMEBACK BUILD-UP)", YELLOW, True))
        else:
            print(btxt(f"NEXT GOAL SIGNAL -> INFORMACIJA (BREZ ENTRY) | {_r}", YELLOW, True))
    else:
    ...
    if _is_endgame_closed_context(r):
        print(btxt("• ENDGAME LOCK (90+) -> NO NEW ENTRY", RED, True))
        print(btxt("SIGNAL: GAME CLOSED / NO BET", YELLOW, True))
    elif _is_no_bet_locked_context(r):
        _r = _no_bet_lock_reason(r)
        print(btxt(f"• TRGOVALNI SIGNAL: NO ENTRY ({_r})", RED, True))
        print(btxt("• Match signal je informativen do odpiranja entry okna.", YELLOW, True))
    else:
        if r["p_goal"] < 0.25:
    ...
    cfos_slo_interpretacija(
        ...
        minute=int(float(r.get("minute", 0) or 0)),
        endgame_lock=_is_endgame_closed_context(r),
        no_bet_reason=_no_bet_lock_reason(r) if _is_no_bet_locked_context(r) else ""
    )
...
def _display_top5_for_pick(top5_list, pick_key, scores_dict):
    """Če se končni pick razlikuje od zmagovalca `scores` sorta, prvo vrstico uskladi (UX + CSV)."""
    if not top5_list:
        return []
    pk = str(pick_key or "").strip().upper()
    if not pk or pk in ("NO BET", "NONE"):
        return list(top5_list)
    out = [(str(k), float(v or 0.0)) for k, v in top5_list]
    first_k = str(out[0][0] or "").strip().upper()
    if first_k == pk:
        return out
    base_s = float(out[0][1] or 0.0)
    alt_s = float((scores_dict or {}).get(pk, 0.0) or 0.0)
    pick_s = max(base_s, alt_s) + 0.01
    rest = [(k, v) for k, v in out if str(k).strip().upper() != pk][:4]
    return [(pk, pick_s)] + rest


def _decision_quality_0_100(
    main_bet,
    *,
    mc_h,
    mc_x,
    ...
    """
    Hevristična ocena 0–100: kalibracija + edge/MC za izbrano stavo + skladnost s scores rank1
    + band confidence; znižanje ob skritem tveganju / dual threat. (Ne spreminja picka.)
    """
    rel = max(0.0, min(1.0, float(model_reliability or 0.0)))
    q = 28.0 + rel * 38.0
    mb = str(main_bet or "").strip().upper()
    edge_pick = 0.0
    mc_pick = max(float(mc_h or 0.0), float(mc_x or 0.0), float(mc_a or 0.0))
    if mb == "HOME":
        edge_pick, mc_pick = float(edge_h or 0.0), float(mc_h or 0.0)
    elif mb == "AWAY":
        edge_pick, mc_pick = float(edge_a or 0.0), float(mc_a or 0.0)
    elif mb == "DRAW":
        edge_pick, mc_pick = float(edge_x or 0.0), float(mc_x or 0.0)
    elif mb == "NEXT GOAL HOME":
        edge_pick, mc_pick = float(edge_h or 0.0), float(mc_h or 0.0)
    elif mb == "NEXT GOAL AWAY":
        edge_pick, mc_pick = float(edge_a or 0.0), float(mc_a or 0.0)
    elif mb == "COMEBACK HOME":
        edge_pick, mc_pick = float(edge_h or 0.0), float(mc_h or 0.0)
    elif mb == "COMEBACK AWAY":
        edge_pick, mc_pick = float(edge_a or 0.0), float(mc_a or 0.0)
    elif mb == "NO GOAL":
        edge_pick, mc_pick = 0.0, float(mc_x or 0.0)

    if mb not in ("NO BET", "NONE", ""):
        q += min(26.0, max(0.0, edge_pick) * 58.0)
        q += min(14.0, max(0.0, mc_pick - 0.50) * 42.0)

    if str(scores_rank1_key or "").strip().upper() == mb:
        q += 9.0

    cw = str(confidence or "").strip().upper()
    if cw == "HIGH":
        q += 5.0
    elif cw == "MEDIUM":
        q += 2.5
...
def bet_decision(r):
    ...
    _gs_v2 = str(r.get("game_state_v2", "") or "")
    _ts_ctx = str(r.get("timing_state", "") or "")
    _in_h = str(r.get("intent_home", "") or "")
    _in_a = str(r.get("intent_away", "") or "")
    if _gs_v2 or _ts_ctx:
        _note(f"CTX: {_gs_v2 or '-'} / TIMING: {_ts_ctx or '-'} / INTENT H:{_in_h or '-'} A:{_in_a or '-'}")
    ...
    lam_h = float(r.get("lam_h", 0) or 0)
    lam_a = float(r.get("lam_a", 0) or 0)
    lam_total = float(r.get("lam_total", lam_h + lam_a) or (lam_h + lam_a))
    ...
    ignore_home_pressure = bool(r.get("ignore_home_pressure", False))
    if ignore_home_pressure:
        _note("CFOS GOLD: ignore_home_pressure ON (trail 75+)")
    ...
    wave_for_entry = bool(wave_active or semi_wave_active)
    pre_trigger_chaos = bool(r.get("pre_trigger_chaos", False))
    pre_trigger_reason = str(r.get("pre_trigger_reason", "") or "")
    ...
    goal_only_mode = str(r.get("goal_only_mode", "BLOCKED") or "BLOCKED").strip().upper()
    goal_only_action = str(r.get("goal_only_action", "NO ALT") or "NO ALT").strip()
    goal_only_reason = str(r.get("goal_only_reason", "NONE") or "NONE").strip()
    ...
    ng_signals_agreement = int(ng_smart.get("signals_agreement", 0) or 0)
    ...
    # ================= PRE-GOAL TRIGGER ENGINE =================
    pre_goal_trigger = False
    pre_goal_side = "NONE"
    pre_goal_strength = 0.0
    tempo_attacks = float(r.get("tempo_attacks", 0.0) or 0.0)
    if tempo_attacks <= 0.0:
        tempo_attacks = (float(attacks_h or 0.0) + float(attacks_a or 0.0)) / max(1.0, float(minute or 1))
    if minute >= int(CFG.get("PRE_GOAL_MINUTE", 25)):
        _atk_ratio = float(CFG.get("PRE_GOAL_ATTACK_RATIO_MIN", 1.80))
        _dng_ratio = float(CFG.get("PRE_GOAL_DANGER_RATIO_MIN", 2.00))
        _lam_ratio = float(CFG.get("PRE_GOAL_LAM_RATIO_MIN", 2.50))
        _mom_min = float(CFG.get("PRE_GOAL_MOM_MIN", 0.22))
        _td_min = float(CFG.get("PRE_GOAL_TEMPO_DANGER_MIN", 0.95))
        _ta_min = float(CFG.get("PRE_GOAL_TEMPO_ATTACKS_MIN", 1.60))
        home_dom = (attacks_h > attacks_a * _atk_ratio) and (danger_h > danger_a * _dng_ratio)
        away_dom = (attacks_a > attacks_h * _atk_ratio) and (danger_a > danger_h * _dng_ratio)
        home_edge = lam_h > (lam_a * _lam_ratio)
        away_edge = lam_a > (lam_h * _lam_ratio)
        home_mom = momentum > _mom_min
        away_mom = momentum < -_mom_min
        tempo_ok = (tempo_danger > _td_min) or (tempo_attacks > _ta_min)
        if home_dom and home_edge and home_mom and tempo_ok:
            pre_goal_trigger = True
            pre_goal_side = "HOME"
            pre_goal_strength = (
                (attacks_h / max(1.0, attacks_a)) * 0.3
                + (danger_h / max(1.0, danger_a)) * 0.4
                + (lam_h * 0.3)
            )
        elif away_dom and away_edge and away_mom and tempo_ok:
            pre_goal_trigger = True
            pre_goal_side = "AWAY"
            pre_goal_strength = (
                (attacks_a / max(1.0, attacks_h)) * 0.3
                + (danger_a / max(1.0, danger_h)) * 0.4
                + (lam_a * 0.3)
            )
    if pre_goal_trigger:
        if (
            tempo_shots < float(CFG.get("PRE_GOAL_BLOCK_TEMPO_SHOTS_MAX", 0.12))
            and tempo_danger < float(CFG.get("PRE_GOAL_BLOCK_TEMPO_DANGER_MAX", 0.90))
        ) or (lam_total < float(CFG.get("PRE_GOAL_BLOCK_LAM_TOTAL_MAX", 0.35))):
            pre_goal_trigger = False
            pre_goal_side = "NONE"
            pre_goal_strength = 0.0
    try:
        r["tempo_attacks"] = round(float(tempo_attacks), 3)
        r["pre_goal_trigger"] = bool(pre_goal_trigger)
        r["pre_goal_side"] = str(pre_goal_side)
        r["pre_goal_strength"] = round(float(pre_goal_strength), 3)
    except Exception as e:
        cfos_log_ex("bet_decision pre_goal_trigger flags", e)
    gd_engine = _goal_decision_engine_snapshot(r)
    gd_phase_entry_active = bool(gd_engine.get("phase_entry_active", False))
    gd_final_bet = str(gd_engine.get("final_bet", "NO BET") or "NO BET").strip().upper()
    gd_final_conf = int(gd_engine.get("final_conf", 0) or 0)
    gd_minute_gate_ok = bool(gd_engine.get("minute_gate_ok", False))
    gd_control_game = bool(gd_engine.get("control_game", False))
    gd_timing_delayed = bool(gd_engine.get("timing_delayed", False))
    gd_event_lock = bool(gd_engine.get("event_lock", False))
    gd_low_event_breakout = bool(gd_engine.get("low_event_breakout", False))
    gd_low_event_breakout_side = str(gd_engine.get("low_event_breakout_side", "NONE") or "NONE").strip().upper()
    gd_low_event_breakout_level = str(gd_engine.get("low_event_breakout_level", "NONE") or "NONE").strip().upper()
    gd_low_event_breakout_stake = float(gd_engine.get("low_event_breakout_stake", 0.0) or 0.0)
    ...
    # =====================================================
    # SMART MINUTE ENGINE (minute = weight, event = gate)
    # =====================================================
    ...
    event_ok = bool(sm_state.get("event_ok", False))
    event_reason = str(sm_state.get("event_reason", "EVENT TRIGGER MISSING") or "EVENT TRIGGER MISSING")
    wave_for_entry = bool(sm_state.get("wave_for_entry", wave_for_entry))
    try:
        r["minute_mult"] = round(float(minute_mult), 3)
        r["event_ok"] = bool(event_ok)
        r["event_reason"] = str(event_reason)
    except Exception as e:
        cfos_log_ex("bet_decision minute_engine flags", e)

    early_bypass = False
    early_bypass_reason = ""
    if minute < CFG["MIN_BET_MINUTE"]:
        edge_a_ev = float(r.get("edge_a", 0) or 0)
        edge_h_ev = float(r.get("edge_h", 0) or 0)
        tempo_hi_ev = (float(tempo_shots) > 0.18) or (float(tempo_danger) > 1.2)
        safe_early = (
            (not hidden_goal_risk)
            and (not dual_threat_mode)
            and bet_mode not in ("FREEZE", "LOW_EVENT")
            and (not kill_game)
            and (not counter_risk)
        )
        early_goal_event_bypass = (
            safe_early
            and float(p_goal or 0.0) >= float(CFG.get("EARLY_GOAL_EVENT_PGOAL_MIN", 0.65))
            and float(lam_total or 0.0) >= float(CFG.get("EARLY_GOAL_EVENT_LAM_TOTAL_MIN", 1.00))
        )
        # PRO: elite AWAY value + tempo (market še ne prilagojen)
        if early_goal_event_bypass:
            early_bypass = True
            early_bypass_reason = "EARLY GOAL EVENT: p_goal+lambda (event lane bypass <MIN_BET)"
        elif (
            safe_early
            and edge_a_ev > CFG["EARLY_VALUE_EDGE"]
            and mc_a > CFG["EARLY_VALUE_MC"]
            and tempo_hi_ev
        ):
            early_bypass = True
            early_bypass_reason = "EARLY VALUE: AWAY edge+MC+tempo (bypass <MIN_BET)"
        # BONUS: AWAY vodi od 55' + močan λ + SOT realizacija
        elif (
            safe_early
            and minute >= CFG["EARLY_ATTACK_MINUTE"]
            and score_diff < 0
            and lam_a > lam_h * CFG["EARLY_ATTACK_LAM_RATIO"]
            and float(sot_a) >= CFG["EARLY_ATTACK_SOT_MIN"]
        ):
            early_bypass = True
            early_bypass_reason = "EARLY ATTACK: AWAY lead + λ + SOT (bypass <MIN_BET)"
        elif (
            safe_early
            and edge_h_ev > CFG["EARLY_VALUE_EDGE"]
            and mc_h > CFG["EARLY_VALUE_MC"]
            and tempo_hi_ev
        ):
            early_bypass = True
            early_bypass_reason = "EARLY VALUE: HOME edge+MC+tempo (bypass <MIN_BET)"
        elif (
            safe_early
            and minute >= CFG["EARLY_ATTACK_MINUTE"]
            and score_diff > 0
            and lam_h > lam_a * CFG["EARLY_ATTACK_LAM_RATIO"]
            and float(sot_h) >= CFG["EARLY_ATTACK_SOT_MIN"]
        ):
            early_bypass = True
            early_bypass_reason = "EARLY ATTACK: HOME lead + λ + SOT (bypass <MIN_BET)"
        elif (
            safe_early
            and minute >= int(CFG.get("EARLY_PRETRIGGER_FROM_MINUTE", 65))
            and float(p_goal or 0.0) >= float(CFG.get("EARLY_PRETRIGGER_PGOAL_MIN", 0.60))
            and float(p_goal_10 or 0.0) >= float(CFG.get("EARLY_PRETRIGGER_PGOAL10_MIN", 0.32))
            and abs(float(p_home_next or 0.0) - float(p_away_next or 0.0)) >= float(CFG.get("EARLY_PRETRIGGER_SIDE_GAP_MIN", 0.06))
        ):
            early_bypass = True
            early_bypass_reason = "EARLY PRE-TRIGGER: soft unlock 65+ (build-up lane)"
        elif (
            safe_early
            and minute >= int(CFG.get("EARLY_BUILDUP_FROM_MINUTE", 60))
            and float(p_goal or 0.0) >= float(CFG.get("EARLY_BUILDUP_PGOAL_MIN", 0.55))
            and float(p_goal_10 or 0.0) >= float(CFG.get("EARLY_BUILDUP_PGOAL10_MIN", 0.28))
        ):
            early_bypass = True
            early_bypass_reason = "EARLY BUILD-UP: soft unlock 60+ (monitoring lane)"
        elif (
            safe_early
            and gd_minute_gate_ok
            and gd_phase_entry_active
            and gd_final_bet != "NO BET"
        ):
            early_bypass = True
            early_bypass_reason = f"GOAL DECISION ENGINE EARLY UNLOCK: {gd_final_bet}"
        try:
            r["early_value_bypass"] = bool(early_bypass)
            r["early_value_bypass_reason"] = str(early_bypass_reason or "")
        except Exception as e:
            cfos_log_ex("bet_decision early_value_bypass flags", e)

    if minute < CFG["MIN_BET_MINUTE"] and (not early_bypass) and (not event_ok):
        early_side = "NONE"
        if game_state == "AWAY DOMINACIJA":
            early_side = "AWAY"
        elif game_state == "HOME DOMINACIJA":
            early_side = "HOME"
        decision_trace.append("EARLY_EVENT_LOCK")
        decision_trace.append("FINAL:NO_BET")
        print()
        print("=============== BET DECISION ===============" + cmd_tag("FINAL"))
        print()
        print("MINUTE:", minute)
        print()
        print("DECISION TRACE:", " → ".join(decision_trace))
        print()
        print("BET: NO BET")
        print("CONFIDENCE: LOW")
        _exec, _why = live_execution_status(r, "NO BET", "LOW")
        _clr = GREEN if _exec == "GO" else RED
        print("IZVEDBA V ŽIVO:", btxt(f"{_exec} | {_why}", _clr, True))
        print()
        print("ALTERNATIVE:")
        print("2) NO BET")
        print("3) NO BET")
        ...
        if p_goal < 0.35 and tempo_danger < 0.8:
            print("NO EVENT:", "LOW GOAL PROB + LOW TEMPO")
            print("RAZLAGA:", "nizka verjetnost gola + nizek tempo")
        print()
        print("============================================")
        try:
            r["final_auto_bet"] = "NO BET"
            r["final_auto_conf"] = "LOW"
            r["final_auto_reason"] = "SMART MINUTE ENGINE: EVENT LOCK"
            r["moja_stava"] = "NO BET"
            r["razlog_stave"] = "SMART MINUTE ENGINE: EVENT LOCK"
            r["decision_trace"] = list(decision_trace)
        except Exception as e:
            cfos_log_ex("bet_decision early final_auto_*", e)
        try:
            _mr = calib_get_reliability()
        except Exception as e:
            cfos_log_ex("bet_decision early calib_get_reliability", e)
            _mr = 0.75
        append_bet_decision_log_row(
            r,
            main_bet="NO BET",
            decision_reason="SMART MINUTE ENGINE: EVENT LOCK",
            confidence="LOW",
            stake_band="0",
        ...
        try:
            ...
            cfos_log_ex("bet_decision early _vd_engine", e)
        return

    if minute < CFG["MIN_BET_MINUTE"] and (early_bypass or event_ok):
        if early_bypass_reason:
            _note(early_bypass_reason)
        if event_ok:
            _note(f"SMART MINUTE ENGINE: {event_reason} | minute_mult={minute_mult:.2f}")
        _note("EARLY_BYPASS_CONTINUE")
    ...
    if minute >= CFG["MIN_BET_MINUTE"] and low_lambda and low_tempo and low_goal and balanced:
        decision_trace.append("MASTER_FREEZE")
        decision_trace.append("FINAL:NO_BET")
        print()
        print("=============== BET DECISION ===============" + cmd_tag("FINAL"))
        print()
        ...
        _exec, _why = live_execution_status(r, "NO BET", "HIGH")
        _clr = GREEN if _exec == "GO" else RED
        print("IZVEDBA V ŽIVO:", btxt(f"{_exec} | {_why}", _clr, True))
        ...
        try:
            ...
            r["moja_stava"] = "NO BET"
            r["razlog_stave"] = "MASTER FREEZE FILTER"
            r["decision_trace"] = list(decision_trace)
        except Exception as e:
            cfos_log_ex("bet_decision master_freeze final_auto_*", e)
        try:
            _mr = calib_get_reliability()
        except Exception as e:
            cfos_log_ex("bet_decision master_freeze calib", e)
            _mr = 0.75
        append_bet_decision_log_row(
            r,
            main_bet="NO BET",
        ...
        try:
            ...
            cfos_log_ex("bet_decision master_freeze _vd_engine", e)
        return
    ...
    if minute >= CFG["MIN_BET_MINUTE"] and score_diff < 0 and mc_a > 0.60:
        stronger_side = "AWAY"
    elif minute >= CFG["MIN_BET_MINUTE"] and score_diff > 0 and mc_h > 0.60:
        stronger_side = "HOME"
    ...
    # NUJNO: fake pressure guard (danger/possession brez xG kvalitete).
    _fp_on, _fp_side, _fp_reason = _detect_fake_pressure_guard(
        danger_h=danger_h,
        danger_a=danger_a,
        pos_h=pos_h,
        pos_a=pos_a,
    ...
    main_bet = top5[0][0]
    _note(f"TOP5:{main_bet}")
    decision_reason = ""
    control_override_active = False
    control_soft_link_flag = False
    hard_no_bet_lock = False
    pro_late_value_flag = False
    freeze_override_active = False
    edge_mode_active = False
    edge_mode_side = ""
    goal_event_engine_active = False
    goal_event_engine_side = ""
    goal_event_only_active = False
    goal_decision_engine_override_active = False
    goal_decision_engine_override_reason = ""
    low_event_breakout_active = False
    low_event_breakout_level = "NONE"
    low_event_breakout_stake_units = 0.0
    comeback_aggressive_entry_active = False
    comeback_aggressive_entry_reason = ""
    early_goal_entry_active = False
    early_goal_entry_aggressive = False
    early_goal_event_force = False
    pre_goal_entry_forced = False
    pre_goal_entry_side = str(pre_goal_side or "NONE").strip().upper()
    pre_goal_entry_strength = float(pre_goal_strength or 0.0)

    ng_gap = abs(p_home_next - p_away_next)
    if (
        pre_goal_trigger
        and pre_goal_entry_side in ("HOME", "AWAY")
        and abs(score_diff) <= 1
        and minute < int(CFG.get("HARD_ENDGAME_NO_BET_MINUTE", 90))
        and (not hidden_goal_risk)
        and (not dual_threat_mode)
        and (not counter_risk)
    ):
        main_bet = f"NEXT GOAL {pre_goal_entry_side}"
        decision_reason = (
            f"PRE-GOAL TRIGGER (EARLY ENTRY): {pre_goal_entry_side} "
            f"| strength {pre_goal_entry_strength:.2f}"
        )
        pre_goal_entry_forced = True
        hard_no_bet_lock = False
        _note(f"PRE_GOAL_TRIGGER→{main_bet}")

    # MATCH 1X2 value gate (ne mešaj z NG timing): močan edge + MC + rezultat/λ/momentum v pravo stran
    edge_h_mv = float(r.get("edge_h", 0) or 0)
    edge_a_mv = float(r.get("edge_a", 0) or 0)
    match_force_home = (
        edge_h_mv > CFG["MATCH_VALUE_FORCE_EDGE"]
        and mc_h > CFG["MATCH_VALUE_FORCE_MC"]
        and score_diff > 0
        and lam_h >= lam_a * 0.95
        and momentum > 0.02
    )
    match_force_away = (
        edge_a_mv > CFG["MATCH_VALUE_FORCE_EDGE"]
        and mc_a > CFG["MATCH_VALUE_FORCE_MC"]
        and score_diff < 0
        and lam_a >= lam_h * 0.95
        and momentum < -0.02
    )

    _cb_min = int(CFG.get("COMEBACK_AGGR_MINUTE", 65))
    _cb_max = int(CFG.get("COMEBACK_AGGR_MAX_MINUTE", 80))
    _cb_sd = int(CFG.get("COMEBACK_AGGR_SCORE_DIFF", 1))
    _cb_lr = float(CFG.get("COMEBACK_AGGR_LAM_RATIO_MIN", 1.30))
    _cb_td = float(CFG.get("COMEBACK_AGGR_TEMPO_DANGER_MIN", 1.20))
    _cb_mom = float(CFG.get("COMEBACK_AGGR_MOM_MIN", 0.12))
    _cb_allow_no_wave = bool(CFG.get("COMEBACK_AGGR_ALLOW_NO_WAVE", True))
    comeback_aggr_home = (
        minute >= _cb_min
        and minute <= _cb_max
        and score_diff == -_cb_sd
        and lam_h > (lam_a * _cb_lr)
        and tempo_danger > _cb_td
        and momentum >= _cb_mom
        and (_cb_allow_no_wave or wave_for_entry)
    )
    comeback_aggr_away = (
        minute >= _cb_min
        and minute <= _cb_max
        and score_diff == _cb_sd
        and lam_a > (lam_h * _cb_lr)
        and tempo_danger > _cb_td
        and momentum <= -_cb_mom
        and (_cb_allow_no_wave or wave_for_entry)
    )
    ...
    # =====================================================
    # 0) ENDGAME HARD LOCK (90+): po 90' ne odpiramo novih stav.
    if (
        minute >= int(CFG.get("HARD_ENDGAME_NO_BET_MINUTE", 90))
        and main_bet != "NO BET"
    ):
        main_bet = "NO BET"
        decision_reason = "ENDGAME HARD LOCK (90+)"
        _note(decision_reason)
    ...
    if (
        minute >= CFG["GAME_DECIDED_MINUTE"]
        and abs(score_diff) >= 2
        and p_goal_10 < CFG["LOW_GOAL_10M_NEXT"]
        and main_bet != "NO BET"
    ):
        main_bet = "NO BET"
    ...
    if (
        ...
        and (not pre_goal_entry_forced)
        and ng_smart_conf < CFG["NG_CONF_MIN"]
        and main_bet in ("NEXT GOAL HOME", "NEXT GOAL AWAY", "COMEBACK HOME", "COMEBACK AWAY")
        and (
            (main_bet not in ("NEXT GOAL HOME", "COMEBACK HOME") or (not comeback_aggr_home))
            and (main_bet not in ("NEXT GOAL AWAY", "COMEBACK AWAY") or (not comeback_aggr_away))
        )
    ):
        main_bet = "NO BET"
    ...
    if (
        ...
        main_bet = "NO BET"
        decision_reason = f"LOW GOAL 10M ({p_goal_10*100:.1f}% < {CFG['LOW_GOAL_10M_NEXT']*100:.0f}%)"
        _note(decision_reason)
        hard_no_bet_lock = True

    # 4) PRE-TRIGGER CHAOS: <70, brez vala, zrel signal še ni — NG/COMEBACK zadržan
    if (
        (not hard_no_bet_lock)
        and (not pre_goal_entry_forced)
        and pre_trigger_chaos
        and minute < int(CFG.get("PRE_TRIGGER_MAX_MINUTE", 70))
        and (not wave_active)
        and main_bet in ("NEXT GOAL HOME", "NEXT GOAL AWAY", "COMEBACK HOME", "COMEBACK AWAY")
    ):
        main_bet = "NO BET"
        decision_reason = "PRE-TRIGGER BLOCK" + (
            f" ({pre_trigger_reason})" if pre_trigger_reason else ""
        )
        _note(decision_reason)
        hard_no_bet_lock = True

    # 5) REAL ENTRY ENGINE (ANTI-FAKE COMEBACK)
    # 70+ samo po sebi ni dovolj: za comeback smer mora biti wave + momentum + signal alignment.
    real_entry_min = int(CFG.get("REAL_ENTRY_MINUTE", 70))
    min_mom = float(CFG.get("REAL_ENTRY_MIN_MOMENTUM", 0.05))
    min_agr = int(CFG.get("REAL_ENTRY_MIN_SIGNALS_AGR", 4))
    if (
        (not hard_no_bet_lock)
        and minute >= real_entry_min
        and score_diff < 0
        and main_bet in ("NEXT GOAL HOME", "COMEBACK HOME")
        and (not comeback_aggr_home)
        and ((not wave_active) or abs(momentum) < min_mom or ng_signals_agreement < min_agr)
    ):
        main_bet = "NO BET"
        decision_reason = (
            f"ZAKLENJENO: LAŽNI COMEBACK SIGNAL (DOMA): wave={1 if wave_active else 0}, "
            f"momentum={momentum:.2f}, skladnost={ng_signals_agreement}/7"
        )
        _note(decision_reason)
        hard_no_bet_lock = True
    ...
    if (
        ...
        and (not comeback_aggr_away)
        and ((not wave_active) or abs(momentum) < min_mom or ng_signals_agreement < min_agr)
    ):
        main_bet = "NO BET"
        decision_reason = (
            f"ZAKLENJENO: LAŽNI COMEBACK SIGNAL (GOST): wave={1 if wave_active else 0}, "
            f"momentum={momentum:.2f}, skladnost={ng_signals_agreement}/7"
        )
        _note(decision_reason)
        hard_no_bet_lock = True

    # 6) FREEZE MODE (82+/85+): pozna mrtva tekma -> dovoli DRAW/NO GOAL entry brez value gate.
    freeze_mode, freeze_hard = _freeze_mode_flags({
        "minute": minute,
        "score_diff": score_diff,
        "lam_total": lam_total,
        "lam_h": lam_h,
        ...
        "hidden_goal_risk": hidden_goal_risk,
        "fake_home_pressure": fake_home_pressure,
        "fake_away_pressure": bool(r.get("fake_away_pressure", False)),
    })
    if (not hard_no_bet_lock) and freeze_mode:
        freeze_draw_ok = mc_x >= float(CFG.get("FREEZE_DRAW_MC_MIN", 0.65))
        freeze_nogoal_ok = p_no_goal >= float(CFG.get("FREEZE_NO_GOAL_MIN", 0.70))
        freeze_pick = ""
        if freeze_nogoal_ok and p_no_goal >= (mc_x + 0.03):
            freeze_pick = "NO GOAL"
        elif freeze_draw_ok:
            freeze_pick = "DRAW"
        elif freeze_nogoal_ok:
            freeze_pick = "NO GOAL"

        if freeze_pick:
            prev_bet = str(main_bet or "").strip().upper()
            if prev_bet in (
                "NO BET",
                "NONE",
                "",
                ...
                main_bet = freeze_pick
                freeze_override_active = True
                decision_reason = (
                    "FREEZE MODE (85+ hard): nizka gol verjetnost, izenačeno"
                    if freeze_hard
                    else "FREEZE MODE (82+): nizka lambda, brez vala, nizek momentum"
                )
                _note(decision_reason)
                hard_no_bet_lock = False
    ...
    if (
        main_bet != "NO BET"
        and (not freeze_override_active)
    ...
    try:
        ...
        cfos_log_ex("bet_decision _vd_engine (pre-control)", e)
    ...
    # ================= PRE-ENTRY / ENTRY ENGINE =================
    pre_entry = False
    entry_trigger = False
    entry_side = "NONE"
    entry_trigger_reason = ""
    entry_final = False
    entry_signal_found = False
    entry_candidate_bet = ""
    entry_execution_allowed = False
    entry_execution_status = "WAIT"
    entry_blocked_by_timing = False
    entry_block_reason = ""
    entry_prepare = False
    micro_entry_active = False
    comeback_force_entry_active = False
    early_goal_entry_reason = ""
    ...
    if (
        ...
        side_ratio = float(CFG.get("PRE_ENTRY_LAM_SIDE_RATIO", 1.50))
        if lam_h > (lam_a * side_ratio):
            pre_entry = True
            entry_side = "HOME"
        elif lam_a > (lam_h * side_ratio):
            pre_entry = True
            entry_side = "AWAY"

    # če je attack wave že aktiven, to ni več build-up
    if wave_active:
        pre_entry = False

    # ---------------- ENTRY TRIGGER ----------------
    if p_goal_10 >= float(CFG.get("PRE_ENTRY_TRIGGER_PGOAL10_MIN", 0.35)):
        entry_trigger = True
        entry_trigger_reason = "10M GOAL PROB HIGH"

    if wave_active:
        entry_trigger = True
        entry_trigger_reason = "ATTACK WAVE ACTIVE"

    if semi_wave_active:
        entry_trigger = True
        entry_trigger_reason = "SEMI WAVE PRESSURE"

    if tempo_danger > float(CFG.get("PRE_ENTRY_TRIGGER_TEMPO_DANGER_MIN", 1.00)):
        entry_trigger = True
        entry_trigger_reason = "HIGH DANGER TEMPO"

    # ANTI LATE TRAP: ne odpiraj novega entry triggerja v 88+
    if minute >= CFG["ENTRY_ANTI_LATE_MINUTE"]:
        entry_trigger = False

    # ---------------- FINAL ENTRY ----------------
    if pre_entry and entry_trigger:
        entry_final = True

    # fallback: direct strong signal (brez pre-entry)
    if (
        p_goal >= float(CFG.get("PRE_ENTRY_DIRECT_PGOAL_MIN", 0.70))
        and p_goal_10 >= float(CFG.get("PRE_ENTRY_DIRECT_PGOAL10_MIN", 0.35))
    ):
        entry_final = True
        entry_side = "HOME" if lam_h > lam_a else "AWAY"
        entry_trigger_reason = "DIRECT STRONG GOAL SIGNAL"

    # fake pressure block
    if fake_pressure and entry_final:
        entry_final = False
        entry_trigger_reason = "FAKE PRESSURE BLOCK"

    # known hard-risk block
    if hidden_goal_risk or dual_threat_mode:
        entry_final = False
        if not entry_trigger_reason:
            entry_trigger_reason = "RISK BLOCK"

    # EARLY GOAL ENTRY (BUILD-UP): ne cakaj izkljucno na 10m trigger.
    if bool(CFG.get("EARLY_GOAL_BUILDUP_ENABLE", True)):
        _eg_min = int(CFG.get("EARLY_GOAL_BUILDUP_MINUTE", 60))
        _eg_pg = float(CFG.get("EARLY_GOAL_BUILDUP_PGOAL_MIN", 0.45))
        _eg_td = float(CFG.get("EARLY_GOAL_BUILDUP_TEMPO_DANGER_MIN", 0.60))
        _eg_lm = float(CFG.get("EARLY_GOAL_BUILDUP_LAM_TOTAL_MIN", 0.60))
        _eg_gap = float(CFG.get("EARLY_GOAL_BUILDUP_DIR_GAP_MIN", 0.05))
        _eg_aggr = float(CFG.get("EARLY_GOAL_BUILDUP_AGGR_PGOAL_MIN", 0.60))
        _dir_gap = abs(float(p_home_next or 0.0) - float(p_away_next or 0.0))
        _eg_ok = (
            minute >= _eg_min
            and p_goal >= _eg_pg
            and tempo_danger > _eg_td
            and lam_total > _eg_lm
            and minute < int(CFG.get("ENTRY_ANTI_LATE_MINUTE", 88))
            and (not fake_pressure)
            and (not hidden_goal_risk)
            and (not dual_threat_mode)
        )
        if _eg_ok:
            early_goal_entry_active = True
            early_goal_entry_aggressive = bool(p_goal >= _eg_aggr)
            early_goal_entry_reason = (
                f"EARLY GOAL ENTRY (BUILD-UP) | P(goal)={p_goal:.2f} "
                f"tempo={tempo_danger:.2f} lam_total={lam_total:.2f}"
            )
            entry_trigger = True
            if _dir_gap >= _eg_gap:
                entry_final = True
                entry_side = "HOME" if float(p_home_next or 0.0) >= float(p_away_next or 0.0) else "AWAY"
                entry_trigger_reason = "EARLY GOAL ENTRY (BUILD-UP)"
            else:
                early_goal_event_force = True
            _note("EARLY_GOAL_BUILDUP:PRE_EVENT_ENTRY")

    # FORCE ENTRY (COMEBACK FIX): če je comeback-aggr + event trigger, ne čakaj BUILD-UP.
    if bool(CFG.get("COMEBACK_FORCE_ENTRY_ENABLE", True)):
        _cb_force_lr = float(CFG.get("COMEBACK_FORCE_ENTRY_LAM_RATIO_MIN", 1.40))
        _cb_force_td = float(CFG.get("COMEBACK_FORCE_ENTRY_TEMPO_DANGER_MIN", 1.25))
        _cb_force_event = bool(entry_trigger or event_ok)
        _force_home = (
            comeback_aggr_home
            and _cb_force_event
            and lam_h > (lam_a * _cb_force_lr)
            and tempo_danger > _cb_force_td
        )
        _force_away = (
            comeback_aggr_away
            and _cb_force_event
            and lam_a > (lam_h * _cb_force_lr)
            and tempo_danger > _cb_force_td
        )
        if (
            (_force_home or _force_away)
            and minute < int(CFG.get("ENTRY_ANTI_LATE_MINUTE", 88))
            and (not fake_pressure)
            and (not hidden_goal_risk)
            and (not dual_threat_mode)
        ):
            comeback_force_entry_active = True
            entry_final = True
            entry_side = "HOME" if _force_home else "AWAY"
            entry_trigger = True
            entry_trigger_reason = "FORCED COMEBACK ENTRY"
            _note(f"FORCE_ENTRY:COMEBACK_{entry_side}")

    # BUILD-UP PREPARE: setup je blizu triggerja (ETA <=10m), a še brez full entry.
    if (
        pre_entry
        and (not entry_final)
        and minute >= int(CFG.get("PRE_ENTRY_PREPARE_FROM_MINUTE", 55))
        and minute < int(CFG.get("ENTRY_ANTI_LATE_MINUTE", 88))
        and entry_side in ("HOME", "AWAY")
        and (
            p_goal_10 >= float(CFG.get("PRE_ENTRY_PREPARE_PGOAL10_MIN", 0.28))
            or semi_wave_active
            or abs(float(momentum or 0.0)) >= float(CFG.get("PRE_ENTRY_PREPARE_MOM_MIN", 0.14))
        )
    ):
        entry_prepare = True

    entry_status = "MONITOR"
    if pre_entry and (not entry_final):
        entry_status = "PREPARE ENTRY (ETA<=10m)" if entry_prepare else "SIGNAL BUILD-UP (WAIT)"
        main_bet = "NO BET"
        decision_reason = (
            "ENTRY ENGINE: PREPARE ENTRY (BUILD-UP, ETA<=10m)"
            if entry_prepare
            else "ENTRY ENGINE: PRE-ENTRY BUILD-UP (WAIT)"
        )
        _note(decision_reason)
        hard_no_bet_lock = False
        pro_late_value_flag = False
        control_soft_link_flag = False
        entry_execution_status = "PREPARE" if entry_prepare else "WAIT"
    elif early_goal_event_force:
        entry_status = "SIGNAL FOUND (EARLY GOAL EVENT)"
        main_bet = "GOAL YES"
        entry_signal_found = True
        entry_candidate_bet = "GOAL YES"
        entry_execution_allowed = True
        entry_execution_status = "GO (EARLY GOAL EVENT AGGR)" if early_goal_entry_aggressive else "GO (EARLY GOAL EVENT)"
        decision_reason = "EARLY GOAL ENTRY: GOAL YES (build-up override)"
        goal_event_engine_active = True
        goal_event_engine_side = "OVER"
        goal_event_only_active = True
        _note("EARLY_GOAL_EVENT_FORCE:GOAL_YES")
        hard_no_bet_lock = False
        pro_late_value_flag = False
        control_soft_link_flag = False
    elif entry_final and entry_side in ("HOME", "AWAY"):
        entry_status = "SIGNAL FOUND (CANDIDATE)"
        main_bet = f"NEXT GOAL {entry_side}"
        entry_signal_found = True
        entry_candidate_bet = str(main_bet)
        entry_execution_allowed = True
        entry_execution_status = "GO (FORCED COMEBACK)" if comeback_force_entry_active else "GO"
        if comeback_force_entry_active:
            decision_reason = f"FORCED COMEBACK ENTRY: NEXT GOAL {entry_side} (override timing)"
        else:
            decision_reason = f"ENTRY ENGINE: TRIGGER → NEXT GOAL {entry_side} ({entry_trigger_reason})"
        _note(decision_reason)
        hard_no_bet_lock = False
        pro_late_value_flag = False
        control_soft_link_flag = False
    elif pre_goal_trigger and pre_goal_entry_side in ("HOME", "AWAY"):
        entry_status = "WATCH SIGNAL (PRE-GOAL BUILD-UP)"
        entry_signal_found = True
        entry_candidate_bet = f"NEXT GOAL {pre_goal_entry_side}"
        if pre_goal_entry_forced:
            entry_execution_allowed = True
            entry_execution_status = "GO (PRE-GOAL EARLY)"
            main_bet = str(entry_candidate_bet)
            if not str(decision_reason or "").startswith("PRE-GOAL TRIGGER"):
                decision_reason = (
                    f"PRE-GOAL TRIGGER (EARLY ENTRY): {pre_goal_entry_side} "
                    f"| strength {pre_goal_entry_strength:.2f}"
                )
            _note("PRE_GOAL_EARLY_ENTRY:EXEC_GO")
        else:
            entry_execution_allowed = False
            entry_execution_status = "WATCH (PRE-GOAL BUILD-UP)"

    try:
        r["entry_wait_mode"] = bool(pre_entry)
        r["entry_trigger_home"] = bool(entry_trigger and entry_side == "HOME")
        r["entry_status"] = str(entry_status)
        r["entry_pre_mode"] = bool(pre_entry)
        r["entry_trigger"] = bool(entry_trigger)
        r["entry_side"] = str(entry_side or "NONE")
        r["entry_trigger_reason"] = str(entry_trigger_reason or "")
        r["entry_final"] = bool(entry_final)
        r["entry_prepare"] = bool(entry_prepare)
        r["comeback_force_entry_active"] = bool(comeback_force_entry_active)
        r["early_goal_entry_active"] = bool(early_goal_entry_active)
        r["early_goal_entry_aggressive"] = bool(early_goal_entry_aggressive)
        r["early_goal_entry_reason"] = str(early_goal_entry_reason or "")
    except Exception:
        pass
    ...
    _cb_home_bet = main_bet in ("NEXT GOAL HOME", "COMEBACK HOME")
    _cb_away_bet = main_bet in ("NEXT GOAL AWAY", "COMEBACK AWAY")
    _cb_aggr_for_bet = (_cb_home_bet and comeback_aggr_home) or (_cb_away_bet and comeback_aggr_away)
    if _cb_aggr_for_bet:
        comeback_aggressive_entry_active = True
        _cb_side = "HOME" if _cb_home_bet else "AWAY"
        comeback_aggressive_entry_reason = (
            f"COMEBACK AGGRESSIVE ENTRY ({_cb_side}) "
            f"| {minute}' λ-ratio ok + tempo_danger {tempo_danger:.2f}"
        )
        _note("COMEBACK_AGGR:BYPASS_TIMING_FILTER")
    if main_bet in _ng_timing_bets:
        _t_parts = []
        if (not _cb_aggr_for_bet) and (not pre_goal_entry_forced):
            if ng_smart_conf < CFG["NG_CONF_MIN"]:
                _t_parts.append("smart NG conf < 62%")
            if (not wave_for_entry) and p_goal_5 < CFG["FINAL_TIMING_LOW_GOAL_5M"]:
                _t_parts.append("no attack/semi-wave + P(goal 5m) < 15%")
        if _t_parts:
            main_bet = "NO BET"
            if entry_signal_found and entry_candidate_bet:
                entry_execution_allowed = False
                entry_execution_status = "BLOCKED (FINAL TIMING)"
                entry_blocked_by_timing = True
                entry_block_reason = " | ".join(_t_parts)
            decision_reason = "FINAL TIMING FILTER: " + " | ".join(_t_parts)
            _note(decision_reason)
            hard_no_bet_lock = True
            pro_late_value_flag = False
            control_soft_link_flag = False
        elif _cb_aggr_for_bet:
            if not str(decision_reason or "").startswith("ENTRY ENGINE: TRIGGER"):
                decision_reason = f"COMEBACK AGGRESSIVE ENTRY: TIMING BYPASS ({_cb_side})"
            hard_no_bet_lock = False

    # --- MICRO ENTRY: controlled execution in gray zone after timing block ---
    micro_entry_ok = (
        bool(CFG.get("MICRO_ENTRY_ENABLE", True))
        and main_bet == "NO BET"
        and entry_signal_found
        and entry_candidate_bet in _ng_timing_bets
        and entry_blocked_by_timing
        and minute >= int(CFG.get("MICRO_ENTRY_MINUTE", 55))
        and minute < int(CFG.get("MICRO_ENTRY_MAX_MINUTE", 88))
        and p_goal >= float(CFG.get("MICRO_ENTRY_PGOAL_MIN", 0.65))
        and p_goal_10 <= float(CFG.get("MICRO_ENTRY_PGOAL10_MAX", 0.35))
        and (semi_wave_active or abs(float(momentum or 0.0)) >= float(CFG.get("MICRO_ENTRY_MOM_MIN", 0.14)))
        and (not hidden_goal_risk)
        and (not dual_threat_mode)
        and (not counter_risk)
        and (not fake_pressure)
    ...
    if micro_entry_ok:
        main_bet = str(entry_candidate_bet)
        decision_reason = f"MICRO ENTRY: {entry_candidate_bet} (GRAY ZONE, 0.2)"
        micro_entry_active = True
        entry_execution_allowed = True
        entry_execution_status = "GO (MICRO)"
        entry_blocked_by_timing = False
        entry_block_reason = ""
        hard_no_bet_lock = False
        _note(f"MICRO_ENTRY→{entry_candidate_bet}")

    # --- MATCH 1X2 recovery: timing / entry filtri veljajo za NG, ne za čist match value ---
    dr_mv = str(decision_reason or "")
    timing_only_no_bet = (
        main_bet == "NO BET"
        and (
            dr_mv == "GOAL TIMING WAIT"
            or dr_mv.startswith("ENTRY ENGINE:")
            or dr_mv.startswith("FINAL TIMING FILTER:")
        )
        and (not hidden_goal_risk)
        and (not dual_threat_mode)
    )
    if timing_only_no_bet and match_force_home:
        main_bet = "HOME"
        decision_reason = "MATCH VALUE: 1X2 HOME (timing filter bypass)"
        hard_no_bet_lock = False
        pro_late_value_flag = False
        control_soft_link_flag = False
        _note("MATCH_LANE:BYPASS→HOME")
    elif timing_only_no_bet and match_force_away:
        main_bet = "AWAY"
        decision_reason = "MATCH VALUE: 1X2 AWAY (timing filter bypass)"
        hard_no_bet_lock = False
        pro_late_value_flag = False
        control_soft_link_flag = False
        _note("MATCH_LANE:BYPASS→AWAY")

    # --- GOAL EVENT override: visok P(goal), smer nejasna -> event trg namesto NO BET ---
    side_gap_event = abs(float(p_home_next or 0.0) - float(p_away_next or 0.0))
    chaos_goal_game = (
        wave_active
        or tempo_danger >= float(CFG.get("GOAL_EVENT_CHAOS_TEMPO_DANGER_MIN", 1.20))
        or tempo_shots >= float(CFG.get("GOAL_EVENT_CHAOS_TEMPO_SHOTS_MIN", 0.25))
        or abs(float(momentum or 0.0)) >= float(CFG.get("GOAL_EVENT_CHAOS_MOM_ABS_MIN", 0.18))
        or str(game_state or "").strip().upper() in ("OPEN CHAOS", "CHAOS")
        or str(r.get("game_type", "") or "").strip().upper() in ("CHAOS", "ATTACK_WAVE", "OPEN CHAOS")
    )
    goal_event_override_ok = (
        main_bet == "NO BET"
        and bet_mode == "GOAL_EVENT"
        and (
            minute >= int(CFG.get("GOAL_EVENT_OVERRIDE_MINUTE", 60))
            or (
                p_goal >= float(CFG.get("GOAL_EVENT_LAMBDA_GATE_PGOAL_MIN", 0.65))
                and float(lam_total or 0.0) >= float(CFG.get("GOAL_EVENT_LAMBDA_GATE_LAM_TOTAL_MIN", 1.00))
            )
        )
        and (
            p_goal >= float(CFG.get("GOAL_EVENT_OVERRIDE_PGOAL_MIN", 0.70))
            or (
                p_goal >= float(CFG.get("GOAL_EVENT_CHAOS_PGOAL_MIN", 0.50))
                and chaos_goal_game
                and side_gap_event <= float(CFG.get("GOAL_EVENT_SIDE_GAP_MAX", 0.15))
            )
            or (
                p_goal >= float(CFG.get("GOAL_EVENT_LAMBDA_GATE_PGOAL_MIN", 0.65))
                and float(lam_total or 0.0) >= float(CFG.get("GOAL_EVENT_LAMBDA_GATE_LAM_TOTAL_MIN", 1.00))
        ...
        and ng_smart_conf <= float(CFG.get("GOAL_EVENT_OVERRIDE_DIR_CONF_MAX", 0.55))
        and (
            abs(lam_h - lam_a) <= float(CFG.get("GOAL_EVENT_OVERRIDE_LAM_GAP_MAX", 0.15))
            or (
                chaos_goal_game
                and side_gap_event <= float(CFG.get("GOAL_EVENT_SIDE_GAP_MAX", 0.15))
            )
        )
        and (not pre_trigger_chaos)
        and (not hidden_goal_risk)
        and (not dual_threat_mode)
        and minute < int(CFG.get("HARD_ENDGAME_NO_BET_MINUTE", 90))
    )
    if goal_event_override_ok:
        main_bet = "GOAL YES"
        decision_reason = "GOAL EVENT OVERRIDE: HIGH P(goal) + LOW DIRECTION"
        goal_event_engine_active = True
        goal_event_engine_side = "OVER"
        goal_event_only_active = True
        hard_no_bet_lock = False
        _note("GOAL_EVENT_OVERRIDE→GOAL YES")

    # --- GOAL EVENT ONLY: trap-comeback primer (gol likely, direction/timing conflict) ---
    _entry_side_u = str(entry_side or "NONE").strip().upper()
    _ng_side_u = str(ng_smart_pred or "").strip().upper()
    _smart_dir_known = _ng_side_u in ("HOME", "AWAY")
    _entry_dir_known = _entry_side_u in ("HOME", "AWAY")
    _side_conflict = _smart_dir_known and _entry_dir_known and (_ng_side_u != _entry_side_u)
    _weak_direction = ng_smart_conf <= float(CFG.get("GOAL_EVENT_ONLY_DIR_CONF_MAX", 0.60))
    _timing_blocked = (
        bool(entry_blocked_by_timing)
        or str(decision_reason or "").startswith("FINAL TIMING FILTER:")
    )
    goal_event_only_ok = (
        bool(CFG.get("GOAL_EVENT_ONLY_ENABLE", True))
        and main_bet == "NO BET"
        and minute >= int(CFG.get("GOAL_EVENT_ONLY_MINUTE", 50))
        and minute < int(CFG.get("HARD_ENDGAME_NO_BET_MINUTE", 90))
        and p_goal >= float(CFG.get("GOAL_EVENT_ONLY_PGOAL_MIN", 0.70))
        and _weak_direction
        and side_gap_event <= float(CFG.get("GOAL_EVENT_ONLY_SIDE_GAP_MAX", 0.18))
        and (not hidden_goal_risk)
        and (not dual_threat_mode)
        and (not counter_risk)
        and (not fake_pressure)
        and (
            (not bool(CFG.get("GOAL_EVENT_ONLY_REQUIRE_TIMING_BLOCK", True)))
            or _timing_blocked
        )
        and (
            (not bool(CFG.get("GOAL_EVENT_ONLY_REQUIRE_SIDE_CONFLICT", True)))
            or _side_conflict
        )
    )
    if goal_event_only_ok:
        main_bet = "GOAL YES"
        decision_reason = "GOAL EVENT ONLY: HIGH P(goal) + LOW/CONFLICT DIRECTION"
        goal_event_engine_active = True
        goal_event_engine_side = "OVER"
        goal_event_only_active = True
        hard_no_bet_lock = False
        _note("GOAL_EVENT_ONLY→GOAL YES")

    # --- GOAL ONLY ENGINE lane: ločeno od side direction engine ---
    goal_only_active_ok = (
        main_bet == "NO BET"
        and goal_only_mode == "ACTIVE"
        and minute >= int(CFG.get("GOAL_ONLY_MINUTE", 70))
        and minute < int(CFG.get("HARD_ENDGAME_NO_BET_MINUTE", 90))
        and (not hidden_goal_risk)
        and (not dual_threat_mode)
        and (not counter_risk)
    ...
    if goal_only_active_ok:
        main_bet = "GOAL YES"
        decision_reason = f"GOAL ONLY ENGINE: ACTIVE ({goal_only_reason})"
        goal_event_engine_active = True
        goal_event_engine_side = "OVER"
        goal_event_only_active = True
        hard_no_bet_lock = False
        _note("GOAL_ONLY_ACTIVE→GOAL YES")
    elif main_bet == "NO BET" and goal_only_mode == "WATCH":
        _note(f"GOAL_ONLY_WATCH:{goal_only_action}")

    # --- EDGE MODE (soft-entry): +EV siva cona namesto preveč strogega NO BET ---
    edge_tempo_ok = (
        tempo_danger >= float(CFG.get("EDGE_MODE_TEMPO_DANGER_MIN", 1.20))
        or tempo_shots >= float(CFG.get("EDGE_MODE_TEMPO_SHOTS_MIN", 0.24))
    )
    edge_wave_ok = wave_active if bool(CFG.get("EDGE_MODE_REQUIRE_WAVE", True)) else True
    edge_side = "AWAY" if p_away_next >= p_home_next else "HOME"
    edge_prob = float(p_away_next if edge_side == "AWAY" else p_home_next)
    edge_mode_ok = (
        main_bet == "NO BET"
        and (not hard_no_bet_lock)
        and minute >= int(CFG.get("EDGE_MODE_MINUTE", 60))
        and minute < int(CFG.get("EDGE_MODE_MAX_MINUTE", 88))
        and edge_wave_ok
        and edge_tempo_ok
        and p_goal >= float(CFG.get("EDGE_MODE_PGOAL_MIN", 0.45))
        and p_no_goal <= float(CFG.get("EDGE_MODE_P_NO_GOAL_MAX", 0.60))
        and edge_prob >= float(CFG.get("EDGE_MODE_PROB_MIN", 0.40))
        and edge_prob <= float(CFG.get("EDGE_MODE_PROB_MAX", 0.55))
        and ng_gap >= float(CFG.get("EDGE_MODE_SIDE_GAP_MIN", 0.02))
        and (not pre_trigger_chaos)
        and (not hidden_goal_risk)
        and (not dual_threat_mode)
        and (not counter_risk)
    ...
    if edge_mode_ok:
        main_bet = f"NEXT GOAL {edge_side}"
        decision_reason = f"EDGE MODE: SOFT ENTRY NEXT GOAL {edge_side} (0.3)"
        edge_mode_active = True
        edge_mode_side = edge_side
        hard_no_bet_lock = False
        _note(f"EDGE_MODE→NEXT GOAL {edge_side}")

    # --- GOAL EVENT ENGINE fallback: če ni side edge, še vedno igraj event edge (OVER/UNDER) ---
    gd_level = str(r.get("goal_detector_level", "") or "").strip().upper()
    gd_prob = float(r.get("goal_detector_prob", 0.0) or 0.0)
    gd_too_late = gd_level == "TOO_LATE"
    gd_very_likely = gd_level == "VERY_LIKELY"
    gd_possible = gd_level == "POSSIBLE"
    gd_over_boost_ok = (
        (gd_very_likely or gd_possible)
        and gd_prob >= float(CFG.get("GOAL_DETECTOR_MIN_PROB_FOR_OVER_BOOST", 0.50))
    )
    over_pgoal_min = float(CFG.get("GOAL_EVENT_ENGINE_OVER_PGOAL_MIN", 0.60))
    if gd_very_likely:
        over_pgoal_min = max(
            0.0,
            over_pgoal_min - float(CFG.get("GOAL_DETECTOR_OVER_BOOST_IF_VERY_LIKELY", 0.05)),
        )

    goal_event_over_ok = (
        main_bet == "NO BET"
        and (not hard_no_bet_lock)
        and minute >= int(CFG.get("GOAL_EVENT_ENGINE_OVER_MINUTE", 65))
        and p_goal >= over_pgoal_min
        and tempo_danger >= float(CFG.get("GOAL_EVENT_ENGINE_OVER_TEMPO_DANGER_MIN", 1.30))
        and (
            (not bool(CFG.get("GOAL_DETECTOR_BLOCK_OVER_ON_TOO_LATE", True)))
            or (not gd_too_late)
        )
        and (gd_over_boost_ok or (not gd_level))
        and (not pre_trigger_chaos)
        and (not hidden_goal_risk)
        and (not dual_threat_mode)
        and minute < int(CFG.get("HARD_ENDGAME_NO_BET_MINUTE", 90))
    ...
    goal_event_under_ok = (
        main_bet == "NO BET"
        and (not hard_no_bet_lock)
        and minute >= int(CFG.get("GOAL_EVENT_ENGINE_UNDER_MINUTE", 75))
        and p_goal <= float(CFG.get("GOAL_EVENT_ENGINE_UNDER_PGOAL_MAX", 0.45))
        and p_no_goal >= float(CFG.get("GOAL_EVENT_ENGINE_UNDER_PNOGOAL_MIN", 0.55))
        and (
            (not bool(CFG.get("GOAL_DETECTOR_ALLOW_UNDER_ON_TOO_LATE", True)))
            or gd_too_late
            or gd_level in ("LOW", "")
            or gd_prob <= 0.45
        )
    ...
    if goal_event_over_ok:
        main_bet = "GOAL YES"
        decision_reason = (
            f"GOAL EVENT ENGINE: OVER / GOAL YES (0.5) | GD={gd_level or 'N/A'} {gd_prob*100:.0f}%"
        )
        goal_event_engine_active = True
        goal_event_engine_side = "OVER"
        hard_no_bet_lock = False
        _note("GOAL_EVENT_ENGINE→OVER")
    elif goal_event_under_ok:
        main_bet = "NO GOAL"
        decision_reason = (
            f"GOAL EVENT ENGINE: NO GOAL / UNDER (0.5) | GD={gd_level or 'N/A'} {gd_prob*100:.0f}%"
        )
        goal_event_engine_active = True
        goal_event_engine_side = "UNDER"
        hard_no_bet_lock = False
        _note("GOAL_EVENT_ENGINE→UNDER")

    # TIMING PROTECTION (kritično): high long-term p_goal brez short-term triggerja ni "GO NOW".
    timing_delay_guard = (
        p_goal >= float(CFG.get("TIMING_DELAY_PGOAL_MIN", 0.75))
        and p_goal_5 < float(CFG.get("TIMING_DELAY_PGOAL5_MAX", 0.30))
        and (not wave_for_entry)
    )
    timing_entry_trigger_now = (
        p_goal_5 >= float(CFG.get("TIMING_ENTRY_TRIGGER_PGOAL5_MIN", CFG.get("TIMING_DELAY_RELEASE_PGOAL5_MIN", 0.35)))
        or wave_for_entry
    )
    if timing_delay_guard and str(main_bet or "").strip().upper() == "GOAL YES":
        main_bet = "NO BET"
        decision_reason = "TIMING ENGINE: DELAYED GOAL (WAIT TRIGGER)"
        hard_no_bet_lock = True
        _note("TIMING_ENGINE:DELAYED_GOAL_WAIT")
    elif (
        str(main_bet or "").strip().upper() == "NO BET"
        and p_goal >= float(CFG.get("TIMING_DELAY_PGOAL_MIN", 0.75))
        and timing_entry_trigger_now
        and (not hard_no_bet_lock)
        and (not hidden_goal_risk)
        and (not dual_threat_mode)
        and (not counter_risk)
        ...
        main_bet = "GOAL YES"
        decision_reason = "TIMING ENGINE: ENTRY TRIGGER (WAVE / GOAL 5M)"
        goal_event_engine_active = True
        goal_event_engine_side = "OVER"
        hard_no_bet_lock = False
        _note("TIMING_ENGINE:ENTRY_TRIGGER_GOAL_YES")

    # --- GOAL DECISION ENGINE -> core execution override (obvezno združeno z logiko) ---
    gde_override_ok = (
        main_bet == "NO BET"
        and gd_minute_gate_ok
        and (gd_phase_entry_active or gd_control_game)
        and gd_final_bet != "NO BET"
        and (not gd_timing_delayed)
        and ((not gd_event_lock) or gd_low_event_breakout)
        and minute < int(CFG.get("HARD_ENDGAME_NO_BET_MINUTE", 90))
        and (not hidden_goal_risk)
        and (not dual_threat_mode)
        and (not counter_risk)
    ...
    if gde_override_ok:
        _gde_pick = "NO BET"
        if gd_final_bet == "NEXT GOAL HOME":
            _gde_pick = "NEXT GOAL HOME"
        elif gd_final_bet == "NEXT GOAL AWAY":
            _gde_pick = "NEXT GOAL AWAY"
        elif gd_final_bet in ("GOAL YES (EARLY BUILD-UP)", "OVER"):
            _gde_pick = "GOAL YES"
            goal_event_engine_active = True
            goal_event_engine_side = "OVER"
        elif gd_final_bet == "UNDER":
            _gde_pick = "NO GOAL"
            goal_event_engine_active = True
            goal_event_engine_side = "UNDER"
        ...
        if _gde_pick != "NO BET":
            main_bet = _gde_pick
            if gd_low_event_breakout:
                low_event_breakout_active = True
                low_event_breakout_level = gd_low_event_breakout_level if gd_low_event_breakout_level in ("SOFT", "STRONG") else "SOFT"
                low_event_breakout_stake_units = max(0.2, gd_low_event_breakout_stake)
                decision_reason = (
                    f"LOW EVENT BREAKOUT: {gd_low_event_breakout_side} ({low_event_breakout_level}, risk {low_event_breakout_stake_units:.1f}) "
                    f"| phase {gd_engine.get('phase_name', 'NONE')}"
                )
                if low_event_breakout_stake_units <= 0.21:
                    micro_entry_active = True
                _note(f"LOW_EVENT_BREAKOUT:{low_event_breakout_level}_RISK_ENTRY")
            else:
                decision_reason = f"GOAL DECISION ENGINE OVERRIDE: {gd_final_bet} (phase {gd_engine.get('phase_name', 'NONE')})"
            entry_signal_found = True
            entry_candidate_bet = str(main_bet)
            entry_execution_allowed = True
            entry_execution_status = "FORCED"
            entry_blocked_by_timing = False
            entry_block_reason = ""
            hard_no_bet_lock = False
            goal_decision_engine_override_active = True
            goal_decision_engine_override_reason = decision_reason
            _note(f"GOAL_DECISION_ENGINE→{_gde_pick}")

    # --- HARD GOAL EVENT OVERRIDE: direction conf ne sme ubiti event stave ---
    _event_hard_override = (
        main_bet == "NO BET"
        and goal_only_mode == "ACTIVE"
        and p_goal >= float(CFG.get("GOAL_EVENT_HARD_OVERRIDE_PGOAL_MIN", 0.65))
        and (not hidden_goal_risk)
        and (not dual_threat_mode)
        and (not counter_risk)
        and minute < int(CFG.get("HARD_ENDGAME_NO_BET_MINUTE", 90))
    ...
    _late_chaos_force = (
        main_bet == "NO BET"
        and minute >= int(CFG.get("LATE_CHAOS_FORCE_MINUTE", 75))
        and p_goal >= float(CFG.get("LATE_CHAOS_FORCE_PGOAL_MIN", 0.70))
        and tempo_shots > float(CFG.get("LATE_CHAOS_FORCE_TEMPO_SHOTS_MIN", 0.25))
        and (not hidden_goal_risk)
        and (not dual_threat_mode)
        and (not counter_risk)
        and (not fake_pressure)
    ...
    if _event_hard_override or _late_chaos_force:
        main_bet = "GOAL YES"
        if _late_chaos_force:
            decision_reason = "LATE CHAOS FORCE: GOAL YES (event > direction)"
            _note("LATE_CHAOS_FORCE→GOAL_YES")
        else:
            decision_reason = "HARD GOAL EVENT OVERRIDE: GOAL ONLY ACTIVE (P(goal) high)"
            _note("GOAL_EVENT_HARD_OVERRIDE→GOAL_YES")
        goal_event_engine_active = True
        goal_event_engine_side = "OVER"
        goal_event_only_active = True
        hard_no_bet_lock = False
        ...
        entry_candidate_bet = "GOAL YES"
        entry_execution_allowed = True
        entry_execution_status = "GO (EVENT HARD OVERRIDE)"
        entry_blocked_by_timing = False
        entry_block_reason = ""
    ...
    elif match_force_home:
        match_bet = "HOME"
        match_reason = "MATCH VALUE (edge+MC+λ; structure > timing)"
    elif match_force_away:
        match_bet = "AWAY"
        match_reason = "MATCH VALUE (edge+MC+λ; structure > timing)"

    # Končni pick je znan: uskladi prikaz top5 z main_bet (timing bypass / override).
    top5_display = _display_top5_for_pick(top5, main_bet, scores)
    ...
    if LAST_BET not in (None, "", "NO BET"):
        if minute - LAST_MINUTE <= 3:
            top5_display = _display_top5_for_pick(top5, str(LAST_BET or "").strip().upper(), scores)
            dq_lock = _decision_quality_0_100(
                str(LAST_BET or ""),
                mc_h=mc_h,
                mc_x=mc_x,
                mc_a=mc_a,
                edge_h=float(r.get("edge_h", 0) or 0),
                edge_x=float(r.get("edge_x", 0) or 0),
                edge_a=float(r.get("edge_a", 0) or 0),
                model_reliability=model_reliability,
                dual_threat_mode=dual_threat_mode,
                hidden_goal_risk=hidden_goal_risk,
                scores_rank1_key=str(top5[0][0]) if top5 else "",
                confidence="LOCKED",
            )
            print()
            print("=============== BET DECISION ===============" + cmd_tag("FINAL"))
            ...
            _exec, _why = live_execution_status(r, str(LAST_BET or ""), "LOCKED")
            _clr = GREEN if _exec == "GO" else RED
            print("IZVEDBA V ŽIVO:", btxt(f"{_exec} | {_why}", _clr, True))
            print("QUALITY:".ljust(12), f"{dq_lock:.0f}/100", "(kalibracija+edge+skladnost rank1)")
            print("VALID:", LAST_MINUTE, "-", int(LAST_MINUTE + 5))
            print()
            print("ALTERNATIVE:")
            if len(top5_display) > 1:
                print("2)", top5_display[1][0])
            else:
                print("2) NO BET")
            if len(top5_display) > 2:
                print("3)", top5_display[2][0])
            else:
                print("3) NO BET")
            if len(top5_display) > 3:
                print("4)", top5_display[3][0])
            else:
                print("4) NO BET")
            if len(top5_display) > 4:
                print("5)", top5_display[4][0])
            else:
                print("5) NO BET")
            print()
            print("MODEL:")
            ...
            try:
                ...
                r["moja_stava"] = str(LAST_BET or "").strip()
                r["razlog_stave"] = "BET LOCK (<=3 MIN)"
                r["decision_quality"] = round(float(dq_lock), 1)
                r["pick_aligned_scores_rank1"] = bool(
                    top5
                    and str(top5[0][0] or "").strip().upper()
                    == str(LAST_BET or "").strip().upper()
                )
            except Exception as e:
                cfos_log_ex("bet_decision BET LOCK final_auto_*", e)
            append_bet_decision_log_row(
                r,
    ...
    # =====================================================
    # FINAL GOAL ENGINE SYNC (MASTER FOR EVENT BETS)
    # =====================================================
    # Če GOAL ONLY engine označi ACTIVE in je P(goal) dovolj visok, mora biti
    # končna odločitev event-bet (GOAL YES), ne NO BET zaradi direction filtrov.
    _goal_engine_master = (
        goal_only_mode == "ACTIVE"
        and p_goal >= float(CFG.get("GOAL_EVENT_HARD_OVERRIDE_PGOAL_MIN", 0.65))
        and minute < int(CFG.get("HARD_ENDGAME_NO_BET_MINUTE", 90))
    )
    if _goal_engine_master:
        if str(main_bet or "").strip().upper() == "NO BET":
            main_bet = "GOAL YES"
            decision_reason = "GOAL ENGINE MASTER SYNC: ACTIVE + HIGH P(goal)"
            _note("GOAL_ENGINE_MASTER_SYNC→GOAL_YES")
        # hard sync zastavic: event engine mora biti aktiven, execution dovoljen.
        goal_event_engine_active = True
        goal_event_engine_side = "OVER"
        goal_event_only_active = True
        hard_no_bet_lock = False
        ...
        entry_candidate_bet = "GOAL YES"
        entry_execution_allowed = True
        entry_execution_status = "GO (GOAL ENGINE MASTER)"
        entry_blocked_by_timing = False
        entry_block_reason = ""
    ...
    if main_bet == "NO BET":
        confidence = "LOW"
    elif pre_goal_entry_forced and main_bet in ("NEXT GOAL HOME", "NEXT GOAL AWAY") and confidence == "LOW":
        confidence = "MEDIUM"
        _note("CONF_UP:PRE_GOAL_EARLY_MIN_MEDIUM")

    # Obnovljen 1X2 iz timing bypass: top5 še kaže NO BET, zato vsaj MEDIUM za match value
    if main_bet in ("HOME", "AWAY") and str(decision_reason or "").startswith("MATCH VALUE:"):
        if confidence == "LOW":
            confidence = "MEDIUM"
    ...
    # GOAL EVENT override: smer je nejasna, a event signal je močan -> ne ostani na LOW.
    if str(decision_reason or "").startswith("GOAL EVENT OVERRIDE"):
        if confidence == "LOW":
            confidence = "MEDIUM"
    if str(decision_reason or "").startswith("EDGE MODE:"):
        if confidence == "LOW":
            confidence = "MEDIUM"
    if str(decision_reason or "").startswith("GOAL EVENT ENGINE:"):
        if confidence == "LOW":
            confidence = "MEDIUM"
    if str(decision_reason or "").startswith("TIMING ENGINE: ENTRY TRIGGER"):
        if confidence == "LOW":
            confidence = "MEDIUM"
    if str(decision_reason or "").startswith("GOAL DECISION ENGINE OVERRIDE:"):
        if confidence == "LOW":
            confidence = "MEDIUM"
    if str(decision_reason or "").startswith("LOW EVENT BREAKOUT:"):
        confidence = "LOW"
    if str(decision_reason or "").startswith("GOAL ONLY ENGINE:"):
        if confidence == "LOW":
            confidence = "MEDIUM"
    ...
    if (
        ...
        if confidence == "HIGH":
            ...
            confidence = "LOW"
        _note("CONF_DOWN:TOP_0-0_70+")

    # SMART MINUTE ENGINE weighting: minuta ne gate-a, le mehko prilagodi confidence.
    if main_bet != "NO BET":
        conf_levels = ["LOW", "MEDIUM", "HIGH"]
        try:
            conf_idx = conf_levels.index(str(confidence).upper())
        except ValueError:
            conf_idx = 0
        if minute_mult <= 0.92:
            conf_idx = max(0, conf_idx - 1)
            _note("CONF_MINUTE_WEIGHT:-1")
        elif minute_mult >= 1.08 and event_ok:
            conf_idx = min(len(conf_levels) - 1, conf_idx + 1)
            _note("CONF_MINUTE_WEIGHT:+1")
        confidence = conf_levels[conf_idx]
    ...
    _note(f"PICK:{main_bet}|CONF={confidence}")

    dq = _decision_quality_0_100(
        main_bet,
        mc_h=mc_h,
        mc_x=mc_x,
        mc_a=mc_a,
    ...
    pick_aligned_scores_r1 = bool(
        top5 and str(top5[0][0] or "").strip().upper() == str(main_bet or "").strip().upper()
    )

    # EVENT mode: direction conf ne sme blokirati izvedbe, če je P(goal) dovolj visok.
    _event_force_exec_now = bool(
        (
            str(main_bet or "").strip().upper() in ("GOAL YES", "OVER", "OVER / GOAL YES")
            and p_goal >= float(CFG.get("GOAL_EVENT_EXEC_PGOAL_MIN", 0.65))
        )
        or (
            str(main_bet or "").strip().upper() in ("NO GOAL", "UNDER", "NO GOAL / UNDER")
            and p_no_goal >= float(CFG.get("GOAL_EVENT_EXEC_PNOGOAL_MIN", 0.55))
        )
    )
    if _event_force_exec_now:
        goal_event_engine_active = True
        entry_signal_found = True
        entry_candidate_bet = str(main_bet)
        entry_execution_allowed = True
        entry_execution_status = "GO (EVENT FORCE)"
        entry_blocked_by_timing = False
        entry_block_reason = ""
        _note("GOAL_EVENT_FORCE:IGNORE_DIRECTION_CONF")

    # ENTRY signal je smerni signal; execution dovoljenje je lahko blokirano kasneje.
    if entry_signal_found and entry_candidate_bet:
        if str(main_bet or "").strip().upper() == str(entry_candidate_bet or "").strip().upper():
            entry_execution_allowed = True
            if "FORCED COMEBACK" not in str(entry_execution_status or ""):
                entry_execution_status = "GO"
            entry_blocked_by_timing = False
            entry_block_reason = ""
        elif str(main_bet or "").strip().upper() == "NO BET":
            if (not entry_blocked_by_timing) and str(decision_reason or "").startswith("FINAL TIMING FILTER:"):
                entry_execution_status = "BLOCKED (FINAL TIMING)"
                entry_blocked_by_timing = True
                entry_block_reason = str(decision_reason or "").replace("FINAL TIMING FILTER:", "").strip()
            elif not entry_blocked_by_timing:
                entry_execution_status = "WAIT"
                entry_execution_allowed = False
        else:
            entry_execution_allowed = False
            if not entry_blocked_by_timing:
                entry_execution_status = f"SWITCHED TO {str(main_bet or '').strip().upper()}"
    ...
    print("MINUTE:", minute)
    print()
    print(btxt("DECISION TRACE:", CYAN, True))
    print(" → ".join(decision_trace))
    print()
    print("BET:", main_bet)
    print("CONFIDENCE:", confidence)
    print("MINUTE ENGINE:", f"x{minute_mult:.2f} | EVENT {'YES' if event_ok else 'NO'} ({event_reason})")
    _exec, _why = live_execution_status(r, main_bet, confidence)
    _clr = GREEN if _exec == "GO" else RED
    print("IZVEDBA V ŽIVO:", btxt(f"{_exec} | {_why}", _clr, True))
    print("QUALITY:".ljust(12), f"{dq:.0f}/100", "(kalibracija+edge+skladnost rank1)")
    ...
    if main_bet == "NO BET":
        ...
        # Minute weighting na sizingu: zgodaj previdno, pozno malo bolj agresivno.
        if stake_band in ("MICRO", "LOW", "MEDIUM", "HIGH"):
            stake_levels = ["MICRO", "LOW", "MEDIUM", "HIGH"]
            s_idx = stake_levels.index(stake_band)
            if minute_mult <= 0.92:
                s_idx = max(0, s_idx - 1)
                _note("STAKE_MINUTE_WEIGHT:-1")
            elif (
                minute_mult >= 1.08
                and event_ok
                and (not chaos_flag)
                and (not hard_lock_flag)
                and model_reliability >= 0.60
            ):
                s_idx = min(len(stake_levels) - 1, s_idx + 1)
                _note("STAKE_MINUTE_WEIGHT:+1")
            stake_band = stake_levels[s_idx]

    if pro_late_value_flag or control_soft_link_flag:
        stake_band = "HALF (0.5 PRO)"
    if edge_mode_active:
        stake_band = "SMALL (0.3 EDGE)"
    if goal_event_engine_active:
        stake_band = "HALF EVENT (0.5)"
    if low_event_breakout_active:
        if low_event_breakout_stake_units >= 0.29:
            stake_band = "LOW EVENT BREAKOUT STRONG (0.3)"
        else:
            stake_band = "LOW EVENT BREAKOUT SOFT (0.2)"
    if micro_entry_active:
        stake_band = "MICRO ENTRY (0.2)"
    if pre_goal_entry_forced and main_bet in ("NEXT GOAL HOME", "NEXT GOAL AWAY"):
        stake_band = "PRE-GOAL EARLY (0.2)"
    ...
    print()
    print("--------------- PRE-GOAL ENGINE ----------------")
    if pre_goal_trigger and pre_goal_entry_side in ("HOME", "AWAY"):
        print(f"TRIGGER:          YES ({pre_goal_entry_side})")
        print(f"STRENGTH:         {pre_goal_entry_strength:.2f}")
        print("MODE:             EARLY BUILD-UP")
    else:
        print("TRIGGER:          NO")
    print()
    print("================ ENTRY ENGINE =================")
    watch_signal_active = bool(pre_goal_trigger and pre_goal_entry_side in ("HOME", "AWAY") and (not pre_goal_entry_forced))
    print(f"WATCH SIGNAL:     {'YES' if watch_signal_active else 'NO'}" + (f" (NEXT GOAL {pre_goal_entry_side})" if watch_signal_active else ""))
    print(f"PRE-ENTRY MODE:   {'BUILD-UP' if pre_entry else 'NO'}")
    print(f"TRIGGER:          {'YES' if entry_trigger else 'NO'}" + (f" ({entry_trigger_reason})" if entry_trigger_reason else ""))
    print(f"PREPARE ENTRY:    {'YES' if entry_prepare else 'NO'}")
    if pre_entry:
        print(f"SMER:             {entry_side}")
        print("ETA:              5-15 min")
    print(f"SIGNAL FOUND:     {'YES' if entry_signal_found else 'NO'}")
    if entry_signal_found and entry_candidate_bet:
        print(f"ENTRY DIRECTION:  {entry_side}")
        print(f"ENTRY CANDIDATE:  {entry_candidate_bet}")
    else:
        print("ENTRY CANDIDATE:  NONE")
    print(f"EXECUTION ALLOWED:{' YES' if entry_execution_allowed else ' NO'}")
    if (not entry_execution_allowed) and entry_execution_status:
        print(f"EXECUTION STATUS: {entry_execution_status}")
    if entry_blocked_by_timing and entry_block_reason:
        print(f"BLOCK REASON:     {entry_block_reason}")
    if comeback_aggressive_entry_active:
        print("COMEBACK AGGR:    ACTIVE (timing bypass)")
        if comeback_aggressive_entry_reason:
            print(f"AGGR REASON:      {comeback_aggressive_entry_reason}")
    if comeback_force_entry_active:
        print("FORCE ENTRY:      ACTIVE (COMEBACK override timing)")
    if early_goal_entry_active:
        _eg_lbl = "AGGRESSIVE" if early_goal_entry_aggressive else "STANDARD"
        print(f"EARLY GOAL ENTRY: ACTIVE ({_eg_lbl} build-up)")
        if early_goal_entry_reason:
            print(f"EARLY REASON:     {early_goal_entry_reason}")
    _sig_side_cmd = str(ng_smart_pred or "").strip().upper()
    if _sig_side_cmd not in ("HOME", "AWAY"):
        _sig_side_cmd = "HOME" if float(p_home_next or 0.0) >= float(p_away_next or 0.0) else "AWAY"
    print(f"SIGNAL SMER:      {_sig_side_cmd}")
    print(f"SIGNAL IZVEDBA:   {main_bet}")
    if str(main_bet or "").strip().upper() == "NO BET":
        _blk_cmd = str(entry_block_reason or "").strip()
        if not _blk_cmd and str(decision_reason or "").upper().startswith("LOW GOAL 10M"):
            _blk_cmd = f"P(GOAL 10M)={p_goal_10*100:.2f}% < ENTRY THRESHOLD {CFG['LOW_GOAL_10M_NEXT']*100:.0f}%"
        elif not _blk_cmd:
            _blk_cmd = str(decision_reason or "").strip()
        if _blk_cmd:
            print(f"RAZLOG BLOKADE:   {_blk_cmd}")
    print(f"SIGNAL STATUS:    {entry_status}")
    print()
    ...
    if edge_mode_active:
        print(f"PRO MODE: EDGE MODE — SOFT ENTRY {edge_mode_side} (0.3 units)")
    if goal_event_engine_active:
        print(f"PRO MODE: GOAL EVENT ENGINE — {goal_event_engine_side} (0.5 units)")
    if goal_event_only_active:
        print("PRO MODE: GOAL EVENT ONLY — trap conflict override (0.5 units)")
    if goal_decision_engine_override_active:
        print(f"PRO MODE: GOAL DECISION ENGINE OVERRIDE — {gd_final_bet} ({gd_final_conf}%)")
    if low_event_breakout_active:
        print(
            f"PRO MODE: LOW EVENT BREAKOUT — {gd_low_event_breakout_side} "
            f"({low_event_breakout_level}, {low_event_breakout_stake_units:.1f} units)"
        )
    if micro_entry_active:
        print("PRO MODE: MICRO ENTRY — RISK MODE EXECUTION (0.2 units)")

    print()
    print("================ INTERPRETACIJA (HUMAN MODE) =================")
    print()

    # 1) REALNA GROZNJA
    if (xg_h + xg_a) < 1.0 and (sot_h + sot_a) <= 2:
        print("REALNA GROZNJA:   NO (NIZKA)")
        print("-> Veliko napadov, ampak brez prave nevarnosti (fake pressure)")
    else:
        print("REALNA GROZNJA:   YES (VISOKA)")

    # 2) TIP TEKME
    if abs(score_diff) == 1 and minute > 60:
        print("TIP TEKME:        KILL GAME (ekipa vodi in kontrolira)")
    elif abs(momentum) > 0.4:
        print("TIP TEKME:        OPEN GAME (mocan pritisk)")
    else:
        print("TIP TEKME:        BALANCED")

    # 3) SIGNAL ZA GOL (consistency: ce je GOAL YES signal, mora biti YES)
    _goal_yes_signal = bool(
        str(main_bet or "").strip().upper() in ("GOAL YES", "OVER", "OVER / GOAL YES")
        or goal_event_engine_active
        or goal_event_only_active
    )
    _goal_signal_human = bool(_goal_yes_signal or (p_goal_10 >= 0.30))
    if _goal_signal_human:
        if _goal_yes_signal and p_goal_10 < 0.30:
            print("SIGNAL ZA GOL:    MOZEN (BUILD-UP OVERRIDE)")
        else:
            print("SIGNAL ZA GOL:    MOZEN")
    else:
        print("SIGNAL ZA GOL:    NO")
        print("-> Verjetnost gola v naslednjih 10 min je prenizka")

    # 4) SMER
    _dir_gap_human = abs(float(p_home_next or 0.0) - float(p_away_next or 0.0))
    if _dir_gap_human < 0.05:
        print("SMER:             NEJASNA (coin flip)")
    elif float(p_home_next or 0.0) > float(p_away_next or 0.0):
        print("SMER:             HOME")
    else:
        print("SMER:             AWAY")
    ...
    print("ZAKLJUCEK:")
    if minute >= 90:
        print("-> Tekma je koncana (time kill) -> ni vec entryja")
    elif (not _goal_signal_human):
        print("-> Ni pravega eventa -> pocakaj")
    elif _dir_gap_human < 0.05:
        print("-> Smer ni jasna -> NO BET")
    else:
        print("-> Signal obstaja -> mozna priprava na vstop")

    # BONUS: FAKE PRESSURE ALERT
    if danger_h > (danger_a * 1.5) and sot_h <= 2 and xg_h < 1.0:
        print()
        print("[WARNING] FAKE HOME PRESSURE (veliko napadov brez kvalitete)")
    if danger_a > (danger_h * 1.5) and sot_a <= 2 and xg_a < 1.0:
        print()
        print("[WARNING] FAKE AWAY PRESSURE (veliko napadov brez kvalitete)")
    ...
    try:
        ...
        r["entry_signal_found"] = bool(entry_signal_found)
        r["entry_candidate_bet"] = str(entry_candidate_bet or "NONE")
        r["entry_execution_allowed"] = bool(entry_execution_allowed)
        r["entry_execution_status"] = str(entry_execution_status or "WAIT")
        r["entry_blocked_by_timing"] = bool(entry_blocked_by_timing)
        r["entry_block_reason"] = str(entry_block_reason or "")
        r["entry_prepare"] = bool(entry_prepare)
        r["semi_wave_active"] = bool(semi_wave_active)
        r["micro_entry_active"] = bool(micro_entry_active)
        r["comeback_aggressive_entry_active"] = bool(comeback_aggressive_entry_active)
        r["comeback_aggressive_entry_reason"] = str(comeback_aggressive_entry_reason or "")
        r["moja_stava"] = str(main_bet or "").strip()
        r["razlog_stave"] = str(decision_reason or "").strip() or str(r.get("razlog_stave") or "")
        r["decision_quality"] = round(float(dq), 1)
        r["pick_aligned_scores_rank1"] = bool(pick_aligned_scores_r1)
        r["pro_late_value_flag"] = bool(pro_late_value_flag)
        r["control_soft_link_flag"] = bool(control_soft_link_flag)
        r["edge_mode_active"] = bool(edge_mode_active)
        r["edge_mode_side"] = str(edge_mode_side or "")
        r["edge_mode_stake_units"] = 0.3 if edge_mode_active else 0.0
        r["goal_event_engine_active"] = bool(goal_event_engine_active)
        r["goal_event_engine_side"] = str(goal_event_engine_side or "")
        r["goal_event_only_active"] = bool(goal_event_only_active)
        r["goal_decision_engine_mode"] = str(gd_engine.get("mode", "LOW EVENT") or "LOW EVENT")
        r["goal_decision_engine_phase"] = str(gd_engine.get("phase_name", "NONE") or "NONE")
        r["goal_decision_engine_phase_active"] = bool(gd_engine.get("phase_entry_active", False))
        r["goal_decision_engine_final_bet"] = str(gd_final_bet or "NO BET")
        r["goal_decision_engine_final_conf"] = int(gd_final_conf)
        r["goal_decision_engine_low_event_breakout"] = bool(gd_engine.get("low_event_breakout", False))
        r["goal_decision_engine_low_event_breakout_side"] = str(gd_engine.get("low_event_breakout_side", "NONE") or "NONE")
        r["goal_decision_engine_low_event_breakout_level"] = str(gd_engine.get("low_event_breakout_level", "NONE") or "NONE")
        r["goal_decision_engine_low_event_breakout_stake"] = float(gd_engine.get("low_event_breakout_stake", 0.0) or 0.0)
        r["low_event_breakout_active"] = bool(low_event_breakout_active)
        r["low_event_breakout_level"] = str(low_event_breakout_level or "NONE")
        r["low_event_breakout_stake_units"] = float(low_event_breakout_stake_units or 0.0)
        r["goal_decision_engine_override_active"] = bool(goal_decision_engine_override_active)
        r["goal_decision_engine_override_reason"] = str(goal_decision_engine_override_reason or "")
        r["goal_event_engine_stake_units"] = 0.5 if goal_event_engine_active else 0.0
        if goal_event_engine_active:
            r["bet_mode"] = "GOAL_EVENT"
            if goal_event_engine_side == "UNDER":
                r["goal_event_market_advisory"] = "NO GOAL / UNDER"
                r["bet_mode_reason"] = "GOAL EVENT ENGINE: UNDER fallback"
            else:
                r["goal_event_market_advisory"] = "OVER / GOAL YES (Next goal YES)"
                r["bet_mode_reason"] = "GOAL EVENT ENGINE: OVER fallback"
        if low_event_breakout_active:
            r["pro_stake_units"] = float(low_event_breakout_stake_units or CFG.get("LOW_EVENT_BREAKOUT_STAKE_SOFT", 0.2))
        elif micro_entry_active:
            r["pro_stake_units"] = float(CFG.get("MICRO_ENTRY_STAKE_UNITS", 0.2))
        elif edge_mode_active:
            r["pro_stake_units"] = 0.3
        elif goal_event_engine_active:
            r["pro_stake_units"] = 0.5
        else:
            r["pro_stake_units"] = 0.5 if (pro_late_value_flag or control_soft_link_flag) else 1.0
        r["cfos_bet_decision_log"] = BET_DECISION_LOG
        r["decision_trace"] = list(decision_trace)
    except Exception as e:
        cfos_log_ex("bet_decision final_auto_* / trace", e)
    try:
        append_bet_decision_log_row(
            r,
            main_bet=main_bet,
        ...
        cfos_log_ex("bet_decision append_bet_decision_log_row", e, critical=True)
...
def main():
    ...
    if len(data) < 20:
        print(f"OPOZORILO: prebranih je samo {len(data)} CSV polj (možen napačen separator/shift).")
    elif len(data) < 90:
        print(f"INFO: prebranih {len(data)} polj (osnovni format deluje; manjkajoča polja bodo 0).")
